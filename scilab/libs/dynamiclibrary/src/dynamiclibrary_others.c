...
/*---------------------------------------------------------------------------*/
wchar_t* buildModuleDynLibraryName(const wchar_t* _pwstModuleName, dynlib_name_format _iType)
{
...
char* buildModuleDynLibraryName(const char* _pstModuleName, dynlib_name_format _iType)
{
    ...
    wchar_t* pwstDynLibName = buildModuleDynLibraryNameW(pwstModuleName);
