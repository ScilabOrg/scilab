...
cs_CZ.MsgBoxTclsciRequired1 =You choose to install Scipad but tclsci module is not selected.
...
cs_CZ.DescriptionJavasci =Java Interface with Scilab
cs_CZ.DescriptionMexlib =Mexlib Tools
cs_CZ.DescriptionIntersci =Intersci Toolbox
cs_CZ.DescriptionMaple2sci =Maple to Scilab Toolbox
cs_CZ.DescriptionFortran2sci =Scilab to Fortran Toolbox
cs_CZ.DescriptionTclTK =TCL/TK in Scilab
cs_CZ.DescriptionScipad =Scipad Editor for Scilab
