...
Source: bin\mkl\libiomp5md.dll; DestDir: {app}\bin; Components: {#COMPN_MKL_CPU_LIBRARY}
Source: bin\mkl\mkl_core.dll; DestDir: {app}\bin; Components: {#COMPN_MKL_CPU_LIBRARY}
Source: bin\mkl\mkl_def.dll; DestDir: {app}\bin; Components: {#COMPN_MKL_CPU_LIBRARY}
Source: bin\mkl\mkl_intel_thread.dll; DestDir: {app}\bin; Components: {#COMPN_MKL_CPU_LIBRARY}
