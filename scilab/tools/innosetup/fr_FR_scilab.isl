...
fr_FR.MsgBoxJREReinstall = Relancer l'installeur de Scilab après l'installation du JRE.
...
fr_FR.MsgBoxWinVer =Nécessité Windows 2000 ou plus.
...
;
fr_FR.DescriptionEquDif =Module sur les Équations Différentielles
fr_FR.DescriptionInterpolation =Module sur l'Interpolation
fr_FR.DescriptionPolynomials =Module Polynômes
fr_FR.DescriptionSymbolic =Module Calculs Symboliques
fr_FR.DescriptionStats =Module de Statistiques
fr_FR.DescriptionSparse =Module sur les Matrices Creuses
fr_FR.DescriptionLinAlg =Module d'Algèbre Linéaire
...
fr_FR.DescriptionParallel = Calculs Parallèle avec Scilab
...
;
fr_FR.DescriptionLaunchScilab =Exécuter Scilab
;
