...
;
fr_FR.NextButtonClickwpReadyMsg1 =Il a été impossible de télècharger la bibliothèque Intel Math Kernel pour Scilab (La bibliothèque par défaut sera utilisée).
fr_FR.NextButtonClickwpReadyMsg2 =Il a été impossible de télècharger la bibliothèque FFTW3 optimisée par Intel Math Kernel Library (La bibliothèque par défaut sera utilisée).
;
