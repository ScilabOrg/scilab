 ...
 * @return <ReturnValue>
 */
CORE_IMPEXP int StoreCommandWithFlags(char* command, int iPrioritary, int iInterruptible, enum command_origin_t iCmdorigin);
 ...
 * @return <ReturnValue>
 */
CORE_IMPEXP int StoreCommand(char *command);
 ...
 * @return <ReturnValue>
 */
CORE_IMPEXP int StoreConsoleCommand(char *command, int iWaitFor);
 ...
 * @return <ReturnValue>
 */
CORE_IMPEXP int StorePrioritaryCommand(char *command);
 ...
 */
CORE_IMPEXP int GetCommand(char** command, int* piPrioritary, int* piInterruptible, enum command_origin_t* iCmdorigin);

/**
* check if command queue is empty
* @return 1 if empty , 0 is not empty
*/
CORE_IMPEXP int isEmptyCommandQueue(void);
