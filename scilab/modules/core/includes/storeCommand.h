 ...
 * @return <ReturnValue>
 */
int StoreCommandWithFlags(char* command, int iPrioritary, int iInterruptible, enum command_origin_t iConsole);
 ...
 */
int GetCommand(char** command, int* piPrioritary, int* piInterruptible, enum command_origin_t* piConsole);
