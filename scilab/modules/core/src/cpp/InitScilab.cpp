...
int StartScilabEngine(bool _bNoStart, bool _bJvm, bool _bConsole, char* _pstLang, char* _pstExec, char* _pstFile)
{
    int iMainRet = 0;
...
void StopScilabEngine(bool _bNoStart, bool _bConsole)
{
    //execute scilab.quit
    if (_bNoStart == false)
    {
