...
*/
void execAstTask(ast::Exp* tree, bool serialize, bool timed, bool ASTtimed, bool execVerbose, bool isInterruptible)
{
    if (tree == NULL)
    {
        return;
    ...
    Runner::execAndWait(newTree, exec, isInterruptible);
...
void execScilabStartTask(bool _bSerialize)
{
    ...
    execAstTask(parse.getTree(), _bSerialize, false, false, false, false);
}
