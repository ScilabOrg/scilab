...
#define BUFFER_LEN 255
    ...
    if (str_info)
    {
        sprintf(str_info, "Memory in use: %*ld %%", WIDTH, statex.dwMemoryLoad);
    ...
    if (str_info)
    {
        sprintf(str_info, "Total Physical Memory (Kbytes): %*I64d", WIDTH, statex.ullTotalPhys / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
    ...
    if (str_info)
    {
        sprintf(str_info, "Free Physical Memory (Kbytes): %*I64d", WIDTH, statex.ullAvailPhys / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
    ...
    if (str_info)
    {
        sprintf(str_info, "Total Paging File (Kbytes): %*I64d", WIDTH, statex.ullTotalPageFile / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
    ...
    if (str_info)
    {
        sprintf(str_info, "Free Paging File (Kbytes): %*I64d", WIDTH, statex.ullAvailPageFile / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
    ...
    if (str_info)
    {
        sprintf(str_info, "Total Virtual Memory (Kbytes): %*I64d", WIDTH, statex.ullTotalVirtual / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
    ...
    if (str_info)
    {
        sprintf(str_info, "Free Virtual Memory (Kbytes): %*I64d", WIDTH, statex.ullAvailVirtual / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
    ...
    if (str_info)
    {
        sprintf(str_info, "Free Extended Memory (Kbytes): %*I64d", WIDTH, statex.ullAvailExtendedVirtual / DIV);
        outputDynamicList = appendStringDebugInfo(outputDynamicList, &nb_info, str_info);
    }
