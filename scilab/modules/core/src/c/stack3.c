...
void CreateCSparseVarFromPtr(int _iNewVal, int _iRows, int _iCols, int _iTotalElem, int *_piElemByRow, int *_piColByRow, double *_pdblRealData,
                             double *_pdblImgData)
{
    int iIndex = 0;
    int iAddrBase = iadr(*Lstk(Top - Rhs + _iNewVal));
...
int iAllocComplexMatrixOfPoly(int _iNewVal, int _iComplex, int **_piVarName, int _iRows, int _iCols, int *_piPow, double **_pdblRealData,
                              double **_pdblImgData)
{
...
/*for internal use, assign values in variable without, VarNum, just scilab address*/
int iAllocComplexMatrixOfPolyToAddress(int _iAddr, int _iComplex, int **_piVarName, int _iRows, int _iCols, int *_piPow, double **_pdblRealData,
                                       double **_pdblImgData)
{
...
int iAllocComplexSparseMatrix(int _iNewVal, int _iComplex, int _iRows, int _iCols, int _iTotalElem, int **_piElemByRow, int **_piColByRow,
...
int iGetListItemSparse(int _iVar, int _iItemNumber, int *_piRows, int *_piCols, int *_piTotalElem, int *_piElemByRow, double **_pdblReal,
                       double **_pdblImg)
{
    return 0;
}
...
int iListAllocComplexMatrixOfDouble(int _iVar, int *_piParent, int _iItemPos, int _iComplex, int _iRows, int _iCols, double **_pdblRealData,
                                    double **_pdblImgData)
{
    //int iAddrBase     = iadr(*Lstk(Top - Rhs + _iVar));
...
/*Reserve space in stack for a matrix of complex polynom*/
int iListAllocComplexMatrixOfPoly(int _iVar, int *_piParent, int _iItemPos, int _iComplex, int **_piVarName, int _iRows, int _iCols, int *_piPow,
                                  double **_pdblRealData, double **_pdblImgData)
{
    int iAddrBase = iadr(*Lstk(Top - Rhs + _iVar));
    ...
    iAddrData = iAddrBase + (9 + _iRows * _iCols);
    piItemPos[_iItemPos] =
        piItemPos[_iItemPos - 1] + ((9 + _iRows * _iCols) + !((_iRows * _iCols) % 2)) / 2 + iArraySum(_piPow, 0, _iRows * _iCols) * (_iComplex + 1);
    if (_iItemPos == iItemNumber)
    {
...
int iGetComplexSparseFromPointer(int *_piAddr, int *_piRows, int *_piCols, int *_piTotalElem, int *_piElemByRow, double **_pdblReal,
                                 double **_pdblImg)
{
    return 0;
}
...
int iGetComplexMatlabSparseFromPointer(int *_piAddr, int *_piRows, int *_piCols, int *_piTotalElem, int *_piElemByRow, double **_pdblReal,
                                       double **_pdblImg)
{
    return 0;
}
