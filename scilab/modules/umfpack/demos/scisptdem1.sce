...
function demo1()
    ...
    messagebox(_(["To load a sparse matrix  stored  in  the  Harwell";
    "Boeing format in scilab, you may use the function";
    "                                                 ";
    "                 ReadHBSparse                    ";
    "                                                 ";
    "4 matrices will be loaded for the demo: they come";
    " from the University of Florida Sparse Matrix    "
    "Collection:                                      ";
    "                                                 ";
    ...
    mode(1)
    [A1,descr1,ref1,mtype1] = ReadHBSparse(SCI+"/modules/umfpack/demos/arc130.rua");
    [A2,descr2,ref2,mtype2] = ReadHBSparse(SCI+"/modules/umfpack/demos/bcsstk24.rsa");
    [A3,descr3,ref3,mtype3] = ReadHBSparse(SCI+"/modules/umfpack/demos/ex14.rua");
    [A4,descr4,ref4,mtype4] = ReadHBSparse(SCI+"/modules/umfpack/demos/young1c.csa");

    mode(-1)
    messagebox(_(["To see the pattern of non zeros elements";
    ...
    messagebox(_(["Now, using umfpack to solve some linear systems:      ";
    "                                                   ";
    ...
    messagebox(_([" A1 ("+descr1+"): order = "+ string(n1) + " nnz = " + string(nnz(A1));
    ...
    messagebox(_(["             Now we will see how to use the lu factors:                 ";
    "                                                                       ";
    ...
    "        umf_ludel(lup)                                                 ";
    "                                                                       ";
    " If you have lost your pointer you may use umf_ludel() which frees all the";
    ...
    messagebox(_(["            Now we will see how to use the taucs snmf stuff            ";
    ...
    messagebox(_([" On the s.p.d. matrix A2: ";
    " A2 ("+descr2+"): order = "+ string(n2) + " nnz = " + string(nnz(A2));
    " K2 (1-norm) = " + string(K2);
