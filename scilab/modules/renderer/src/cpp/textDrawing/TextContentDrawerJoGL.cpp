...
{
/*---------------------------------------------------------------------------------*/
    TextContentDrawerJoGL::TextContentDrawerJoGL(DrawableText * drawer):DrawTextContentStrategy(drawer), DrawableObjectJoGL(drawer)
    {
...
/*---------------------------------------------------------------------------------*/
    void TextContentDrawerJoGL::getPixelLength(sciPointObj * parentSubwin, const double startingPoint[3],
                                               double userWidth, double userHeight, double &pixelWidth, double &pixelHeight)
    {
...
/*---------------------------------------------------------------------------------*/
    void TextContentDrawerJoGL::convertCornersArray(const double corners[12],
                                                    double corner1[3], double corner2[3], double corner3[3], double corner4[3])
    {
        // we got an array of size 12
        ...
        m_pDrawed->inversePointScale(corner1[0], corner1[1], corner1[2], &(corner1[0]), &(corner1[1]), &(corner1[2]));
        m_pDrawed->inversePointScale(corner2[0], corner2[1], corner2[2], &(corner2[0]), &(corner2[1]), &(corner2[2]));
        m_pDrawed->inversePointScale(corner3[0], corner3[1], corner3[2], &(corner3[0]), &(corner3[1]), &(corner3[2]));
        m_pDrawed->inversePointScale(corner4[0], corner4[1], corner4[2], &(corner4[0]), &(corner4[1]), &(corner4[2]));
    }
/*---------------------------------------------------------------------------------*/
