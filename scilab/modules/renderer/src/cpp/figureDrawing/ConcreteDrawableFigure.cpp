...
{
/*---------------------------------------------------------------------------------*/
    ConcreteDrawableFigure::ConcreteDrawableFigure(sciPointObj * pObj):DrawableFigure(pObj)
    {
...
/*---------------------------------------------------------------------------------*/
    list < sciPointObj * >ConcreteDrawableFigure::getChildrenOfSubwin(sciPointObj * parentSubwin, list < sciPointObj * >pObjs)
    {
