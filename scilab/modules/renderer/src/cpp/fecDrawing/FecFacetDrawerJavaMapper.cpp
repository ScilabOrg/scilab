...
/*---------------------------------------------------------------------------------*/
    void FecFacetDrawerJavaMapper::setFacetParameters(double zMin, double zMax, int colMin, int colMax, int colOutLow, int colOutUp)
    {
...
/*---------------------------------------------------------------------------------*/
                                           ...
                                           const int firstPoints[], const int secondPoints[], const int thirdPoints[], int nbTriangles)
    {
        m_pJavaObject->drawFec((double *)xCoords, nbNodes,
                               ...
                               (int *)firstPoints, nbTriangles, (int *)secondPoints, nbTriangles, (int *)thirdPoints, nbTriangles);
    }
/*---------------------------------------------------------------------------------*/
