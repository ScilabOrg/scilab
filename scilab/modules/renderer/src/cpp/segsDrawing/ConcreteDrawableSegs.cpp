...
/*---------------------------------------------------------------------------------*/
      ConcreteDrawableSegs::ConcreteDrawableSegs(sciPointObj * pSegs):DrawableSegs(pSegs)
    {
        m_oDrawers.clear();
        m_pDecomposer = NULL;
    }
...
/*---------------------------------------------------------------------------------*/
    ...
    {
        m_pDecomposer->getSegsPos(startXcoords, endXCoords, startYCoords, endYCoords, startZCoords, endZcoords);
    }
/*---------------------------------------------------------------------------------*/
