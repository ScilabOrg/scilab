...
/*---------------------------------------------------------------------------------*/
    void SegsArrowDrawerJavaMapper::setAxesBounds(double xMin, double xMax, double yMin, double yMax, double zMin, double zMax)
    {
...
/*---------------------------------------------------------------------------------*/
    void SegsArrowDrawerJavaMapper::drawSegs(const double startXCoords[], const double endXCoords[],
                                             ...
                                             const double startZCoords[], const double endZCoords[], const int colors[], int nbSegments)
    {
        m_pJavaObject->drawSegs((double *)startXCoords, nbSegments,
                                ...
                                (double *)startZCoords, nbSegments, (double *)endZCoords, nbSegments, (int *)colors, nbSegments);
    }
/*---------------------------------------------------------------------------------*/
