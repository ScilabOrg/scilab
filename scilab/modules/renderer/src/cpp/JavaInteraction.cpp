...
/*---------------------------------------------------------------------------------*/
int *javaClickRubberBox(char *pstObjUID, int *initialRect, int iRectSize)
{
    return org_scilab_modules_renderer::CallRenderer::clickRubberBox(getScilabJavaVM(), pstObjUID, initialRect, iRectSize);
}

/*---------------------------------------------------------------------------------*/
int *javaDragRubberBox(char *pstObjUID, int *initialRect, int iRectSize)
{
    return org_scilab_modules_renderer::CallRenderer::dragRubberBox(getScilabJavaVM(), pstObjUID, initialRect,  iRectSize);
}
