...
/*---------------------------------------------------------------------------------*/
    DrawableClippedObjectJoGL::DrawableClippedObjectJoGL(DrawableObject * drawer):DrawableObjectJoGL(drawer)
    {
        m_dXmin = 0.0;
        m_dXmax = 0.0;
...
/*---------------------------------------------------------------------------------*/
    void DrawableClippedObjectJoGL::setClipBox(double xMin, double xMax, double yMin, double yMax, double zMin, double zMax)
    {
        m_dXmin = xMin;
        m_dXmax = xMax;
