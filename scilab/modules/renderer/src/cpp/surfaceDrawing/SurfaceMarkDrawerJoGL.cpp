...
{
/*---------------------------------------------------------------------------------*/
    SurfaceMarkDrawerJoGL::SurfaceMarkDrawerJoGL(DrawableSurface * surface):DrawSurfaceStrategy(surface), DrawableObjectJoGL(surface)
    {
...
/*---------------------------------------------------------------------------------*/
    void SurfaceMarkDrawerJoGL::drawSurface(void)
    {
        ...
        getMarkDrawerJavaMapper()->setMarkParameters(sciGetGraphicContext(pSurface)->markbackground,
                                                     ...
                                                     sciGetMarkSizeUnit(pSurface), sciGetMarkSize(pSurface), sciGetMarkStyle(pSurface));
        try
        {
            getMarkDrawerJavaMapper()->drawSurface(xCoords, sizeXCoord, yCoords, sizeYCoord, zCoords, sizeZCoord, nbVertexPerFacet);
        }
