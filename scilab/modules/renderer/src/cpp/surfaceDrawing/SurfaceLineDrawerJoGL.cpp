...
{
/*---------------------------------------------------------------------------------*/
    SurfaceLineDrawerJoGL::SurfaceLineDrawerJoGL(DrawableSurface * surface):DrawSurfaceStrategy(surface), DrawableObjectJoGL(surface)
    {
...
/*---------------------------------------------------------------------------------*/
    void SurfaceLineDrawerJoGL::drawSurface(void)
    {
        ...
        getLineDrawerJavaMapper()->setLineParameters(sciGetGraphicContext(pSurface)->foregroundcolor,
                                                     (float)sciGetLineWidth(pSurface), sciGetLineStyle(pSurface));
        try
        {
            getLineDrawerJavaMapper()->drawSurface(xCoords, sizeXCoord, yCoords, sizeYCoord, zCoords, sizeZCoord, nbVertexPerFacet);
        }
