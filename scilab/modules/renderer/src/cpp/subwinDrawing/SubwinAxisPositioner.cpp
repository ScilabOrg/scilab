...
/*------------------------------------------------------------------------------------------*/
    SubwinAxisPositioner::SubwinAxisPositioner(DrawableSubwin * subwin):AxisPositioner()
    {
        m_pSubwin = subwin;
...
/*------------------------------------------------------------------------------------------*/
    bool SubwinAxisPositioner::checkTicksDirection(const double ticksDir[3], const double axisSegmentStart[3], const double axisSegmentEnd[3])
    {
