...
{
/*------------------------------------------------------------------------------------------*/
    GridDrawer::GridDrawer(void):DrawableObjectBridge()
    {
...
/*------------------------------------------------------------------------------------------*/
    void GridDrawer::draw(const double firstAxisStart[3], const double firstAxisEnd[3],
                          ...
                          const double relativeTicksPositions[], int nbTicks, const double relativeSubticksPositions[], int nbSubticks)
    {
        ...
        if (m_bDrawSubticksGrid)
        {
            ...
            drawGrid(firstAxisStart, firstAxisEnd, secondAxisStart, secondAxisEnd, thirdAxisStart, thirdAxisEnd, gridAbscissas, nbTicks + nbSubticks);
            delete[]gridAbscissas;
        }
        else
        {
            drawGrid(firstAxisStart, firstAxisEnd, secondAxisStart, secondAxisEnd, thirdAxisStart, thirdAxisEnd, relativeTicksPositions, nbTicks);
        }
