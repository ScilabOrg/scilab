...
/*--------------------------------------------------------------------------*/
    void FullBoxDrawerJavaMapper::setBoxParameters(int hiddenAxisColor, int lineColor, int lineStyle, float thickness)
    {
        m_pJavaObject->setBoxParameters(hiddenAxisColor, lineColor, lineStyle, thickness);
    }
/*--------------------------------------------------------------------------*/
    void FullBoxDrawerJavaMapper::drawBox(double xMin, double xMax, double yMin, double yMax, double zMin, double zMax, int concealedCornerIndex)
    {
