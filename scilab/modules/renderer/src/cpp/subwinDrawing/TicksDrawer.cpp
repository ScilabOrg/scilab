...
double TicksDrawer::drawTicks(void)
{
  ...
  case SCI_AXES:
    /*
     * This is to be consistent with AxesSubticksComputer which treats subint as
     * equal to the number of subticks per tick + 1
     */
    pAXES_FEATURE( pObj )->subint = subTicksPerGrad+1;
  }
