...
public class LegendDrawer {
        ...
        public void draw(Legend legend) throws SciRendererException {
                ...
                Sprite legendSprite = null;

                if (nbValidLinks > 0) {
                    legendSprite = getSprite(colorMap, legend);
                }
                ...
                if (nbValidLinks > 0) {
                    normSpriteWidth = (double) legendSprite.getWidth() / (double) canvasWidth;
                    normSpriteHeight = (double) legendSprite.getHeight() / (double) canvasHeight;
                }
