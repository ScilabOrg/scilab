...
public class DragZoomRotateInteraction extends FigureInteraction {
     ...
     */
    public DragZoomRotateInteraction(Figure figure, Component component) {
    ...
    private class FigureMouseListener extends MouseAdapter implements MouseListener {
        ...
        public void mouseReleased(MouseEvent e) {
            pressedButtons--;
            if (pressedButtons == 0) {
                getComponent().removeMouseMotionListener(mouseMotionListener);
                currentAxes = null;
            }
        }
        ...
        public void mouseEntered(MouseEvent e) {
            GlobalEventWatcher.setAxesUID(getFigure().getIdentifier());
        }
    }
