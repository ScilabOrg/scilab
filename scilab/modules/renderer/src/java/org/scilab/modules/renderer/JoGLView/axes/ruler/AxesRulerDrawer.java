...
public class AxesRulerDrawer {
    ...
    public void drawRuler(Axes axes, AxesDrawer axesDrawer, ColorMap colorMap, DrawingTools drawingTools) {
        ...
        if (px.getNorm2() > pz.getNorm2()) {
            rulerModel.setTicksDirection(new Vector3d(TICKS_SIZE * yAxisPosition.getX(), 0, 0));
        } else {
            rulerModel.setTicksDirection(new Vector3d(0, 0, TICKS_SIZE * yAxisPosition.getZ()));
        }
