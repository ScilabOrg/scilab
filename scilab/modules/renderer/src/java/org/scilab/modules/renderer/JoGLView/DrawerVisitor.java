...
import org.scilab.forge.scirenderer.canvas.interfaces.core.math.IVector3d;
import org.scilab.forge.scirenderer.canvas.interfaces.core.math.Vector3d;
...
import org.scilab.forge.scirenderer.canvas.interfaces.geometry.buffers.FinalVertexBuffer;
...
public class DrawerVisitor implements IVisitor {
    ...
    private static final IVertexBuffer boxBorderVertices =
        new FinalVertexBuffer(new IVector3d[] {
    ...
    private static final IVertexBuffer hiddenBoxBorderVertices =
        new FinalVertexBuffer(new IVector3d[] {
            new Vector3d(-1,-1,-1), new Vector3d(+1,-1,-1),
            new Vector3d(-1,-1,-1), new Vector3d(-1,+1,-1),
            new Vector3d(-1,-1,-1), new Vector3d(-1,-1,+1)
    ...
    private static final IVertexBuffer frontBoxBorderVertices =
        new FinalVertexBuffer(new IVector3d[] {
            new Vector3d(+1,+1,+1), new Vector3d(-1,+1,+1),
            new Vector3d(+1,+1,+1), new Vector3d(+1,-1,+1),
            new Vector3d(+1,+1,+1), new Vector3d(+1,+1,-1)
    ...
    public void visit(Axes axes) {
        if (axes.getVisible()) {
            ...
            IColor backgroundColor = colorMap.getScilabColor(axes.getBackground());
            ...
            if (boxed != Box.BoxType.OFF) {
                ...
                IColor lineColor;
                lineColor = colorMap.getScilabColor(axes.getHiddenAxisColor());
                ...
                if (boxed != Box.BoxType.HIDDEN_AXES) {
                    lineColor = colorMap.getScilabColor(axes.getLineColor());
                    lines.getLineProperties().getMaterial().setDiffuseColor(lineColor);
