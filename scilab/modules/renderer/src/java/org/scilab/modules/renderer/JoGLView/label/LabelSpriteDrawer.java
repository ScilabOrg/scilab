...
public class LabelSpriteDrawer implements SpriteDrawer {
    ...
    /**
     * Compute and return the matrix of text string from the given {@see Label} label.
     * @param label the given {@see Label} label.
     * @return the matrix of text string from the given {@see Label} label.
     */
     ...
     * @param text the given scilab label.
