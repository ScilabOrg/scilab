...
public class TextManager {
     ...
     * @throws DegenerateMatrixException.
     */
    private double[] computeRatios(Transformation projection, Text text, Vector3d[] textBoxVectors, int spriteWidth, int spriteHeight, int baseSpriteW, int baseSpriteH) {
