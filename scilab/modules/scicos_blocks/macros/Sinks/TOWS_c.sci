...
function [x,y,typ]=TOWS_c(job,arg1,arg2)
    ...
    case "set" then
        ...
        while %t do
            ...
            if varnam == "%e" | varnam == "%i" | varnam == "%io" | varnam == "%eps" | varnam == "%f" |...
                varnam == "%t" | varnam == "$" | varnam == "%fftw" | varnam == "%gui"| varnam == "TMPDIR" |...
                varnam == "SCI" | varnam == "SCIHOME" | varnam == "%inf" | varnam == "%nan"| varnam == "%T" |...
                varnam == "%F" | varnam == "%tk" | varnam == "PWD" | varnam == "corelib"| varnam == "differential_equationlib" |...
                ...
                varnam == "modules_managerlib" | varnam == "external_objectslib" | varnam == "home" then
                r = %f;
            end
            if ~r then
