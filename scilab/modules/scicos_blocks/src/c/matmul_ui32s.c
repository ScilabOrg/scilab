...
SCICOS_BLOCKS_IMPEXP void matmul_ui32s(scicos_block *block, int flag)
{
    if ((flag == 1) | (flag == 6))
    {
        ...
        SCSUINT32_COD *u1 = Getuint32InPortPtrs(block, 1);
        SCSUINT32_COD *u2 = Getuint32InPortPtrs(block, 2);
        SCSUINT32_COD *y = Getuint32OutPortPtrs(block, 1);
