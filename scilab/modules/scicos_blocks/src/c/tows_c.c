    ...
    else if (flag == 5)
    {
        ...
        if (ptr != NULL)
        {
            ...
            */
            ...
            code2str(&varName, block->ipar + 2, varNameLen); /* save the Scilab name into varName */
            if (ismat)
            {
                nRows  = ptr_i[39]; /* nz  */
                nCols  = ptr_i[38]; /* nu  */
                ...
                switch (ut)
                {
                    case SCSREAL_N    :
                        if (ismat)
                        {
                            ...
                            sciErr = createNamedMatrixOfDouble(NULL, varName, nCols, nRows, MatDouble);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfDouble(NULL, varName, nRows, nCols, MatDouble);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSCOMPLEX_N :
                        ...
                        else
                        {
                            ...
                            for (i = 0; i < nRows * nCols; ++i)
                            {
                                MatComplexReal[i] = ptr_d[i];
                                MatComplexImg[i]  = ptr_d[i + nRows * nCols];
                            }
                            /* pass Matrix to Scilab */
                            sciErr = createNamedComplexMatrixOfDouble(NULL, varName, nRows, nCols, MatComplexReal, MatComplexImg);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSINT8_N    :
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfInteger8(NULL, varName, nRows, nCols, MatInt8);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSINT16_N   :
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfInteger16(NULL, varName, nRows, nCols, MatInt16);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSINT32_N   :
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfInteger32(NULL, varName, nRows, nCols, MatInt32);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSUINT8_N   :
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfUnsignedInteger8(NULL, varName, nRows, nCols, MatUInt8);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSUINT16_N  :
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfUnsignedInteger16(NULL, varName, nRows, nCols, MatUInt16);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
                    ...
                    case SCSUINT32_N  :
                        ...
                        else
                        {
                            ...
                            /* pass Matrix to Scilab */
                            sciErr = createNamedMatrixOfUnsignedInteger32(NULL, varName, nRows, nCols, MatUInt32);
                            if (sciErr.iErr)
                            {
                                scicos_free(ptr->workt);
                                scicos_free(ptr);
