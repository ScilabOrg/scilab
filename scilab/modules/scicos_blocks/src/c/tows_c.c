...
*/
{
    ...
    if (flag == 4)
    {
         ...
         * t
         */
        if ((ptr->workt = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * sizeof(double))) == NULL)
        {
            set_block_error(-16);
            scicos_free(ptr);
            *(block->work) = NULL;
        ...
        case SCSREAL_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) +
                                                       (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(double))) == NULL)
                {
                    set_block_error(-16);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(double))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSCOMPLEX_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) +
                                                       (3) * sizeof(int) + 4 * sizeof(int) + 2 * nz * nu * nu2 * sizeof(double))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + 2 * nz * nu * sizeof(double))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSINT8_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       4 * sizeof(int) +
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) + (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(char))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(char))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSINT16_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) +
                                                       (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(short))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(short))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSINT32_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       4 * sizeof(int) +
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) + (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(long))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(long))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSUINT8_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) +
                                                       (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(unsigned char))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(unsigned char))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSUINT16_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) +
                                                       (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(unsigned short))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(unsigned short))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
        ...
        case SCSUINT32_N:
            if (ismat)
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) +
                                                       ...
                                                       (2 + 4 + 7) * sizeof(int) +
                                                       4 * sizeof(int) +
                                                       (3) * sizeof(int) + 4 * sizeof(int) + nz * nu * nu2 * sizeof(unsigned long))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
            ...
            {
                if ((ptr->work = (void *)scicos_malloc(6 * sizeof(int) + 4 * sizeof(int) + nz * nu * sizeof(unsigned long))) == NULL)
                {
                    set_block_error(-16);
                    scicos_free(ptr->workt);
                    scicos_free(ptr);
    ...
    else if (flag == 5)
    {
        ...
        if (ptr != NULL)
        {
            ...
            C2F(cvstr) (&(block->ipar[1]), &(block->ipar[2]), str, (j = 1, &j), (unsigned long)strlen(str));
            str[block->ipar[1]] = '\0';
                ...
                else
                {
                    ...
                    if (ptr_i[8] == 1)
                    {
                        ...
                        case SCSCOMPLEX_N:
                            for (j = 0; j < ptr->cnt; j++)
                            {
                                *((double *)(&ptr_i[10]) + (j + ptr->cnt)) = *((double *)(&ptr_i[10]) + (j + nz * nu));
                            }
                            break;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        case SCSREAL_N:
                            for (i = 0; i < ptr_i[8] - 1; i++)
                            {
                                for (j = 0; j < ptr->cnt; j++)
                                {
                                    *((double *)(&ptr_i[10]) + (((i + 1) * nz) + j - (i + 1) * k)) = *((double *)(&ptr_i[10]) + (((i + 1) * nz) + j));
                                }
                            }
                            break;
                        ...
                        case SCSINT8_N:
                            for (i = 0; i < ptr_i[8] - 1; i++)
                            {
                                for (j = 0; j < ptr->cnt; j++)
                                {
                                    *((char *)(&ptr_i[10]) + (((i + 1) * nz) + j - (i + 1) * k)) = *((char *)(&ptr_i[10]) + (((i + 1) * nz) + j));
                                }
                            }
                            break;
                        ...
                        case SCSINT16_N:
                            for (i = 0; i < ptr_i[8] - 1; i++)
                            {
                                for (j = 0; j < ptr->cnt; j++)
                                {
                                    *((short *)(&ptr_i[10]) + (((i + 1) * nz) + j - (i + 1) * k)) = *((short *)(&ptr_i[10]) + (((i + 1) * nz) + j));
                                }
                            }
                            break;
                        ...
                        case SCSINT32_N:
                            for (i = 0; i < ptr_i[8] - 1; i++)
                            {
                                for (j = 0; j < ptr->cnt; j++)
                                {
                                    *((long *)(&ptr_i[10]) + (((i + 1) * nz) + j - (i + 1) * k)) = *((long *)(&ptr_i[10]) + (((i + 1) * nz) + j));
                                }
                            }
                            break;
                    ...
                    if (ismat)
                    {
                        for (i = 0; i < (nz - ptr->cnt); i++)
                        {
                            ...
                            for (j = (nz - 1); j >= 1; j--)
                            {
                                for (k = 0; k < nu * nu2; k++)
                                {
                                    *((unsigned char *)(&ptr_i[44]) + k + j * (nu * nu2)) =
                                        *((unsigned char *)(&ptr_i[44]) + k + (j - 1) * (nu * nu2));
                                }
                            }
                            for (k = 0; k < nu * nu2; k++)
                            {
                    ...
                    if (ismat)
                    {
                        for (i = 0; i < (nz - ptr->cnt); i++)
                        {
                            ...
                            for (j = (nz - 1); j >= 1; j--)
                            {
                                for (k = 0; k < nu * nu2; k++)
                                {
                                    *((unsigned short *)(&ptr_i[44]) + k + j * (nu * nu2)) =
                                        *((unsigned short *)(&ptr_i[44]) + k + (j - 1) * (nu * nu2));
                                }
                            }
                            for (k = 0; k < nu * nu2; k++)
                            {
                    ...
                    if (ismat)
                    {
                        for (i = 0; i < (nz - ptr->cnt); i++)
                        {
                            ...
                            for (j = (nz - 1); j >= 1; j--)
                            {
                                for (k = 0; k < nu * nu2; k++)
                                {
                                    *((unsigned long *)(&ptr_i[44]) + k + j * (nu * nu2)) =
                                        *((unsigned long *)(&ptr_i[44]) + k + (j - 1) * (nu * nu2));
                                }
                            }
                            for (k = 0; k < nu * nu2; k++)
                            {
