...
void EqEqChecker::preCheckNode(const ast::Exp & e, SLintContext & context, SLintResult & result)
{
    ...
    {
        result.report(context, e.getLocation(), L"Possible confusion between assignment operator \'=' and equality operator \'==\'.");
    }
}
...
const std::wstring EqEqChecker::getName() const
{
    return L"EqEqChecker";
}
}
