...
void UpdateConsoleColors(void)
{
    ...
    FillConsoleOutputAttribute(hConsole,
                               ...
                               csbiInfoSave.dwSize.X * csbiInfoSave.dwSize.Y, Coord, &cWritten);
...
void RestoreConsoleColors(void)
{
    ...
    FillConsoleOutputAttribute(hConsole, csbiInfoSave.wAttributes, csbiInfoSave.dwSize.X * csbiInfoSave.dwSize.Y, Coord, &cWritten);
