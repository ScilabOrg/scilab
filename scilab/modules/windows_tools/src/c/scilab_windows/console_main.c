...
int Console_Main(int argc, char **argv)
{
    ...
    while (argcount > 0)
    {
        ...
        else if (_stricmp(my_argv[argcount], "-NS") == 0)
            startupf = 1;
        ...
        else if ((_stricmp(my_argv[argcount], "-VERSION") == 0) || (_stricmp(my_argv[argcount], "-VER") == 0))
        {
            disp_scilab_version();
            exit(1);
        }
        ...
        else if ((_stricmp(my_argv[argcount], "-H") == 0) || (_stricmp(my_argv[argcount], "-?") == 0) || (_stricmp(my_argv[argcount], "-HELP") == 0))
        {
