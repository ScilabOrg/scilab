 ...
 */
public class ScilabFileSelectorButtons {
    ...
    public ScilabFileSelectorButtons(ScilabFileSelectorComboBox combobox) {
	this.combobox = combobox;
	combobox.setButtons(this);
    }
	...
	previous.setAction(new CallBack(null) {
		public void callBack() {
		    combobox.setBaseDirAndValidate(history.get(position - 1));
