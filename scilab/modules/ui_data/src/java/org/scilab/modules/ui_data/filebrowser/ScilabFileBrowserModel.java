...
public class ScilabFileBrowserModel extends AbstractScilabTreeTableModel implements ScilabTreeTableModel {
	...
	setRoot(new FileNode(new File(baseDir)));
	fireTreeStructureChanged(this, new TreePath(root).getPath(), null, null);
    }
    ...
    public int getChildCount(Object node) {
        return ((FileNode) node).getChildrenCount();
    }
	...
	private boolean isEmpty;
	    ...
	    this.isEmpty = CommonFileUtils.isEmptyDirectory(file.getAbsolutePath()) == 1;
        }
		...
		|| isEmpty != (CommonFileUtils.isEmptyDirectory(file.getAbsolutePath()) == 1);
        }
        ...
        public boolean isLeaf() {
            return file.isFile() || isEmpty; //getChildrenCount() == 0;
        }
