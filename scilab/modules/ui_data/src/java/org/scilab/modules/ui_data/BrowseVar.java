...
public class BrowseVar {
     ...
     */
    public static void openVariableBrowser(String[] columnNames, String[] dataNames, int[] dataBytes, int[] dataTypes, String[] dataVisibility, int refresh) {
	...
	ScilabVariableBrowser.getVariableBrowser(columnNames, data, refresh);
    }
