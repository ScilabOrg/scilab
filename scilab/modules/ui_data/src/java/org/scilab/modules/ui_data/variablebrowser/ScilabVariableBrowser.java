...
public final class ScilabVariableBrowser extends ScilabWindow implements VariableBrowser {
     ...
     */
    public static VariableBrowser getVariableBrowser(String[] columnNames, Object[][] data, int refresh) {
	if (refresh == 1 && instance == null) {
	    return null;
	}
	...
	browserTab.close();
	((SwingScilabVariableBrowser) browserTab).stopRefreshThread();
	instance = null;
    }
