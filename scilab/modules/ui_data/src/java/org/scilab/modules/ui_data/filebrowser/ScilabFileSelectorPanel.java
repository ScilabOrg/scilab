...
public class ScilabFileSelectorPanel extends JPanel {
    ...
    private void init() {
        ...
        int height = table.getComboBox().getPreferredSize().height;
        changeDirButton.setPreferredSize(new Dimension(height, height));
        upDirButton.setPreferredSize(new Dimension(height, height));
