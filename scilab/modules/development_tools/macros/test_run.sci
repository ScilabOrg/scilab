...
function test_run(varargin)
    ...
    if rhs >= 3 then
        ...
        params.disp_summary = assign_option(option_mat, "no_summary", %f, params.disp_summary);
        option_mat          = clean_option(option_mat, "no_summary");
