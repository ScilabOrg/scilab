...
refP = gsort(P,"g","i");
assert_checkequal ( size(P) , [size(X) 2] );
assert_checkequal ( refP(1,:,1,1) , X(1,:,1) );
assert_checkequal ( refP(2,:,1,1) , X(1,:,1) );
assert_checkequal ( refP(1,:,2,1) , X(2,:,1) );
assert_checkequal ( refP(2,:,2,1) , X(2,:,1) );
assert_checkequal ( refP(1,:,1,2) , X(1,:,2) );
assert_checkequal ( refP(2,:,1,2) , X(1,:,2) );
assert_checkequal ( refP(1,:,2,2) , X(2,:,2) );
assert_checkequal ( refP(2,:,2,2) , X(2,:,2) );
