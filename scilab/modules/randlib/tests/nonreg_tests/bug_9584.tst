...
errMsg1 = msprintf(_("%s: Wrong value for first input argument: Positive scalar expected.\n"),"Rand");
errMsg2 = msprintf(_("%s: Wrong value for second input argument: Positive scalar expected.\n"),"Rand");
