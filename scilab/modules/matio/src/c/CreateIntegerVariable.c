    ...
    if (matVariable->rank == 2) /* 2-D array */
    {
        switch (integerType)
        {
            case I_CHAR:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfInteger8(pvApiCtx, iVar, nbRow, nbCol, tmp_int8);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfInteger8InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_int8);
                    MATIO_ERROR;
                }
            ...
            case I_INT16:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfInteger16(pvApiCtx, iVar, nbRow, nbCol, tmp_int16);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfInteger16InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_int16);
                    MATIO_ERROR;
                }
            ...
            case I_INT32:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfInteger32(pvApiCtx, iVar, nbRow, nbCol, tmp_int32);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfInteger32InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_int32);
                    MATIO_ERROR;
                }
            ...
            case I_INT64:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfInteger64(pvApiCtx, iVar, nbRow, nbCol, tmp_int64);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfInteger64InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_int64);
                    MATIO_ERROR;
                }
            ...
            case I_UCHAR:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfUnsignedInteger8(pvApiCtx, iVar, nbRow, nbCol, tmp_uint8);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfUnsignedInteger8InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_uint8);
                    MATIO_ERROR;
                }
            ...
            case I_UINT16:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfUnsignedInteger16(pvApiCtx, iVar, nbRow, nbCol, tmp_uint16);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfUnsignedInteger16InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_uint16);
                    MATIO_ERROR;
                }
            ...
            case I_UINT32:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfUnsignedInteger32(pvApiCtx, iVar, nbRow, nbCol, tmp_uint32);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfUnsignedInteger32InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_uint32);
                    MATIO_ERROR;
                }
            ...
            case I_UINT64:
                ...
                if (parent == NULL)
                {
                    _SciErr = createMatrixOfUnsignedInteger64(pvApiCtx, iVar, nbRow, nbCol, tmp_uint64);
                    MATIO_ERROR;
                }
                else
                {
                    _SciErr = createMatrixOfUnsignedInteger64InList(pvApiCtx, iVar, parent, item_position, nbRow, nbCol, tmp_uint64);
                    MATIO_ERROR;
                }
