...
namespace analysis
{
    ...
    AnalysisVisitor::MapSymCall AnalysisVisitor::initCalls()
    {
        ...
        msc.emplace(symbol::Symbol(L"zeros"), std::shared_ptr<CallAnalyzer>(new ZerosAnalyzer()));
        msc.emplace(symbol::Symbol(L"ones"), std::shared_ptr<CallAnalyzer>(new OnesAnalyzer()));
        msc.emplace(symbol::Symbol(L"rand"), std::shared_ptr<CallAnalyzer>(new RandAnalyzer()));
        msc.emplace(symbol::Symbol(L"matrix"), std::shared_ptr<CallAnalyzer>(new MatrixAnalyzer()));
        msc.emplace(symbol::Symbol(L"eye"), std::shared_ptr<CallAnalyzer>(new EyeAnalyzer()));

        std::shared_ptr<CallAnalyzer> ca(new CeilAnalyzer());
        msc.emplace(symbol::Symbol(L"ceil"), ca);
        msc.emplace(symbol::Symbol(L"floor"), ca);
        msc.emplace(symbol::Symbol(L"round"), ca);
        msc.emplace(symbol::Symbol(L"fix"), ca);
        msc.emplace(symbol::Symbol(L"int"), ca);

        //msc.emplace(symbol::Symbol(L"sqrt"), std::shared_ptr<CallAnalyzer>(new SqrtAnalyzer()));
        msc.emplace(symbol::Symbol(L"argn"), std::shared_ptr<CallAnalyzer>(new ArgnAnalyzer()));
        msc.emplace(symbol::Symbol(L"size"), std::shared_ptr<CallAnalyzer>(new SizeAnalyzer()));
        msc.emplace(symbol::Symbol(L"length"), std::shared_ptr<CallAnalyzer>(new LengthAnalyzer()));
        msc.emplace(symbol::Symbol(L"diag"), std::shared_ptr<CallAnalyzer>(new DiagAnalyzer()));
