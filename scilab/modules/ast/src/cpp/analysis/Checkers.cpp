...
TIType (*Checkers::ARGS1[55])(GVN &, const TIType &);
...
Checkers::CheckersMap Checkers::initMap()
{
    ...
    map.emplace(__NName(1, L"real"), __Infos(27, false, false, false));
    map.emplace(__NName(1, L"int32"), __Infos(28, true, false, true));
    map.emplace(__NName(1, L"inttype"), __Infos(29, false, false, false));
    map.emplace(__NName(1, L"exp"), __Infos(30, true, false, true));
    map.emplace(__NName(1, L"atan"), __Infos(31, true, false, true));
    map.emplace(__NName(1, L"imag"), __Infos(32, false, false, false));
    map.emplace(__NName(1, L"uint8"), __Infos(33, true, false, true));
    map.emplace(__NName(1, L"ceil"), __Infos(34, true, false, true));
    map.emplace(__NName(1, L"uint64"), __Infos(35, true, false, true));
    map.emplace(__NName(1, L"sinm"), __Infos(36, false, false, false));
    map.emplace(__NName(1, L"isinf"), __Infos(37, true, false, true));
    map.emplace(__NName(1, L"sinh"), __Infos(38, true, false, true));
    map.emplace(__NName(1, L"isscalar"), __Infos(39, false, false, false));
    map.emplace(__NName(1, L"sign"), __Infos(40, true, false, true));
    map.emplace(__NName(1, L"int8"), __Infos(41, true, false, true));
    map.emplace(__NName(1, L"cos"), __Infos(42, true, false, true));
    map.emplace(__NName(1, L"and"), __Infos(43, false, false, false));
    map.emplace(__NName(1, L"tanh"), __Infos(44, true, false, true));
    map.emplace(__NName(1, L"isnan"), __Infos(45, true, false, true));
    map.emplace(__NName(1, L"imult"), __Infos(46, false, false, false));
    map.emplace(__NName(1, L"argn"), __Infos(47, false, false, false));
    map.emplace(__NName(1, L"cumprod"), __Infos(48, true, false, true));
    map.emplace(__NName(1, L"erf"), __Infos(49, true, false, true));
    map.emplace(__NName(1, L"ones"), __Infos(50, false, false, false));
    map.emplace(__NName(1, L"erfc"), __Infos(51, true, false, true));
    map.emplace(__NName(1, L"min"), __Infos(52, false, false, true));
    map.emplace(__NName(1, L"sum"), __Infos(53, false, false, true));
    map.emplace(__NName(1, L"acos"), __Infos(54, true, false, false));
    ...
    ARGS1[27] = &check_real;
    ARGS1[28] = &check_int32;
    ARGS1[29] = &check_inttype;
    ARGS1[30] = &check_exp;
    ARGS1[31] = &check_atan;
    ARGS1[32] = &check_imag;
    ARGS1[33] = &check_uint8;
    ARGS1[34] = &check_ceil;
    ARGS1[35] = &check_uint64;
    ARGS1[36] = &check_sinm;
    ARGS1[37] = &check_isinf;
    ARGS1[38] = &check_sinh;
    ARGS1[39] = &check_isscalar;
    ARGS1[40] = &check_sign;
    ARGS1[41] = &check_int8;
    ARGS1[42] = &check_cos;
    ARGS1[43] = &check_and;
    ARGS1[44] = &check_tanh;
    ARGS1[45] = &check_isnan;
    ARGS1[46] = &check_imult;
    ARGS1[47] = &check_argn;
    ARGS1[48] = &check_cumprod;
    ARGS1[49] = &check_erf;
    ARGS1[50] = &check_ones;
    ARGS1[51] = &check_erfc;
    ARGS1[52] = &check_min;
