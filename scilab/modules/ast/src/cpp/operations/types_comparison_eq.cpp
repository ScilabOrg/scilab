...
#define scilab_fill_comparisonequal(id1, id2, func, typeIn1, typeIn2, typeOut) \
    ...
    scilab_fill_comparisonequal(Double, Bool, M_M, Double, Bool, Bool);
    scilab_fill_comparisonequal(Double, Polynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(Double, Sparse, M_M, Double, Sparse, SparseBool);

    //Matrix == Matrix Complex
    scilab_fill_comparisonequal(Double, DoubleComplex, M_MC, Double, Double, Bool);
    scilab_fill_comparisonequal(Double, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(Double, SparseComplex, M_M, Double, Sparse, SparseBool);
    ...
    scilab_fill_comparisonequal(Double, ScalarBool, M_S, Double, Bool, Bool);
    scilab_fill_comparisonequal(Double, ScalarPolynom, M_M, Double, Polynom, Bool);

    //Matrix == Scalar Complex
    scilab_fill_comparisonequal(Double, ScalarDoubleComplex, M_SC, Double, Double, Bool);
    scilab_fill_comparisonequal(Double, ScalarPolynomComplex, M_M, Double, Polynom, Bool);
    ...
    scilab_fill_comparisonequal(DoubleComplex, Polynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(DoubleComplex, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(DoubleComplex, ScalarPolynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(DoubleComplex, ScalarPolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(DoubleComplex, Sparse, M_M, Double, Sparse, SparseBool);
    scilab_fill_comparisonequal(DoubleComplex, SparseComplex, M_M, Double, Sparse, SparseBool);
    ...
    scilab_fill_comparisonequal(ScalarDouble, Bool, S_M, Double, Bool, Bool);
    scilab_fill_comparisonequal(ScalarDouble, Polynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(ScalarDouble, Sparse, M_M, Double, Sparse, SparseBool);

    //Scalar == Matrix Complex
    scilab_fill_comparisonequal(ScalarDouble, DoubleComplex, S_MC, Double, Double, Bool);
    scilab_fill_comparisonequal(ScalarDouble, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(ScalarDouble, SparseComplex, M_M, Double, Sparse, SparseBool);
    ...
    scilab_fill_comparisonequal(ScalarDouble, ScalarBool, S_S, Double, Bool, Bool);
    scilab_fill_comparisonequal(ScalarDouble, ScalarPolynom, M_M, Double, Polynom, Bool);

    //Scalar == Scalar Complex
    scilab_fill_comparisonequal(ScalarDouble, ScalarDoubleComplex, S_SC, Double, Double, Bool);
    scilab_fill_comparisonequal(ScalarDouble, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(ScalarDouble, ScalarPolynomComplex, M_M, Double, Polynom, Bool);
    ...
    scilab_fill_comparisonequal(ScalarDoubleComplex, Polynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(ScalarDoubleComplex, Sparse, M_M, Double, Sparse, SparseBool);
    //Scalar Complex == Matrix Complex
    scilab_fill_comparisonequal(ScalarDoubleComplex, DoubleComplex, SC_MC, Double, Double, Bool);
    scilab_fill_comparisonequal(ScalarDoubleComplex, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(ScalarDoubleComplex, SparseComplex, M_M, Double, Sparse, SparseBool);
    //Scalar Complex == Scalar
    scilab_fill_comparisonequal(ScalarDoubleComplex, ScalarDouble, SC_S, Double, Double, Bool);
    scilab_fill_comparisonequal(ScalarDoubleComplex, ScalarPolynom, M_M, Double, Polynom, Bool);
    ...
    scilab_fill_comparisonequal(ScalarDoubleComplex, ScalarPolynomComplex, M_M, Double, Polynom, Bool);
    ...
    //Empty == Empty
    scilab_fill_comparisonequal(Empty, Empty, E_M, Double, Double, Bool);
    //Empty == eye
    ...
    scilab_fill_comparisonequal(Int8, Bool, M_M, Int8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int8, ScalarBool, M_S, Int8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt8, Bool, S_M, Int8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt8, ScalarBool, S_S, Int8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt8, Bool, M_M, UInt8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt8, ScalarBool, M_S, UInt8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt8, Bool, S_M, UInt8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt8, ScalarBool, S_S, UInt8, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int16, Bool, M_M, Int16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int16, ScalarBool, M_E, Int16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt16, Bool, S_M, Int16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt16, ScalarBool, S_S, Int16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt16, Bool, M_M, UInt16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt16, ScalarBool, M_S, UInt16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt16, Bool, S_M, UInt16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt16, ScalarBool, S_S, UInt16, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int32, Bool, M_M, Int32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int32, ScalarBool, M_S, Int32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt32, Bool, S_M, Int32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt32, ScalarBool, S_S, Int32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt32, Bool, M_M, UInt32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt32, ScalarBool, M_S, UInt32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt32, Bool, S_M, UInt32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt32, ScalarBool, S_S, UInt32, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int64, Bool, M_M, Int64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(Int64, ScalarBool, M_S, Int64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt64, Bool, S_M, Int64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarInt64, ScalarBool, S_S, Int64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt64, Bool, M_M, UInt64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(UInt64, ScalarBool, M_S, UInt64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt64, Bool, S_M, UInt64, Bool, Bool);
    ...
    scilab_fill_comparisonequal(ScalarUInt64, ScalarBool, S_S, UInt64, Bool, Bool);

    //Bool
    //Matrix == Matrix
    scilab_fill_comparisonequal(Bool, Double, M_M, Bool, Double, Bool);
    scilab_fill_comparisonequal(Bool, Int8, M_M, Bool, Int8, Bool);
    scilab_fill_comparisonequal(Bool, UInt8, M_M, Bool, UInt8, Bool);
    scilab_fill_comparisonequal(Bool, Int16, M_M, Bool, Int16, Bool);
    scilab_fill_comparisonequal(Bool, UInt16, M_M, Bool, UInt16, Bool);
    scilab_fill_comparisonequal(Bool, Int32, M_M, Bool, Int32, Bool);
    scilab_fill_comparisonequal(Bool, UInt32, M_M, Bool, UInt32, Bool);
    scilab_fill_comparisonequal(Bool, Int64, M_M, Bool, Int64, Bool);
    scilab_fill_comparisonequal(Bool, UInt64, M_M, Bool, UInt64, Bool);
    scilab_fill_comparisonequal(Bool, Bool, M_M, Bool, Bool, Bool);
    scilab_fill_comparisonequal(Bool, Empty, M_E, Bool, Double, Bool);

    //Matrix == Scalar
    scilab_fill_comparisonequal(Bool, ScalarDouble, M_S, Bool, Double, Bool);
    scilab_fill_comparisonequal(Bool, ScalarInt8, M_S, Bool, Int8, Bool);
    scilab_fill_comparisonequal(Bool, ScalarUInt8, M_S, Bool, UInt8, Bool);
    scilab_fill_comparisonequal(Bool, ScalarInt16, M_S, Bool, Int16, Bool);
    scilab_fill_comparisonequal(Bool, ScalarUInt16, M_S, Bool, UInt16, Bool);
    scilab_fill_comparisonequal(Bool, ScalarInt32, M_S, Bool, Int32, Bool);
    scilab_fill_comparisonequal(Bool, ScalarUInt32, M_S, Bool, UInt32, Bool);
    scilab_fill_comparisonequal(Bool, ScalarInt64, M_S, Bool, Int64, Bool);
    scilab_fill_comparisonequal(Bool, ScalarUInt64, M_S, Bool, UInt64, Bool);
    scilab_fill_comparisonequal(Bool, ScalarBool, M_S, Bool, Bool, Bool);

    //Scalar == Matrix
    scilab_fill_comparisonequal(ScalarBool, Double, S_M, Bool, Double, Bool);
    scilab_fill_comparisonequal(ScalarBool, Int8, S_M, Bool, Int8, Bool);
    scilab_fill_comparisonequal(ScalarBool, UInt8, S_M, Bool, UInt8, Bool);
    scilab_fill_comparisonequal(ScalarBool, Int16, S_M, Bool, Int16, Bool);
    scilab_fill_comparisonequal(ScalarBool, UInt16, S_M, Bool, UInt16, Bool);
    scilab_fill_comparisonequal(ScalarBool, Int32, S_M, Bool, Int32, Bool);
    scilab_fill_comparisonequal(ScalarBool, UInt32, S_M, Bool, UInt32, Bool);
    scilab_fill_comparisonequal(ScalarBool, Int64, S_M, Bool, Int64, Bool);
    scilab_fill_comparisonequal(ScalarBool, UInt64, S_M, Bool, UInt64, Bool);
    ...
    //Scalar == Scalar
    scilab_fill_comparisonequal(ScalarBool, ScalarDouble, S_S, Bool, Double, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarInt8, S_S, Bool, Int8, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarUInt8, S_S, Bool, UInt8, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarInt16, S_S, Bool, Int16, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarUInt16, S_S, Bool, UInt16, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarInt32, S_S, Bool, Int32, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarUInt32, S_S, Bool, UInt32, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarInt64, S_S, Bool, Int64, Bool);
    scilab_fill_comparisonequal(ScalarBool, ScalarUInt64, S_S, Bool, UInt64, Bool);
    ...
    scilab_fill_comparisonequal(Identity, Polynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(Identity, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(Identity, ScalarPolynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(Identity, ScalarPolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(Identity, Sparse, M_M, Double, Sparse, SparseBool);
    scilab_fill_comparisonequal(Identity, SparseComplex, M_M, Double, Sparse, SparseBool);
    ...
    scilab_fill_comparisonequal(IdentityComplex, Polynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(IdentityComplex, PolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(IdentityComplex, ScalarPolynom, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(IdentityComplex, ScalarPolynomComplex, M_M, Double, Polynom, Bool);
    scilab_fill_comparisonequal(IdentityComplex, Sparse, M_M, Double, Sparse, SparseBool);
    scilab_fill_comparisonequal(IdentityComplex, SparseComplex, M_M, Double, Sparse, SparseBool);
    ...
    //poly == double
    scilab_fill_comparisonequal(Polynom, Double, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(Polynom, DoubleComplex, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(PolynomComplex, Double, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(PolynomComplex, DoubleComplex, M_M, Polynom, Double, Bool);

    //poly == scalar double
    scilab_fill_comparisonequal(Polynom, ScalarDouble, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(Polynom, ScalarDoubleComplex, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(PolynomComplex, ScalarDouble, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(PolynomComplex, ScalarDoubleComplex, M_M, Polynom, Double, Bool);
    ...
    //poly == eye
    scilab_fill_comparisonequal(Polynom, Identity, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(Polynom, IdentityComplex, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(PolynomComplex, Identity, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(PolynomComplex, IdentityComplex, M_M, Polynom, Double, Bool);
    ...
    //scalar poly == double
    scilab_fill_comparisonequal(ScalarPolynom, Double, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynom, DoubleComplex, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynomComplex, Double, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynomComplex, DoubleComplex, M_M, Polynom, Double, Bool);

    //scalar poly == scalar double
    scilab_fill_comparisonequal(ScalarPolynom, ScalarDouble, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynom, ScalarDoubleComplex, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynomComplex, ScalarDouble, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynomComplex, ScalarDoubleComplex, M_M, Polynom, Double, Bool);
    ...
    //scalar poly == eye
    scilab_fill_comparisonequal(ScalarPolynom, Identity, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynom, IdentityComplex, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynomComplex, Identity, M_M, Polynom, Double, Bool);
    scilab_fill_comparisonequal(ScalarPolynomComplex, IdentityComplex, M_M, Polynom, Double, Bool);
    ...
    scilab_fill_comparisonequal(Sparse, Double, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(Sparse, DoubleComplex, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(Sparse, ScalarDouble, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(Sparse, ScalarDoubleComplex, M_M, Sparse, Double, SparseBool);

    scilab_fill_comparisonequal(Sparse, Empty, M_E, Sparse, Double, Bool);
    scilab_fill_comparisonequal(Sparse, Identity, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(Sparse, IdentityComplex, M_M, Sparse, Double, SparseBool);
    ...
    scilab_fill_comparisonequal(SparseComplex, Double, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(SparseComplex, DoubleComplex, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(SparseComplex, ScalarDouble, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(SparseComplex, ScalarDoubleComplex, M_M, Sparse, Double, SparseBool);

    scilab_fill_comparisonequal(SparseComplex, Empty, M_E, Sparse, Double, Bool);
    scilab_fill_comparisonequal(SparseComplex, Identity, M_M, Sparse, Double, SparseBool);
    scilab_fill_comparisonequal(SparseComplex, IdentityComplex, M_M, Sparse, Double, SparseBool);
...
InternalType *GenericComparisonEqual(InternalType *_pLeftOperand, InternalType *_pRightOperand)
{
    ...
    compequal_function compequal = pComparisonEqualfunction[_pRightOperand->getId()][_pLeftOperand->getId()];
    if (compequal)
    {
        pResult = compequal(_pRightOperand, _pLeftOperand);
        if (pResult)
        {
            return pResult;
        }
...
InternalType* compequal_M_E(T *_pL, U *_pR)
{
    if (_pL->isDouble())
    {
        ...
        Double* pdblTempo = _pL->getAs<Double>();
        return new Bool(pdblTempo->isEmpty());
    }
...
InternalType* compequal_E_M(T *_pL, U *_pR)
{
    if (_pR->isDouble())
    {
        Double* pdblTempo = _pR->getAs<Double>();
        return new Bool(pdblTempo->isEmpty());
    }
    return new Bool(false);
}
...
//
template<>
InternalType* compequal_M_M<Double, Sparse, SparseBool>(Double* _pL, Sparse* _pR)
{
    return NULL;
    //pending changes
...
template<>
InternalType* compequal_M_M<Sparse, Double, SparseBool>(Sparse* _pL, Double* _pR)
{
    return NULL;
    //pending changes
...
template<>
InternalType* compequal_M_M<Polynom, Double, Bool>(Polynom* _pL, Double* _pR)
{
    Bool* pbOut = NULL;
        ...
        if (_pL->isComplex())
        {
            if (_pR->isComplex())
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pSPR[i]->getImg(0), pdblEye->get(i), pdblEye->getImg(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pSPR[i]->getImg(0), pdblEye->get(i), (double)0, &(pbOut->get()[i]));
                    }
                }
            }
        }
        else
        {
            if (_pR->isComplex())
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), (double)0, pdblEye->get(i), pdblEye->getImg(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                ...
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pdblEye->get(i), &(pbOut->get()[i]));
                    }
                }
            }
        }
        ...
        if (_pL->isComplex())
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pSPR[i]->getImg(0), _pR->get(0), _pR->getImg(0), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pSPR[i]->getImg(0), _pR->get(0), double(0), &(pbOut->get()[i]));
                    }
                }
            }
        }
        else
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), (double)0, _pR->get(0), _pR->getImg(0), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), _pR->get(0), &(pbOut->get()[i]));
                    }
                }
            }
        }
        ...
        if (pSPR[0]->getSize() == 1)
        {
            if (_pL->isComplex())
            {
                if (_pR->isComplex())
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compequal(pSPR[0]->get(0), pSPR[0]->getImg(0), _pR->get(i), _pR->getImg(i), &(pbOut->get()[i]));
                    }
                }
                else
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compequal(pSPR[0]->get(0), pSPR[0]->getImg(0), _pR->get(i), double(0), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                if (_pR->isComplex())
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compequal(pSPR[0]->get(0), (double)0, _pR->get(i), _pR->getImg(i), &(pbOut->get()[i]));
                    }
                }
                else
                {
                    for (int i = 0; i < iSize; i++)
                    {
                        compequal(pSPR[0]->get(0), _pR->get(i), &(pbOut->get()[i]));
                    }
                }
        ...
        if (_pL->isComplex())
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pSPR[i]->getImg(0), _pR->get(i), _pR->getImg(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), pSPR[i]->getImg(0), _pR->get(i), (double)0, &(pbOut->get()[i]));
                    }
                }
            }
        }
        else
        {
            if (_pR->isComplex())
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), (double)0, _pR->get(i), _pR->getImg(i), &(pbOut->get()[i]));
                    }
                }
            }
            else
            {
                for (int i = 0; i < iSize; i++)
                {
                    ...
                    {
                        compequal(pSPR[i]->get(0), _pR->get(i), &(pbOut->get()[i]));
                    }
                }
            }
        }
...
template<>
InternalType* compequal_M_M<Double, Polynom, Bool>(Double* _pL, Polynom* _pR)
{
    return compequal_M_M<Polynom, Double, Bool>(_pR, _pL);
}
