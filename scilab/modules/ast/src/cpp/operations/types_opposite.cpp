...
//Sparse
types::InternalType* opposite_M(types::Sparse *_pL)
{
...
types::InternalType* opposite_MC(types::Sparse *_pL)
{
    types::Sparse* pOut = (types::Sparse*)(_pL->clone());
    pOut->opposite();
    return pOut;
...
//Polynom
types::InternalType* opposite_S(types::Polynom *_pL)
{
...
types::InternalType* opposite_SC(types::Polynom *_pL)
{
    types::Polynom* pOut = (types::Polynom*)_pL->clone();
    types::SinglePoly* pSPL = _pL->get(0);
    types::SinglePoly* pSPO = pOut->get(0);
...
types::InternalType* opposite_M(types::Polynom *_pL)
{
    types::Polynom* pOut = (types::Polynom*)_pL->clone();
...
types::InternalType* opposite_MC(types::Polynom *_pL)
{
    types::Polynom* pOut = (types::Polynom*)_pL->clone();
