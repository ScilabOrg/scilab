    ...
    end(0)
{
    ...
    //    {
    //        triple.setTriple(llvm::sys::getProcessTriple());
    //    }
    //
    //    if (triple.isOSWindows() && !triple.isOSBinFormatELF())
    //    {
    //        //triple.setObjectFormat(llvm::Triple::ELF);
    //        std::cout << "add -elf flag" << std::endl;
    //        module.setTargetTriple(triple.getTriple() + "-elf");
    //    }
    //#endif
