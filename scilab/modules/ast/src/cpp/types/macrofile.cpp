...
bool MacroFile::parse(void)
{
    if (m_pMacro == NULL)
    {
        ...
        for (j = LExp.begin() ; j != LExp.end() ; j++)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    std::wcerr << "Macrofile: the library contains two macros with the same name" << std::endl;
                    delete macro;
                }
            }
        }
        ...
        else
        {
            ...
            std::wcerr << "Macrofile: the library doesn't contain a macro with the library name" << std::endl;
            for (const auto & macro : sub)
            {
                delete macro.second;
            }
