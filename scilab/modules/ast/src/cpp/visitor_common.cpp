    ...
    if (TypeDest != TypeSource)
    {
        ...
        switch (TypeDest)
        {
            case types::GenericType::RealDouble :
                ...
                //                    // The concatenation of Double and Sparse is a Sparse
                //
                //                    // /!\ types::Double poDest is not initialized to zeros !!!  /!\
                ...
                //                            {
                //                                spResult->set((int)pRows[i] + iCurRow - 1, (int)pCols[i] + iCurCol - 1, std::complex<double>(pNonZeroR[i], pNonZeroI[i]));
                //                            }
                //                        }
                //                        else
                //                        {
                //                            for (int i = 0; i < nonZeros; i++)
                //                            {
                //                                spResult->set((int)pRows[i] + iCurRow - 1, (int)pCols[i] + iCurCol - 1, std::complex<double>(pNonZeroR[i], 0));
                //                            }
                //                        }
                //                    }
                //                    else
                ...
                //                        for (int i = 0; i < nonZeros; i++)
                //                        {
                //                            spResult->set((int)pRows[i] + iCurRow - 1, (int)pCols[i] + iCurCol - 1, pNonZeroR[i]);
                //                        }
                //                    }
                //                }
                break;
