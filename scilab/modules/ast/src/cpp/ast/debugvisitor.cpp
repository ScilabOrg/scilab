...
const std::wstring clYELLOW = L"\033[1;33m";
...
{
    *ostr << L"@(" << YELLOW << loc.first_line << L"." << NORMAL << loc.first_column << NORMAL << L" -> "
          << YELLOW << loc.last_line << L"." << NORMAL << loc.last_column << NORMAL << L")";
}
