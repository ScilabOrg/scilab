...
private :
    ...
    static __threadSignal m_TCLExecDone;
    static __threadSignalLock m_TCLExecDoneLock;
...
public :
    ...
    static void SendTCLExecDoneSignal(void);
    static void WaitForTCLExecDoneSignal(void);
