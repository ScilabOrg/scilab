...
public :
    ...
    ArrayOf<T>* insert(typed_list* _pArgs, InternalType* _pSource);
    ...
    ArrayOf<T>* resize(int* _piDims, int _iDims);
    ...
    ArrayOf<T>* reshape(int _iNewRows, int _iNewCols)
    {
        int piDims[2] = {_iNewRows, _iNewCols};
        return reshape(piDims, 2);
    }

    ArrayOf<T>* reshape(int* _piDims, int _iDims);


    ArrayOf<T>* resize(int _iNewRows, int _iNewCols)
    {
        int piDims[2] = {_iNewRows, _iNewCols};
