...
template<> double get(RealSparse_t SPARSE_CONST&s, int r, int c)
{
    return s.coeff(r, c);
}
template<> std::complex<double> get(RealSparse_t SPARSE_CONST&s, int r, int c)
{
    return std::complex<double>(s.coeff(r, c), 0.);
}

template<> bool get(BoolSparse_t SPARSE_CONST& d, int r, int c)
{
    return d.coeff(r, c);
}

template<> double get(CplxSparse_t SPARSE_CONST&s, int r, int c)
{
    return s.coeff(r, c).real();
}
template<> std::complex<double> get(CplxSparse_t SPARSE_CONST&s, int r, int c)
{
    return s.coeff(r, c);
}
 ...
 */
template<> bool set(RealSparse_t& s, int r, int c, double v)
{
    if (v != 0.)
    {
        s.insert(r, c) = v;
...
template<> bool set(RealSparse_t& s, int r, int c, std::complex<double> v)
{
    if ( v.real() != 0.)
    {
        s.insert(r, c) = v.real();
...
template<> bool set(CplxSparse_t& s, int r, int c, double v)
{
    if (v != 0.)
    {
...
template<> bool set(CplxSparse_t& s, int r, int c, std::complex<double> v)
{
    if (v != cplxZero)
    {
        s.insert(r, c) = v;
...
template<> bool set(BoolSparse_t& s, int r, int c, bool v)
{
    if (v)
    {
        s.insert(r, c) = v;
