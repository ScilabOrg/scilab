...
EXTERN_AST bool getStructFromExp(const ast::Exp* _pExp, std::list<types::InternalType*>& structHistory, std::list<std::wstring>& argHistory, types::typed_list** _pArgs, types::InternalType* _pAssignValue);
EXTERN_AST bool updateStructFromHistory(std::list<types::InternalType*>& structHistory, std::list<std::wstring>& fieldHistory);
