...
template<> types::InternalType* compequal_M_M<types::Double, types::Sparse, types::Bool>(types::Double* _pL, types::Sparse* _pR);
template<> types::InternalType* compequal_M_M<types::Sparse, types::Double, types::Bool>(types::Sparse* _pL, types::Double* _pR);
template<> types::InternalType* compequal_M_M<types::Double, types::Sparse, types::SparseBool>(types::Double* _pL, types::Sparse* _pR);
template<> types::InternalType* compequal_M_M<types::Sparse, types::Double, types::SparseBool>(types::Sparse* _pL, types::Double* _pR);

template<> types::InternalType* compequal_M_M<types::Polynom, types::Polynom, types::Bool>(types::Polynom* _pL, types::Polynom* _pR);
template<> types::InternalType* compequal_M_M<types::Polynom, types::Double, types::Bool>(types::Polynom* _pL, types::Double* _pR);
template<> types::InternalType* compequal_M_M<types::Double, types::Polynom, types::Bool>(types::Double* _pL, types::Polynom* _pR);
