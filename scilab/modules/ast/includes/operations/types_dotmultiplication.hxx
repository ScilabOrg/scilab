...
//x .* x
template<typename T, typename U, typename O> inline static void dotmul(T* l, long long size, U* r, O* o)
{
...
//xC .* x
template<typename T, typename U, typename O> inline static void dotmul(T* l, T* lc, long long size, U* r, O* o, O* oc)
{
    for (int i = 0; i < size ; ++i)
    {
        o[i] = (O)l[i] * (O)r[i];
...
//x .* xC
template<typename T, typename U, typename O> inline static void dotmul(T* l, long long size, U* r, U* rc, O* o, O* oc)
{
    for (int i = 0; i < size ; ++i)
    {
        o[i] = (O)l[i] * (O)r[i];
...
//xC .* xC
template<typename T, typename U, typename O> inline static void dotmul(T* l, T* lc, long long size, U* r, U* rc, O* o, O* oc)
{
    for (int i = 0; i < size ; ++i)
    {
