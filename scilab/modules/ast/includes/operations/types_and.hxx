...
//x & x
template<typename T, typename U, typename O> inline static void and (T* l, long long size, U* r, O* o)
{
...
//x1 & x1
template<typename T, typename U, typename O> inline static void and (T l, U r, O* o)
{
