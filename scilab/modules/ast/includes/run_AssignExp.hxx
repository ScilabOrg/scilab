    ...
    try
    {
        ...
        if (pCall)
        {
            ...
            if (pVar == NULL)
            {
                ...
                std::list<symbol::Symbol*> fieldHistory;
                ...
                if (getStructFromExp(pCall, structHistory, fieldHistory, argHistory, pITR, bFromCallExp))
                {
        ...
        if (pField)
        {
            ...
            //try to find struct or handle
            {
                ...
                std::list<types::typed_list*> argHistory;
                bool bComplexForm = false;
                if (getStructFromExp(pField, structHistory, fieldHistory, argHistory, pIT, bComplexForm) == false)
                {
