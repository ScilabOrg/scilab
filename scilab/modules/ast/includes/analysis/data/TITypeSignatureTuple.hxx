...
namespace analysis
{
	...
	inline std::vector<TITypeSignature> & getTypes() { return types; }

	inline const std::vector<TITypeSignature> & getTypes() const { return types; }
	...
	inline void emplace(const TIType & t)
        ...
        inline std::size_t size() const { return types.size(); }
        ...
        struct Hash
        {
            inline std::size_t operator()(const TITypeSignatureTuple & tuple) const { return tuple.hash(); }
        };

        struct Eq
        {
            inline bool operator()(const TITypeSignatureTuple & L, const TITypeSignatureTuple & R) const { return L == R; }
        };
    };
