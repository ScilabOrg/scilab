...
namespace analysis
{
    ...
    public :
        ...
        enum BlockKind { NORMAL, LOOP, EXCLUSIVE, MACRO };
	...
	inline std::map<symbol::Symbol, Info> & getMap() { return symMap; }
	...
	inline ast::Exp * getExp() { return exp; }
