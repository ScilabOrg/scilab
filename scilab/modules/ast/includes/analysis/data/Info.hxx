...
namespace analysis
{
	...
	ast::Exp * exp;
        ...
        Info(Data * _data = nullptr) : R(false), W(false), O(false), isint(false), local(Local::TRUE), cleared(false), exists(true), knownValue(false), data(_data), gvnValue(nullptr), exp(nullptr) { }
        ...
        inline void addData(const bool known, const symbol::Symbol & sym) { data = new Data(known, sym); }
	...
	inline bool isknown() const
        ...
        inline const TIType & getType() const { return type; }
