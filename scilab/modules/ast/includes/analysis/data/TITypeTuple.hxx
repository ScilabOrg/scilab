...
namespace analysis
{
	...
	inline std::size_t size() const { return types.size(); }
        ...
        struct Hash
        {
            inline std::size_t operator()(const TITypeTuple & tuple) const { return tuple.hash(); }
        };

        struct Eq
        {
            inline bool operator()(const TITypeTuple & L, const TITypeTuple & R) const { return L == R; }
        };
    };
