...
struct Breakpoint
{
    Breakpoint(std::wstring functionName, int iLine = -1, std::wstring condition = std::wstring(L""))
        : _pFunctionName(functionName), _iMacroLine(iLine), _file(L""), _condition(condition), _conditionExp(NULL) {}
