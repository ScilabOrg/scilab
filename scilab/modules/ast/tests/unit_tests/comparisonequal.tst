...
//assert_checkequal(r == SP, "error");
//assert_checkequal(r == SPC, "error");
//assert_checkequal(r == SP1, "error");
//assert_checkequal(r == SPC1, "error");
...
//assert_checkequal(c == SP, "error");
//assert_checkequal(c == SPC, "error");
//assert_checkequal(c == SP1, "error");
//assert_checkequal(c == SPC1, "error");
...
//assert_checkequal(e == SP, "error");
//assert_checkequal(e == SPC, "error");
//assert_checkequal(e == SP1, "error");
//assert_checkequal(e == SPC1, "error");
...
//assert_checkequal(ec == SP, "error");
//assert_checkequal(ec == SPC, "error");
//assert_checkequal(ec == SP1, "error");
//assert_checkequal(ec == SPC1, "error");
...
//assert_checkequal(p == SP, "error");
//assert_checkequal(p == SPC, "error");
//assert_checkequal(p == SP1, "error");
//assert_checkequal(p == SPC1, "error");
//assert_checkequal(p == i8, "error");
//assert_checkequal(p == I8, "error");
//assert_checkequal(p == ui8, "error");
//assert_checkequal(p == UI8, "error");
//assert_checkequal(p == i16, "error");
//assert_checkequal(p == I16, "error");
//assert_checkequal(p == ui16, "error");
//assert_checkequal(p == UI16, "error");
//assert_checkequal(p == i32, "error");
//assert_checkequal(p == I32, "error");
//assert_checkequal(p == ui32, "error");
//assert_checkequal(p == UI32, "error");
...
//assert_checkequal(pc == SP, "error");
//assert_checkequal(pc == SPC, "error");
//assert_checkequal(pc == SP1, "error");
//assert_checkequal(pc == SPC1, "error");
//assert_checkequal(pc == i8, "error");
//assert_checkequal(pc == I8, "error");
//assert_checkequal(pc == ui8, "error");
//assert_checkequal(pc == UI8, "error");
//assert_checkequal(pc == i16, "error");
//assert_checkequal(pc == I16, "error");
//assert_checkequal(pc == ui16, "error");
//assert_checkequal(pc == UI16, "error");
//assert_checkequal(pc == i32, "error");
//assert_checkequal(pc == I32, "error");
//assert_checkequal(pc == ui32, "error");
//assert_checkequal(pc == UI32, "error");
...
//assert_checkequal(SP == r, "error");
//assert_checkequal(SP == c, "error");
//assert_checkequal(SP == R, "error");
//assert_checkequal(SP == C, "error");
//assert_checkequal(SP == e, "error");
//assert_checkequal(SP == ec, "error");
//assert_checkequal(SP == p, "error");
//assert_checkequal(SP == pc, "error");
//assert_checkequal(SP == P, "error");
//assert_checkequal(SP == PC, "error");
//assert_checkequal(SP == SP, "error");
//assert_checkequal(SP == SPC, "error");
//assert_checkequal(SP == SP1, "error");
//assert_checkequal(SP == SPC1, "error");
//assert_checkequal(SP == i8, "error");
//assert_checkequal(SP == I8, "error");
//assert_checkequal(SP == ui8, "error");
//assert_checkequal(SP == UI8, "error");
//assert_checkequal(SP == i16, "error");
//assert_checkequal(SP == I16, "error");
//assert_checkequal(SP == ui16, "error");
//assert_checkequal(SP == UI16, "error");
//assert_checkequal(SP == i32, "error");
//assert_checkequal(SP == I32, "error");
//assert_checkequal(SP == ui32, "error");
//assert_checkequal(SP == UI32, "error");
assert_checkequal(SP == str, %f);
assert_checkequal(SP == STR, %f);

assert_checkequal(SPC == empty, %f);
//assert_checkequal(SPC == r, "error");
//assert_checkequal(SPC == c, "error");
//assert_checkequal(SPC == R, "error");
//assert_checkequal(SPC == C, "error");
//assert_checkequal(SPC == e, "error");
//assert_checkequal(SPC == ec, "error");
//assert_checkequal(SPC == p, "error");
//assert_checkequal(SPC == pc, "error");
//assert_checkequal(SPC == P, "error");
//assert_checkequal(SPC == PC, "error");
//assert_checkequal(SPC == SP, "error");
//assert_checkequal(SPC == SPC, "error");
//assert_checkequal(SPC == SP1, "error");
//assert_checkequal(SPC == SPC1, "error");
//assert_checkequal(SPC == i8, "error");
//assert_checkequal(SPC == I8, "error");
//assert_checkequal(SPC == ui8, "error");
//assert_checkequal(SPC == UI8, "error");
//assert_checkequal(SPC == i16, "error");
//assert_checkequal(SPC == I16, "error");
//assert_checkequal(SPC == ui16, "error");
//assert_checkequal(SPC == UI16, "error");
//assert_checkequal(SPC == i32, "error");
//assert_checkequal(SPC == I32, "error");
//assert_checkequal(SPC == ui32, "error");
//assert_checkequal(SPC == UI32, "error");
assert_checkequal(SPC == str, %f);
assert_checkequal(SPC == STR, %f);

assert_checkequal(SP1 == empty, %f);
//assert_checkequal(SP1 == r, "error");
//assert_checkequal(SP1 == c, "error");
//assert_checkequal(SP1 == R, "error");
//assert_checkequal(SP1 == C, "error");
//assert_checkequal(SP1 == e, "error");
//assert_checkequal(SP1 == ec, "error");
//assert_checkequal(SP1 == p, "error");
//assert_checkequal(SP1 == pc, "error");
//assert_checkequal(SP1 == P, "error");
//assert_checkequal(SP1 == PC, "error");
//assert_checkequal(SP1 == SP, "error");
//assert_checkequal(SP1 == SPC, "error");
//assert_checkequal(SP1 == SP1, "error");
//assert_checkequal(SP1 == SPC1, "error");
//assert_checkequal(SP1 == i8, "error");
//assert_checkequal(SP1 == I8, "error");
//assert_checkequal(SP1 == ui8, "error");
//assert_checkequal(SP1 == UI8, "error");
//assert_checkequal(SP1 == i16, "error");
//assert_checkequal(SP1 == I16, "error");
//assert_checkequal(SP1 == ui16, "error");
//assert_checkequal(SP1 == UI16, "error");
//assert_checkequal(SP1 == i32, "error");
//assert_checkequal(SP1 == I32, "error");
//assert_checkequal(SP1 == ui32, "error");
//assert_checkequal(SP1 == UI32, "error");
assert_checkequal(SP1 == str, %f);
assert_checkequal(SP1 == STR, %f);

assert_checkequal(SPC1 == empty, %f);
//assert_checkequal(SPC1 == r, "error");
//assert_checkequal(SPC1 == c, "error");
//assert_checkequal(SPC1 == R, "error");
//assert_checkequal(SPC1 == C, "error");
//assert_checkequal(SPC1 == e, "error");
//assert_checkequal(SPC1 == ec, "error");
//assert_checkequal(SPC1 == p, "error");
//assert_checkequal(SPC1 == pc, "error");
//assert_checkequal(SPC1 == P, "error");
//assert_checkequal(SPC1 == PC, "error");
//assert_checkequal(SPC1 == SP, "error");
//assert_checkequal(SPC1 == SPC, "error");
//assert_checkequal(SPC1 == SP1, "error");
//assert_checkequal(SPC1 == SPC1, "error");
//assert_checkequal(SPC1 == i8, "error");
//assert_checkequal(SPC1 == I8, "error");
//assert_checkequal(SPC1 == ui8, "error");
//assert_checkequal(SPC1 == UI8, "error");
//assert_checkequal(SPC1 == i16, "error");
//assert_checkequal(SPC1 == I16, "error");
//assert_checkequal(SPC1 == ui16, "error");
//assert_checkequal(SPC1 == UI16, "error");
//assert_checkequal(SPC1 == i32, "error");
//assert_checkequal(SPC1 == I32, "error");
//assert_checkequal(SPC1 == ui32, "error");
//assert_checkequal(SPC1 == UI32, "error");
...
//assert_checkequal(i8 == p, "error");
//assert_checkequal(i8 == pc, "error");
//assert_checkequal(i8 == P, "error");
//assert_checkequal(i8 == PC, "error");
//assert_checkequal(i8 == SP, "error");
//assert_checkequal(i8 == SPC, "error");
//assert_checkequal(i8 == SP1, "error");
//assert_checkequal(i8 == SPC1, "error");
...
//assert_checkequal(ui8 == p, "error");
//assert_checkequal(ui8 == pc, "error");
//assert_checkequal(ui8 == P, "error");
//assert_checkequal(ui8 == PC, "error");
//assert_checkequal(ui8 == SP, "error");
//assert_checkequal(ui8 == SPC, "error");
//assert_checkequal(ui8 == SP1, "error");
//assert_checkequal(ui8 == SPC1, "error");
...
//assert_checkequal(i16 == p, "error");
//assert_checkequal(i16 == pc, "error");
//assert_checkequal(i16 == P, "error");
//assert_checkequal(i16 == PC, "error");
//assert_checkequal(i16 == SP, "error");
//assert_checkequal(i16 == SPC, "error");
//assert_checkequal(i16 == SP1, "error");
//assert_checkequal(i16 == SPC1, "error");
...
//assert_checkequal(ui16 == p, "error");
//assert_checkequal(ui16 == pc, "error");
//assert_checkequal(ui16 == P, "error");
//assert_checkequal(ui16 == PC, "error");
//assert_checkequal(ui16 == SP, "error");
//assert_checkequal(ui16 == SPC, "error");
//assert_checkequal(ui16 == SP1, "error");
//assert_checkequal(ui16 == SPC1, "error");
...
//assert_checkequal(i32 == p, "error");
//assert_checkequal(i32 == pc, "error");
//assert_checkequal(i32 == P, "error");
//assert_checkequal(i32 == PC, "error");
//assert_checkequal(i32 == SP, "error");
//assert_checkequal(i32 == SPC, "error");
//assert_checkequal(i32 == SP1, "error");
//assert_checkequal(i32 == SPC1, "error");
...
//assert_checkequal(ui32 == p, "error");
//assert_checkequal(ui32 == pc, "error");
//assert_checkequal(ui32 == P, "error");
//assert_checkequal(ui32 == PC, "error");
//assert_checkequal(ui32 == SP, "error");
//assert_checkequal(ui32 == SPC, "error");
//assert_checkequal(ui32 == SP1, "error");
//assert_checkequal(ui32 == SPC1, "error");
