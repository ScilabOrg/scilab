...
assert_checkequal(c .\SP, sparse([ 1, 2; 3, 10; 4, 5],[ 0.2-%i* 0.4; 0.6-%i* 1.2000000000000000000000; 0.4-%i* 0.8],[ 4, 10]));
...
assert_checkequal(c .\SPC1, sparse([ 1, 1], 2.799999999999999800000+%i* 0.4,[ 1, 1]));
...
assert_checkequal(C .\SPC1, [ 2.799999999999999800000+%i* 0.4, 1.3999999999999999000000+%i* 0.2; 0.9333333333333333500000+%i* 0.1333333333333333300000, 0.7+%i* 0.1]);
...
assert_checkequal(SP .\r, sparse([ 1, 2; 3, 10; 4, 5],[ 2; 0.6666666666666666300000; 1],[ 4, 10]));
assert_checkequal(SP .\c, sparse([ 1, 2; 3, 10; 4, 5],[ 1+%i* 2; 0.3333333333333333100000+%i* 0.6666666666666666300000; 0.5+%i],[ 4, 10]));
...
assert_checkequal(SP .\SP1, sparse([ 1, 2; 3, 10; 4, 5],[ 10; 3.3333333333333335000000; 5],[ 4, 10]));
assert_checkequal(SP .\SPC1, sparse([ 1, 2; 3, 10; 4, 5],[ 2+%i* 6; 0.6666666666666666300000+%i* 2; 1+%i* 3],[ 4, 10]));

assert_checkequal(SPC .\empty, []);
assert_checkequal(SPC .\r, sparse([ 1, 2; 3, 10; 4, 5],[ 0.1176470588235294100000-%i* 0.4705882352941176400000; 0.0392156862745098030000-%i* 0.1568627450980392100000; 0.058823529411764705000-%i* 0.2352941176470588200000],[ 4, 10]));
assert_checkequal(SPC .\c, sparse([ 1, 2; 3, 10; 4, 5],[ 0.5294117647058823600000-%i* 0.1176470588235294100000; 0.1764705882352941300000-%i* 0.0392156862745098030000; 0.2647058823529411800000-%i* 0.058823529411764705000],[ 4, 10]));
assert_checkequal(SPC .\SP, sparse([ 1, 2; 3, 10; 4, 5],[ 0.058823529411764705000-%i* 0.2352941176470588200000; 0.058823529411764705000-%i* 0.2352941176470588200000; 0.058823529411764705000-%i* 0.2352941176470588200000],[ 4, 10]));
assert_checkequal(SPC .\SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 1; 1; 1],[ 4, 10]));
assert_checkequal(SPC .\SP1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.5882352941176470800000-%i* 2.3529411764705883000000; 0.1960784313725490200000-%i* 0.7843137254901960700000; 0.2941176470588235400000-%i* 1.1764705882352942000000],[ 4, 10]));
assert_checkequal(SPC .\SPC1, sparse([ 1, 2; 3, 10; 4, 5],[ 1.5294117647058822000000-%i* 0.1176470588235294100000; 0.5098039215686274200000-%i* 0.0392156862745098030000; 0.7647058823529411200000-%i* 0.058823529411764705000],[ 4, 10]));
...
assert_checkequal(SP1 .\SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.1+%i* 0.4; 0.3+%i* 1.2000000000000000000000; 0.2+%i* 0.8],[ 4, 10]));
...
assert_checkequal(SPC1 .\r, sparse([ 1, 1], 0.0999999999999999920000-%i* 0.3,[ 1, 1]));
assert_checkequal(SPC1 .\c, sparse([ 1, 1], 0.3500000000000000300000-%i* 0.05,[ 1, 1]));
assert_checkequal(SPC1 .\R, [ 0.05-%i* 0.15, 0.1-%i* 0.3; 0.15-%i* 0.45, 0.2-%i* 0.6]);
assert_checkequal(SPC1 .\C, [ 0.35-%i* 0.05, 0.7-%i* 0.1; 1.0500000000000000000000-%i* 0.15, 1.3999999999999999000000-%i* 0.2]);
assert_checkequal(SPC1 .\SP, sparse([ 1, 2; 3, 10; 4, 5],[ 0.0499999999999999960000-%i* 0.15; 0.15-%i* 0.45; 0.0999999999999999920000-%i* 0.3],[ 4, 10]));
assert_checkequal(SPC1 .\SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.6499999999999999100000+%i* 0.0499999999999999890000; 1.950000000000000000000+%i* 0.15; 1.299999999999999800000+%i* 0.0999999999999999780000],[ 4, 10]));
assert_checkequal(SPC1 .\SP1, sparse([ 1, 1], 0.4999999999999999400000-%i* 1.5,[ 1, 1]));
...
assert_checkequal(r ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 2; 0.6666666666666666300000; 1],[ 4, 10]));
assert_checkequal(r ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.1176470588235294100000-%i* 0.4705882352941176400000; 0.0392156862745098030000-%i* 0.1568627450980392100000; 0.058823529411764705000-%i* 0.2352941176470588200000],[ 4, 10]));
assert_checkequal(r ./ SP1, sparse([ 1, 1], 0.2,[ 1, 1]));
assert_checkequal(r ./ SPC1, sparse([ 1, 1], 0.0999999999999999920000-%i* 0.3,[ 1, 1]));
...
assert_checkequal(c ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 1+%i* 2; 0.3333333333333333100000+%i* 0.6666666666666666300000; 0.5+%i],[ 4, 10]));
assert_checkequal(c ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.5294117647058823600000-%i* 0.1176470588235294100000; 0.1764705882352941300000-%i* 0.0392156862745098030000; 0.2647058823529411800000-%i* 0.058823529411764705000],[ 4, 10]));
assert_checkequal(c ./ SP1, sparse([ 1, 1], 0.1+%i* 0.2,[ 1, 1]));
assert_checkequal(c ./ SPC1, sparse([ 1, 1], 0.3500000000000000300000-%i* 0.05,[ 1, 1]));
...
assert_checkequal(C ./ SPC1, [ 0.35-%i* 0.05, 0.7-%i* 0.1; 1.0500000000000000000000-%i* 0.15, 1.3999999999999999000000-%i* 0.2]);
...
assert_checkequal(SP ./ c, sparse([ 1, 2; 3, 10; 4, 5],[ 0.2-%i* 0.4; 0.6-%i* 1.2000000000000000000000; 0.4-%i* 0.8],[ 4, 10]));
assert_checkequal(SP ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 1; 1; 1],[ 4, 10]));
assert_checkequal(SP ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.058823529411764705000-%i* 0.2352941176470588200000; 0.058823529411764705000-%i* 0.2352941176470588200000; 0.058823529411764705000-%i* 0.2352941176470588200000],[ 4, 10]));
assert_checkequal(SP ./ SP1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.1; 0.3; 0.2],[ 4, 10]));
assert_checkequal(SP ./ SPC1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.0499999999999999960000-%i* 0.15; 0.15-%i* 0.45; 0.0999999999999999920000-%i* 0.3],[ 4, 10]));
...
assert_checkequal(SPC ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 1; 1; 1],[ 4, 10]));
assert_checkequal(SPC ./ SP1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.1+%i* 0.4; 0.3+%i* 1.2000000000000000000000; 0.2+%i* 0.8],[ 4, 10]));
assert_checkequal(SPC ./ SPC1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.6499999999999999100000+%i* 0.0499999999999999890000; 1.950000000000000000000+%i* 0.15; 1.299999999999999800000+%i* 0.0999999999999999780000],[ 4, 10]));

assert_checkequal(SP1 ./ empty, []);
assert_checkequal(SP1 ./ r, sparse([ 1, 1], 5,[ 1, 1]));
assert_checkequal(SP1 ./ c, sparse([ 1, 1], 2-%i* 4,[ 1, 1]));
assert_checkequal(SP1 ./ R, [ 10, 5; 3.3333333333333335000000, 2.5]);
assert_checkequal(SP1 ./ C, [ 2-%i* 4, 1-%i* 2; 0.6666666666666666300000-%i* 1.3333333333333333000000, 0.5-%i]);
assert_checkequal(SP1 ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 10; 3.3333333333333335000000; 5],[ 4, 10]));
assert_checkequal(SP1 ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.5882352941176470800000-%i* 2.3529411764705883000000; 0.1960784313725490200000-%i* 0.7843137254901960700000; 0.2941176470588235400000-%i* 1.1764705882352942000000],[ 4, 10]));
assert_checkequal(SP1 ./ SP1, sparse([ 1, 1], 1,[ 1, 1]));
assert_checkequal(SP1 ./ SPC1, sparse([ 1, 1], 0.4999999999999999400000-%i* 1.5,[ 1, 1]));

assert_checkequal(SPC1 ./ empty, []);
assert_checkequal(SPC1 ./ r, sparse([ 1, 1], 1+%i* 3,[ 1, 1]));
assert_checkequal(SPC1 ./ c, sparse([ 1, 1], 2.799999999999999800000+%i* 0.4,[ 1, 1]));
assert_checkequal(SPC1 ./ R,  0.05-%i* 0.15);
assert_checkequal(SPC1 ./ C, [ 2.799999999999999800000+%i* 0.4, 1.3999999999999999000000+%i* 0.2; 0.9333333333333333500000+%i* 0.1333333333333333300000, 0.7+%i* 0.1]);
assert_checkequal(SPC1 ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 2+%i* 6; 0.6666666666666666300000+%i* 2; 1+%i* 3],[ 4, 10]));
assert_checkequal(SPC1 ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 1.5294117647058822000000-%i* 0.1176470588235294100000; 0.5098039215686274200000-%i* 0.0392156862745098030000; 0.7647058823529411200000-%i* 0.058823529411764705000],[ 4, 10]));
