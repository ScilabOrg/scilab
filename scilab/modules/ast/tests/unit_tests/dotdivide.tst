...
assert_checkequal(SPC .\c, sparse([ 1, 2; 3, 10; 4, 5],[ 9/17-%i* 2/17; 3/17-%i* 2/51; 0.26470588235294118-%i* 1/17],[ 4, 10]));
...
//assert_checkequal(SPC1 .\c, sparse([ 1, 1], 0.35-%i* 0.05,[ 1, 1]));
...
//assert_checkequal(SPC1 .\SP, sparse([ 1, 2; 3, 10; 4, 5],[ 0.05-%i* 0.15; 0.15-%i* 0.45; 0.1-%i* 0.3],[ 4, 10]));
//assert_checkequal(SPC1 .\SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.65+%i* 0.05; 1.95+%i* 0.15; 1.3+%i* 0.1],[ 4, 10]));
//assert_checkequal(SPC1 .\SP1, sparse([ 1, 1], 0.5-%i* 1.5,[ 1, 1]));
