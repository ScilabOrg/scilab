...
assert_checkequal(C .\empty, []);
assert_checkequal(C .\r, [ 0.4-%i* 0.8, 0.2-%i* 0.4; 0.13333333333333333-%i* 0.26666666666666666, 0.1-%i* 0.2]);
...
assert_checkequal(C .\p, [0.2-%i* 0.4+(0.2-%i* 0.4)*s+(- 0.2+%i* 0.4)*s^ 2,0.1-%i* 0.2+(0.1-%i* 0.2)*s+(- 0.1+%i* 0.2)*s^ 2;0.066666666666666666-%i* 0.13333333333333333+(0.066666666666666666-%i* 0.13333333333333333)*s+(- 0.066666666666666666+%i* 0.13333333333333333)*s^ 2,0.05-%i* 0.1+(0.05-%i* 0.1)*s+(- 0.05+%i* 0.1)*s^ 2]);
assert_checkequal(C .\pc, [1+(- 1-%i)*s+(1.4+%i* 1.2)*s^ 2,0.5+(- 0.5-%i* 0.5)*s+(0.7+%i* 0.6)*s^ 2;(1/3)+(- (1/3)-%i* (1/3))*s+(0.46666666666666667+%i* 0.4)*s^ 2,0.25+(- 0.25-%i* 0.25)*s+(0.35+%i* 0.3)*s^ 2]);
assert_checkequal(C .\P, [0.4-%i* 0.8+(0.4-%i* 0.8)*s+(- 0.4+%i* 0.8)*s^ 2,- 0.3+%i* 0.6+(- 0.3+%i* 0.6)*s+(0.3-%i* 0.6)*s^ 2;0.26666666666666666-%i* 0.53333333333333333+(0.26666666666666666-%i* 0.53333333333333333)*s+(- 0.26666666666666666+%i* 0.53333333333333333)*s^ 2,- 0.25+%i* 0.5+(- 0.25+%i* 0.5)*s+(0.25-%i* 0.5)*s^ 2]);
assert_checkequal(C .\PC, [2+(- 2-%i* 2)*s+(2.8+%i* 2.4)*s^ 2,- 1.5+(1.5+%i* 1.5)*s+(- 2.1-%i* 1.8)*s^ 2;(1+1/3)+(- (1+1/3)-%i* (1+1/3))*s+(1.8666666666666667+%i* 1.6)*s^ 2,- 1.25+(1.25+%i* 1.25)*s+(- 1.75-%i* 1.5)*s^ 2]);
assert_checkequal(C .\SPC1, [ 2.8+%i* 0.4, 1.4+%i* 0.2; 0.93333333333333335+%i* 0.13333333333333333, 0.7+%i* 0.1]);
...
assert_checkequal(ec .\r, ( 0.38461538461538464-%i* 0.076923076923076927)*eye());
assert_checkequal(ec .\c, ( 0.26923076923076922+%i* 0.34615384615384615)*eye());
assert_checkequal(ec .\e, ( 0.19230769230769232-%i* 0.038461538461538464)*eye());
...
assert_checkequal(SPC .\r, sparse([ 1, 2; 3, 10; 4, 5],[ 0.11764705882352941-%i* 0.47058823529411764; 0.039215686274509803-%i* 0.15686274509803921; 0.058823529411764705-%i* 0.23529411764705882],[ 4, 10]));
assert_checkequal(SPC .\c, sparse([ 1, 2; 3, 10; 4, 5],[ 0.52941176470588236-%i* 0.11764705882352941; 0.17647058823529413-%i* 0.039215686274509803; 0.26470588235294118-%i* 0.058823529411764705],[ 4, 10]));
assert_checkequal(SPC .\SP, sparse([ 1, 2; 3, 10; 4, 5],[ 0.058823529411764705-%i* 0.23529411764705882; 0.058823529411764705-%i* 0.23529411764705882; 0.058823529411764705-%i* 0.23529411764705882],[ 4, 10]));
assert_checkequal(SPC .\SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 1; 1; 1],[ 4, 10]));
assert_checkequal(SPC .\SP1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.58823529411764708-%i* 2.3529411764705883; 0.19607843137254902-%i* 0.78431372549019607; 0.29411764705882354-%i* 1.1764705882352942],[ 4, 10]));
assert_checkequal(SPC .\SPC1, sparse([ 1, 2; 3, 10; 4, 5],[ 1.5294117647058822-%i* 0.11764705882352941; 0.50980392156862742-%i* 0.039215686274509803; 0.76470588235294112-%i* 0.058823529411764705],[ 4, 10]));
...
assert_checkequal(SPC1 .\r, sparse([ 1, 1], 0.099999999999999992-%i* 0.3,[ 1, 1]));
assert_checkequal(SPC1 .\c, sparse([ 1, 1], 0.35000000000000003-%i* 0.05,[ 1, 1]));
...
assert_checkequal(SPC1 .\SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.6499999999999999100000+%i* 0.0499999999999999890000; 1.95+%i* 0.15; 1.299999999999999800000+%i* 0.0999999999999999780000],[ 4, 10]));
...
assert_checkequal(r ./ R, [ 2, 1; (2/3), 0.5]);
assert_checkequal(r ./ C, [ 0.4-%i* 0.8, 0.2-%i* 0.4; 0.13333333333333333-%i* 0.26666666666666666, 0.1-%i* 0.2]);
assert_checkequal(r ./ e, ( 2)*eye());
assert_checkequal(r ./ ec, ( 0.38461538461538464-%i* 0.076923076923076927)*eye());
...
assert_checkequal(r ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.11764705882352941-%i* 0.47058823529411764; 0.039215686274509803-%i* 0.1568627450980392100000; 0.058823529411764705-%i* 0.23529411764705882],[ 4, 10]));
assert_checkequal(r ./ SP1, sparse([ 1, 1], 0.2,[ 1, 1]));
assert_checkequal(r ./ SPC1, sparse([ 1, 1], 0.099999999999999992-%i* 0.3,[ 1, 1]));
...
assert_checkequal(c ./ C, [ 1, 0.5; (1/3), 0.25]+%i*0);
assert_checkequal(c ./ e, ( 1+%i* 2)*eye());
assert_checkequal(c ./ ec, ( 0.26923076923076922+%i* 0.34615384615384615)*eye());
test = c ./ p;
...
assert_checkequal(e ./ c, ( 1+%i* 2)*eye());
assert_checkequal(e ./ e, ( 1)*eye());
assert_checkequal(e ./ ec, ( 0.19230769230769232-%i* 0.038461538461538464)*eye());
...
assert_checkequal(p ./ C, [0.2-%i* 0.4+(0.2-%i* 0.4)*s+(- 0.2+%i* 0.4)*s^ 2,0.1-%i* 0.2+(0.1-%i* 0.2)*s+(- 0.1+%i* 0.2)*s^ 2;0.066666666666666666-%i* 0.13333333333333333+(0.066666666666666666-%i* 0.13333333333333333)*s+(- 0.066666666666666666+%i* 0.13333333333333333)*s^ 2,0.05-%i* 0.1+(0.05-%i* 0.1)*s+(- 0.05+%i* 0.1)*s^ 2]);
test = p ./ p;
assert_checkequal(test(2), 1+s*0);
assert_checkequal(test(3), 1+s*0);
test = p ./ pc;
...
assert_checkequal(pc ./ C, [1+(- 1-%i)*s+(1.4+%i* 1.2)*s^ 2,0.5+(- 0.5-%i* 0.5)*s+(0.7+%i* 0.6)*s^ 2;(1/3)+(- (1/3)-%i* (1/3))*s+(0.46666666666666667+%i* 0.4)*s^ 2,0.25+(- 0.25-%i* 0.25)*s+(0.35+%i* 0.3)*s^ 2]);
test = pc ./ p;
assert_checkequal(test(2), 1+%i*2+(1-%i*3)*s+(-1+%i*4)*s^2);
assert_checkequal(test(3), 1+s-s^2);
test = pc ./ pc;
...
assert_checkequal(PC ./ R, [2+%i* 4+(2-%i* 6)*s+(- 2+%i* 8)*s^ 2,- 1.5-%i* 3+(- 1.5+%i* 4.5)*s+(1.5-%i* 6)*s^ 2;(1+1/3)+%i* 2.6666666666666665+((1+1/3)-%i* 4)*s+(- (1+1/3)+%i* 5.333333333333333)*s^ 2,- 1.25-%i* 2.5+(- 1.25+%i* 3.75)*s+(1.25-%i* 5)*s^ 2]);
assert_checkequal(PC ./ C, [2+(- 2-%i* 2)*s+(2.8+%i* 2.4)*s^ 2,- 1.5+(1.5+%i* 1.5)*s+(- 2.1-%i* 1.8)*s^ 2;(1+1/3)+(- (1+1/3)-%i* (1+1/3))*s+(1.8666666666666667+%i* 1.6)*s^ 2,- 1.25+(1.25+%i* 1.25)*s+(- 1.75-%i* 1.5)*s^ 2]);
test = PC ./ p;
assert_checkequal(test(2), [2+%i*4+(2-%i*6)*s+(-2+%i*8)*s^2,-3-%i*6+(-3+%i*9)*s+(3-%i*12)*s^2;4+%i*8+(4-%i*12)*s+(-4+%i*16)*s^2,-5-%i*10+(-5+%i*15)*s+(5-%i*20)*s^2]);
...
assert_checkequal(SP ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 1; 1; 1],[ 4, 10]));
assert_checkequal(SP ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.058823529411764705-%i* 0.23529411764705882; 0.058823529411764705-%i* 0.23529411764705882; 0.058823529411764705-%i* 0.23529411764705882],[ 4, 10]));
...
assert_checkequal(SPC ./ SPC1, sparse([ 1, 2; 3, 10; 4, 5],[ 0.64999999999999991+%i* 0.0499999999999999890000; 1.95+%i* 0.15; 1.299999999999999800000+%i* 0.099999999999999978],[ 4, 10]));
...
assert_checkequal(SP1 ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 0.58823529411764708-%i* 2.3529411764705883; 0.19607843137254902-%i* 0.78431372549019607; 0.29411764705882354-%i* 1.1764705882352942],[ 4, 10]));
assert_checkequal(SP1 ./ SP1, sparse([ 1, 1], 1,[ 1, 1]));
assert_checkequal(SP1 ./ SPC1, sparse([ 1, 1], 0.49999999999999994-%i* 1.5,[ 1, 1]));
...
assert_checkequal(SPC1 ./ C, [ 2.8+%i* 0.4, 1.4+%i* 0.2; 0.93333333333333335+%i* 0.13333333333333333, 0.7+%i* 0.1]);
assert_checkequal(SPC1 ./ SP, sparse([ 1, 2; 3, 10; 4, 5],[ 2+%i* 6; (2/3)+%i* 2; 1+%i* 3],[ 4, 10]));
assert_checkequal(SPC1 ./ SPC, sparse([ 1, 2; 3, 10; 4, 5],[ 1.5294117647058822-%i* 0.11764705882352941; 0.50980392156862742-%i* 0.039215686274509803; 0.76470588235294112-%i* 0.058823529411764705],[ 4, 10]));
