...
execstr("tt(2).d.e(4) = 12;", "errcatch");
assert_checktrue(err <> 0);
...
err=execstr("mm(2).d.e(4) = 12;", "errcatch");
assert_checktrue(err <> 0);
...
err = execstr("a{2}.b = 12;", "errcatch");
assert_checktrue(err <> 0);
//assert_checkequal(a{2}.b, list(12, 12, 12));

err = execstr("a{2}.e = 99;", "errcatch");
assert_checktrue(err <> 0);
...
st=initst();
err=execstr("st.f.e = 5;", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st.f.e = list(5,55,555)", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st.f.e = list(5,55,555,2)", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st.f.e = list(5,55)", "errcatch");
assert_checktrue(err <> 0);
...
st=initst();
err=execstr("st.f(1:4).e = list(5,55)", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st.f(1:2).e = 5", "errcatch");
assert_checktrue(err <> 0);
...
st=initst();
err=execstr("st.f(1:4).e = list(5,55,555,2)", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st.f(1:2).e = list(list(5,55,555,2), list(1,2,3))", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st(1:2).f(1:4).e = list(5,55,555,2)", "errcatch");
assert_checktrue(err <> 0);

st=initst();
err=execstr("st.f(1:4).e(2) = 36", "errcatch");
assert_checktrue(err <> 0);

clear a;
err=execstr("a(2, 1:3, [2 6 7]).b = 12;", "errcatch");
assert_checktrue(err <> 0);
//computed = a.b;
//expected = list();
//for i=1:(2*3*7)
