...
public class testExec {
    ...
    public void execAndReadTest() throws NullPointerException, JavasciException {
        ...
        /* Scalar test */
        assertEquals(sci.exec("a = 1+1") , true);
        ...
        /* Matrix 10x10 */
        assertEquals(sci.exec("b = matrix(1:100,10,10)") , true);
        ...
        assertEquals(sci.exec("c = [42, 12; 32, 32] + [2, 1; 3, 2]; sumMatrix = sum(c);") , true);
    ...
    public void execFromFileTest() throws NullPointerException, JavasciException {
        ...
        try {
            ...
            assertEquals(sci.open(tempScript) , true);
