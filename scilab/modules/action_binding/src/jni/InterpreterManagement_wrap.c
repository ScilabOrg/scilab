...
extern "C"
{
    ...
    SWIGEXPORT jint JNICALL Java_org_scilab_modules_action_1binding_InterpreterManagementJNI_putCommandInScilabQueue(JNIEnv * jenv, jclass jcls,
                                                                                                                     jstring jarg1)
    {
        jint jresult = 0;
        char *arg1 = (char *)0;
    ...
    SWIGEXPORT jint JNICALL Java_org_scilab_modules_action_1binding_InterpreterManagementJNI_requestScilabExec(JNIEnv * jenv, jclass jcls,
                                                                                                               jstring jarg1)
    {
        jint jresult = 0;
        char *arg1 = (char *)0;
