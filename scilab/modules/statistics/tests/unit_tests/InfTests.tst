...
// cdfbet
[res, res2] = cdfbet("PQ", 0, 1, inf, inf);
assert_checkalmostequal(res, 0, tol);
assert_checkalmostequal(res2, 1, tol);

// cdfbin
[res, res2] = cdfbin("PQ", 0, inf, 0.3, 0.7);
assert_checkalmostequal(res, 0, tol);
assert_checkalmostequal(res2, 1, tol);
[res, res2] = cdfbin("PQ", inf, inf, 0.3, 0.7);
...
// cdfchn
[res, res2] = cdfchn("PQ", 1, inf, 1);
assert_checkalmostequal(res, 0, tol);
assert_checkalmostequal(res2, 1, tol);
[res, res2] = cdfchn("PQ", inf, 1, 1e-10);
assert_checkalmostequal(res, 1, tol);
assert_checkalmostequal(res2, 0, tol);
...
assert_checkalmostequal(res, 1);
assert_checkalmostequal(res2, 0);
[res, res2] = cdfnor("PQ", -inf, 1, 1);
assert_checkalmostequal(res, 0);
assert_checkalmostequal(res2, 1);
