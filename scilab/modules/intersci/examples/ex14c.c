     ...
     double *ar, *ai;
{
    ...
    for (i = 0; i < *m; i++)
    {
        ...
        {
            if (*it == 1)
                sciprint("(%d,%d) -> %f +i%f\n", i + 1, icol[iof + j], ar[iof + j], ai[iof + j]);
            else
                sciprint("(%d,%d) -> %f\n", i + 1, icol[iof + j], ar[iof + j]);
        }
        iof += mnel[i];
    }
    return (0);
...
int F2C(ext14cb) (it1, m1, n1, nel1, mnel1, icol1, ar1, ai1, it2, m2, n2, nel2, mnel2, icol2, ar2, ai2)
...
int F2C(ext14cd) (it1, m1, n1, nel1, mnel1, icol1, ar1, ai1, it2, m2, n2, nel2, mnel2, icol2, ar2, ai2)
     int *n1, *m1, *it1, *nel1, *mnel1, *icol1;
     double *ar1, *ai1;
     int *it2, *m2, *n2, *nel2, *mnel2, *icol2;
     int *ar2, *ai2;
