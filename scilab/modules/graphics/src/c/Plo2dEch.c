...
int setscale2d(double WRect[4], double ARect[4], double FRect[4], char logscale[2])
{
 ...
 */
void convertUserCoordToPixelCoords(const double xCoords[], const double yCoords[], int xPixCoords[], int yPixCoords[], int nbCoords, int rect[4])
{
...
void convertPixelCoordsToUserCoords(const int xPixCoords[], const int yPixCoords[],
                                    double xUserCoords[], double yUserCoords[], int nbCoords, int rect[4])
{
    /* coordinates transformation */
    int i;
    sciPointObj *selectedSubwin = sciGetCurrentSubWin();
