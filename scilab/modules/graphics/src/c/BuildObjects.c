 ...
 */
char *
ConstructSubWin(char * pparentfigureUID)
{
    char* parentType;
 ...
 */
char *
ConstructGrayplot (char * pparentsubwinUID, double *pvecx, double *pvecy,
...
ConstructLabel (char * pparentsubwinUID, char *text, int type)
{
    ...
    getGraphicObjectProperty(axesModelUID, labelType, jni_string, &modelLabelUID);
