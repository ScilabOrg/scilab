...
int getchampdata(sciPointObj *pobj)
{
    ...
    dimensions = (int*) getGraphicObjectProperty(pobj->UID, __GO_CHAMP_DIMENSIONS__, jni_int_vector);

    arrowBasesX = (double*) getGraphicObjectProperty(pobj->UID, __GO_BASE_X__, jni_double_vector);
    arrowBasesY = (double*) getGraphicObjectProperty(pobj->UID, __GO_BASE_Y__, jni_double_vector);
    arrowDirectionsX = (double*) getGraphicObjectProperty(pobj->UID, __GO_DIRECTION_X__, jni_double_vector);
    arrowDirectionsY = (double*) getGraphicObjectProperty(pobj->UID, __GO_DIRECTION_Y__, jni_double_vector);
