...
int get_z_shift_property( sciPointObj * pobj )
{
    ...
    tmp = (int*) getGraphicObjectProperty(pobj->UID, __GO_DATA_MODEL_Z_COORDINATES_SHIFT_SET__, jni_int);
    ...
    {
        shiftCoordinates = (double*) getGraphicObjectProperty(pobj->UID, __GO_DATA_MODEL_Z_COORDINATES_SHIFT__, jni_double_vector);
