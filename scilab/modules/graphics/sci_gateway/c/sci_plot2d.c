...
int sci_plot2d(char* fname, unsigned long fname_len)
{
    ...
    if (FirstOpt() == 2 + iskip)       				/** plot2d([loglags,] y, <opt_args>); **/
    {
        ...
        // the argument can be a matrix of doubles or matrix of integers
        // If it is a matrix of integers, call overload %i_plot2d
    ...
    else if (FirstOpt() >= 3 + iskip)     /** plot2d([loglags,] x, y[, style [,...]]); **/
    {
        ...
        // y can be a matrix of doubles or matrix of integers
        // If y is a matrix of integers, call overload %i_plot2d
