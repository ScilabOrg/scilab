...
int sci_rubberbox(char * fname, unsigned long fname_len)
{
    ...
    {
        /* rubberbox() */
        rubberBox(pSubWinUID, TRUE, NULL, selectedRect, &button);
    }
    else if (Rhs == 1)
    {
        ...
        if (GetType(1) == sci_matrix)
        {
            ...
            {
                rubberBox(getCurrentSubWin(), TRUE, initialRect, selectedRect, &button);
            }
            else
            {
        ...
        else if (GetType(1) == sci_boolean)
        {
            ...
            {
                /* rubberbox(%t) */
                rubberBox(getCurrentSubWin(), FALSE, NULL, selectedRect, &button);
            }
            else if (editionModeStatus == 0)
            {
                /* rubberbox(%f) */
                rubberBox(getCurrentSubWin(), TRUE, NULL, selectedRect, &button);
            }
            else
            {
    ...
    else if (Rhs == 2)
    {
        ...
        if (editionModeStatus == 1)
        {
            ...
            rubberBox(getCurrentSubWin(), FALSE, initialRect, selectedRect, &button);
        }
        else if (editionModeStatus == 0)
        {
