...
static char fname[] = "light";

int sci_light(scilabEnv env, int nin, scilabVar* in, scilabOpt opt, int nout, scilabVar* out)
{
    int optCount = scilab_getOptionalCount(env, opt);
    if (nin + optCount > 8)
    {
