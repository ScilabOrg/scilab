...
assert_checkerror("bonecolormap(%t)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "bonecolormap", 1);

assert_checkerror("bonecolormap(%i)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "bonecolormap", 1);

assert_checkerror("bonecolormap([0 1 2 3])", "%s: Wrong size for input argument #%d: Real scalar expected.\n", 10000, "bonecolormap", 1);
