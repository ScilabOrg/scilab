...
assert_checkerror("rainbowcolormap(%t)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "rainbowcolormap", 1);

assert_checkerror("rainbowcolormap(%i)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "rainbowcolormap", 1);

assert_checkerror("rainbowcolormap([0 1 2 3])", "%s: Wrong size for input argument #%d: Real scalar expected.\n", 10000, "rainbowcolormap", 1);
