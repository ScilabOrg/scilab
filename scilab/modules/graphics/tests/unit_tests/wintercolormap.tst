...
assert_checkerror("wintercolormap(%t)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "wintercolormap", 1);

assert_checkerror("wintercolormap(%i)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "wintercolormap", 1);

assert_checkerror("wintercolormap([0 1 2 3])", "%s: Wrong size for input argument #%d: Real scalar expected.\n", 10000, "wintercolormap", 1);
