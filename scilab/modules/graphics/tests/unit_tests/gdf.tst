...
if f.figure_position <> [200,200] then pause, end
if f.figure_size <> [620,590] then pause, end
if f.axes_size <> [610,460] then pause, end
if f.auto_resize <> "on" then pause, end
if f.viewport <> [0,0] then pause, end
if f.figure_name <> "Graphic window number %d" then pause, end
