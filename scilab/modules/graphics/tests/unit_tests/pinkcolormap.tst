...
assert_checkerror("pinkcolormap(%t)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "pinkcolormap", 1);

assert_checkerror("pinkcolormap(%i)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "pinkcolormap", 1);

assert_checkerror("pinkcolormap([0 1 2 3])", "%s: Wrong size for input argument #%d: Real scalar expected.\n", 10000, "pinkcolormap", 1);
