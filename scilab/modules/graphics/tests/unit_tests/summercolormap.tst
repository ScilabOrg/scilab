...
assert_checkerror("summercolormap(%t)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "summercolormap", 1);

assert_checkerror("summercolormap(%i)", "%s: Wrong type for input argument #%d: Real scalar expected.\n", 10000, "summercolormap", 1);

assert_checkerror("summercolormap([0 1 2 3])", "%s: Wrong size for input argument #%d: Real scalar expected.\n", 10000, "summercolormap", 1);
