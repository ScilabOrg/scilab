...
msgerr12=msprintf(_("%s: Wrong type for input arguments: x,y and width must be a constant.\n"),f1);
assert_checkerror("bar(gca(),[""s"" ""d""],[1 2 3])", msgerr12);
msgerr13=msprintf(_("%s: Wrong size for input arguments #%d and #%d.\n"),f1,1,2);
...
msgerr22=msprintf(_("%s: Wrong type for input arguments: x,y and width must be a constant.\n"),f2);
assert_checkerror("barh(gca(),[""s"" ""d""],[1 2 3])", msgerr22);
msgerr23=msprintf(_("%s: Wrong size for input arguments #%d and #%d.\n"),f2,1,2);
assert_checkerror("barh([1 2],[1 2 3],0.8,""blue"")", msgerr23);
msgerr24=msprintf(gettext("%s: Wrong type for input arguments #%d: A string expected.\n"),f2,5);
...
msgerr32=msprintf(_("%s: Wrong type for input argument: width must be a real.\n"),f3);
