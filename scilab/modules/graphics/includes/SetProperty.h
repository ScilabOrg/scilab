...
GRAPHICS_IMPEXP void Obj_RedrawNewAngle(sciPointObj * pSubwin, double alpha, double theta);

GRAPHICS_IMPEXP int sciSetEntityType (sciPointObj * pobj, sciEntityType value);
GRAPHICS_IMPEXP int sciSetColormap (sciPointObj * pobj, double *rgbmat, int m, int n);
GRAPHICS_IMPEXP int sciInitNumColors( sciPointObj * pobj, int numcolors );
GRAPHICS_IMPEXP int sciSetNumColors ( sciPointObj * pobj, int numcolors );

GRAPHICS_IMPEXP int sciSetGoodIndex(sciPointObj * pobj, int colorindex); 
...
GRAPHICS_IMPEXP int sciSetFillColor (sciPointObj * pobj, int colorindex);
...
GRAPHICS_IMPEXP int sciSetIsBoxed (sciPointObj * pobj, BOOL isboxed);

/* Text Functions */
GRAPHICS_IMPEXP int sciInitFontSize(sciPointObj * pobj, double fontSize);
GRAPHICS_IMPEXP int sciSetFontSize (sciPointObj * pobj, double fontSize);

GRAPHICS_IMPEXP int sciInitFontOrientation(sciPointObj * pobj, double textorientation);
GRAPHICS_IMPEXP int sciSetFontOrientation (sciPointObj * pobj, double textorientation);

GRAPHICS_IMPEXP int sciSetStrings( sciPointObj * pobj, const StringMatrix * pStrings );
GRAPHICS_IMPEXP int sciSetText (   sciPointObj * pobj, char ** text, int nbRow, int nbCol );

GRAPHICS_IMPEXP int sciInitFontBackground(sciPointObj * pobj, int color);
GRAPHICS_IMPEXP int sciSetFontBackground (sciPointObj * pobj, int color);

GRAPHICS_IMPEXP int sciInitFontForeground(sciPointObj * pobj, int colorindex );
GRAPHICS_IMPEXP int sciSetFontForeground (sciPointObj * pobj, int colorindex );

GRAPHICS_IMPEXP int sciInitFontStyle(sciPointObj * pobj, int iAttributes );
GRAPHICS_IMPEXP int sciSetFontStyle (sciPointObj * pobj, int iAttributes );

/* Legend */
GRAPHICS_IMPEXP int sciInitLegendPlace(sciPointObj * pobj, sciLegendPlace place);
GRAPHICS_IMPEXP int sciSetLegendPlace (sciPointObj * pobj, sciLegendPlace place);

GRAPHICS_IMPEXP int sciInitLegendPos(sciPointObj * pobj, double position[]);
GRAPHICS_IMPEXP int sciSetLegendPos (sciPointObj * pobj, double position[]);

/* GMODE */
GRAPHICS_IMPEXP int sciInitIsClipping(sciPointObj * pobj, int value);
GRAPHICS_IMPEXP int sciSetIsClipping (sciPointObj * pobj, int value);

GRAPHICS_IMPEXP int sciSetClipping (sciPointObj * pobj, double pclip[4] );

GRAPHICS_IMPEXP int sciInitAddPlot (sciPointObj * pobj, BOOL value);
GRAPHICS_IMPEXP int sciSetAddPlot (sciPointObj * pobj, BOOL value);

GRAPHICS_IMPEXP int sciInitAutoScale(sciPointObj * pobj, BOOL value);
GRAPHICS_IMPEXP int sciSetAutoScale (sciPointObj * pobj, BOOL value);

GRAPHICS_IMPEXP int sciInitZooming(sciPointObj * pobj, BOOL value);
GRAPHICS_IMPEXP int sciSetZooming (sciPointObj * pobj, BOOL value);

GRAPHICS_IMPEXP int sciInitXorMode(sciPointObj * pobj, int value);
GRAPHICS_IMPEXP int sciSetXorMode (sciPointObj * pobj, int value);

GRAPHICS_IMPEXP int sciInitVisibility (sciPointObj * pobj, BOOL value);
GRAPHICS_IMPEXP int sciSetVisibility (sciPointObj * pobj, BOOL value);

GRAPHICS_IMPEXP int sciInitResize(sciPointObj * pobj, BOOL value);
GRAPHICS_IMPEXP int sciSetResize (sciPointObj * pobj, BOOL value);

GRAPHICS_IMPEXP int sciSetDefaultValues (void);


/* Window Functions */
GRAPHICS_IMPEXP int sciInitName(sciPointObj * pobj, char * newName);
GRAPHICS_IMPEXP int sciSetName (sciPointObj * pobj, char * newName);
GRAPHICS_IMPEXP int sciInitNum( sciPointObj * pobj, int value );
GRAPHICS_IMPEXP int sciSetNum ( sciPointObj * pobj, int value );

GRAPHICS_IMPEXP int sciInitDimension( sciPointObj * pobj, int newWidth, int newHeight );
GRAPHICS_IMPEXP int sciSetDimension(  sciPointObj * pobj, int newWidth, int newHeight );

GRAPHICS_IMPEXP int sciInitWindowDim( sciPointObj * pobj, int newWidth, int newHeight );
GRAPHICS_IMPEXP int sciSetWindowDim(  sciPointObj * pobj, int newWidth, int newHeight );

GRAPHICS_IMPEXP int sciInitScreenPosition(sciPointObj * pobj, int pposx, int pposy);
GRAPHICS_IMPEXP int sciSetScreenPosition( sciPointObj * pobj, int pposx, int pposy);


GRAPHICS_IMPEXP void sciSelectFirstSubwin( sciPointObj * parentFigure );

GRAPHICS_IMPEXP int sciInitSelectedSubWin (sciPointObj * psubwinobj);
GRAPHICS_IMPEXP int sciSetSelectedSubWin (sciPointObj * psubwinobj);

GRAPHICS_IMPEXP int sciSetOriginalSubWin (sciPointObj * pfigure, sciPointObj * psubwin);

GRAPHICS_IMPEXP int sciSetPoint(sciPointObj * pthis, double *tab, int *numrow, int *numcol);

GRAPHICS_IMPEXP int sciSetdrawmode(BOOL mode);
GRAPHICS_IMPEXP int sciSwitchWindow(int winnum);

GRAPHICS_IMPEXP int sciInitUsedWindow( int winNum );
GRAPHICS_IMPEXP int sciSetUsedWindow( int winNum );
...
GRAPHICS_IMPEXP int sciSetGridStyle( sciPointObj * pObj, int xStyle, int yStyle, int zStyle );

GRAPHICS_IMPEXP int sciSetViewport(  sciPointObj * pObj, const int viewport[4] );

GRAPHICS_IMPEXP int sciInitInfoMessage(sciPointObj * pObj, const char * newMessage);
GRAPHICS_IMPEXP int sciSetInfoMessage( sciPointObj * pObj, const char * newMessage );
...
GRAPHICS_IMPEXP int sciSetDataBounds( sciPointObj * pObj, double bounds[6] );
GRAPHICS_IMPEXP int sciSetRealDataBounds(sciPointObj * pObj, const double bounds[6]);

GRAPHICS_IMPEXP int sciInitViewingAngles( sciPointObj * pObj, double alpha, double theta);
GRAPHICS_IMPEXP int sciSetViewingAngles( sciPointObj * pObj, double alpha, double theta);
...
GRAPHICS_IMPEXP int sciSetPixmapMode(sciPointObj * pObj, BOOL onOrOff);
...
GRAPHICS_IMPEXP int sciSetLogFlags(sciPointObj * pObj, char logFlags[3]);

GRAPHICS_IMPEXP int sciInitAutoTicks(sciPointObj * pObj, BOOL autoTicksX, BOOL autoTicksY, BOOL autoTicksZ);
GRAPHICS_IMPEXP int sciSetAutoTicks(sciPointObj * pObj, BOOL autoTicksX, BOOL autoTicksY, BOOL autoTicksZ);

GRAPHICS_IMPEXP int sciSetZoomBox(sciPointObj * pObj, const double zoomBox[6]);
...
GRAPHICS_IMPEXP int sciSetUseNurbs(sciPointObj * pObj, BOOL useNurbs);

GRAPHICS_IMPEXP int sciInitIsUsingFractionalMetrics(sciPointObj * pObj, BOOL useFractionalMetrics);
GRAPHICS_IMPEXP int sciSetIsUsingFractionalMetrics(sciPointObj * pObj, BOOL useFractionalMetrics);

GRAPHICS_IMPEXP int sciInitColorRange(sciPointObj * pObj, int subset[2]); 
GRAPHICS_IMPEXP int sciSetColorRange(sciPointObj * pObj, int subset[2]);

GRAPHICS_IMPEXP int sciInitOutsideColors(sciPointObj * pObj, int colors[2]);
GRAPHICS_IMPEXP int sciSetOutsideColors(sciPointObj * pObj, int colors[2]);

GRAPHICS_IMPEXP int sciInitZBounds(sciPointObj * pObj, double bounds[2]);
GRAPHICS_IMPEXP int sciSetZBounds(sciPointObj * pObj, double bounds[2]);

GRAPHICS_IMPEXP int sciInitGridFront(sciPointObj * pObj, BOOL gridFront);
GRAPHICS_IMPEXP int sciSetGridFront(sciPointObj * pObj, BOOL gridFront);

GRAPHICS_IMPEXP int sciInitLegendLocation(sciPointObj * pObj, sciLegendPlace location);
GRAPHICS_IMPEXP int sciSetLegendLocation(sciPointObj * pObj, sciLegendPlace location);

GRAPHICS_IMPEXP int sciInitAntialiasingQuality(sciPointObj * pObj, int quality);
GRAPHICS_IMPEXP int sciSetAntialiasingQuality(sciPointObj * pObj, int quality);
