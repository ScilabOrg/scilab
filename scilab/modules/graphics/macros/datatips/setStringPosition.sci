...
//computes the position of the lower left corner of the string box
  ...
  case 1 then //upper left
    string_handle.data(1:2)=pt(1:2)+[-d(1) d(2)]-[r(1) 0];
  case 2 then //upper right
    string_handle.data(1:2)=pt(1:2)+d;
  case 3 then //lower left
    string_handle.data(1:2)=pt(1:2)-d-r;
  case 4 then //lower right
    string_handle.data(1:2)=pt(1:2)+[d(1) -d(2)]-[0  r(2)];
  end
endfunction
