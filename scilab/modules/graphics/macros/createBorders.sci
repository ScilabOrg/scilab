...
function ret = createBorders(constType, varargin)
    ...
    if constType == "line" then
        ...
        if size(varargin) > 2 then
            arg3 = varargin(3);
            if typeof(arg3) <> "boolean" | size(arg3, "*") <> 1 then
    ...
    elseif constType == "titled" then
        arg1 = createBorders("etched");
        arg2 = "Title";
        arg3 = "default"; //justification
        arg4 = "helvetica"; //fontname
        arg5 = "normal"; //font angle
        arg6 = 10; //font size
        arg7 = "normal"; //font weight
        arg8 = "default"; //position
        arg9 = "black"; //color
