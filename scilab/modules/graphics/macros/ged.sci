...
function ged_axis(h)
    global ged_handle; ged_handle=h
    TCL_SetVar("curvis",h.visible)
    TCL_SetVar("curseg",h.ticks_segment)
    TCL_SetVar("curcolor",string(h.ticks_color))
    TCL_SetVar("curticksstyle",h.ticks_style)
    TCL_SetVar("curfontcolor",string(h.labels_font_color))
    TCL_SetVar("curfontsize",string(h.labels_font_size))
    TCL_SetVar("nbcolX",string(size(h.xticks_coord,2)))
    TCL_SetVar("nbcolY",string(size(h.yticks_coord,2)))
    TCL_SetVar("xtickscoord",sci2exp(h.xticks_coord,0))
    TCL_SetVar("ytickscoord",sci2exp(h.yticks_coord,0))
    TCL_SetVar("cursubticks",string(h.sub_ticks))
    TCL_SetVar("curtickslabel",sci2exp(h.ticks_labels,0))
    TCL_SetVar("curticksdir",string(h.ticks_direction))
