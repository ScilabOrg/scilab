...
function a=%b_cumprod(varargin)
    ...
    //      a=cumprod(double(a))
    //    else
    //      a=cumprod(double(a),direction)
    //    end
    //  end
    //
    //    if varargin($)=="native" then
    //        // call cumprod(a, d) with d = "native"
    //        if size(varargin)==2 then
    //            d = 0 //"*"
    //            // call cumprod(a, d, typ) with typ = "native"
    ...
    //            end
    //
    //            // call cumprod(a, d, typ) with d = "m", "r", "*" or "c"
    ...
    //            end
    //
    //            // call cumprod(a,d,typ), so d must be "m", "c", "r", "*" or an integer > 0
    //            if type(d)==10 then
    //                if and(d <> ["m","*","r","c"]) then
    //                    error(msprintf(_("%s: Wrong value for input argument #%d: Must be in the set {%s}.\n"),..
