...
static PIMAGE_NT_HEADERS getPEHeader(const wchar_t * dllfilename)
{
    ...
    hFile = CreateFileW(dllfilename, GENERIC_READ, FILE_SHARE_READ, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, (HANDLE) NULL);

    if (hFile == INVALID_HANDLE_VALUE)
        return NULL;

    hMap = CreateFileMapping(hFile, NULL,   // security attrs
