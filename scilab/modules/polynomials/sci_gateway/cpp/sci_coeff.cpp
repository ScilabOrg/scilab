        ...
        else
        {
            ...
            if (pPolyIn->isComplex())
            {
                for (int i = 0; i < pPolyIn->getSize(); i++)
                {
                    ...
                    {
                        pDblOut->set(j * pPolyIn->getSize() + i, pdblcoeffR[(int)pdblV[j]]);
                        pDblOut->setImg(j * pPolyIn->getSize() + i, pdblcoeffI[(int)pdblV[j]]);
                    }
                }
            }
            else
            {
                for (int i = 0; i < pPolyIn->getSize(); i++)
                {
                    ...
                    for (int j = 0; j < iVSize; j++)
                    {
                        pDblOut->set(j * pPolyIn->getSize() + i, pdblcoeff[(int)pdblV[j]]);
                    }
                }
            }
        }
