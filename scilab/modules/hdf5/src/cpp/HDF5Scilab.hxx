...
public:
    ...
    static void createSoftLink(H5Object & parent, const std::string & name, const std::string & targetPath);

    static void createSoftLink(H5Object & parent, const std::string & name, H5Object & targetObject);
    ...
    static U & create(H5Object & parent, const std::string & name, const unsigned int rank, const hsize_t * dims, const hsize_t * maxdims, T * data, const hid_t targetType)
    {
        ...
        if (rank < 0 || rank > __SCILAB_HDF5_MAX_DIMS__)
        {
