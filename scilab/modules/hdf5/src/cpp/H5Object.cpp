...
H5Object & H5Object::getObject(H5Object & parent, hid_t loc, const std::string & name)
{
    return getObject(parent, loc, name.c_str());
}

H5Object & H5Object::getObject(H5Object & parent, hid_t loc, const char * name)
{
    H5O_info_t info;
    herr_t err;
    H5Object * obj = 0;
