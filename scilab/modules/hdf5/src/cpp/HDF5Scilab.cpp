...
void HDF5Scilab::createSoftLink(H5Object & parent, const std::string & name, const std::string & targetPath)
{
    herr_t err;
    if (H5Lexists(parent.getH5Id(), name.c_str(), H5P_DEFAULT) > 0)
    {
...
void HDF5Scilab::createSoftLink(H5Object & parent, const std::string & name, H5Object & targetObject)
{
    createSoftLink(parent, name, targetObject.getCompletePath());
}
}
