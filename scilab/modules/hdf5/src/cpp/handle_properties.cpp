...
{
    bool ret = false;
    HandleProp plist = UicontrolHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = UicontextmenuHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = UimenuHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = LightHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = AxisHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = TextHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = LegendHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = FecHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = MatplotHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = GrayplotHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = SegsHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = ArcHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = RectangleHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = DatatipHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
static bool export_handle_polyline(int parent, int uid)
{
    ...
    HandleProp plist = PolylineHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = SurfaceHandle::getPropertyList();
    return export_handle_generic(parent, uid, plist);
}
...
static bool export_handle_champ(int parent, int uid)
{
    HandleProp plist = ChampHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
static bool export_handle_label(int parent, int uid)
{
    HandleProp plist = LabelHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
static bool export_handle_axes(int parent, int uid)
{
    HandleProp plist = AxesHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
static bool export_handle_figure(int parent, int uid)
{
    HandleProp plist = FigureHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
...
{
    HandleProp plist = CompoundHandle::getPropertyList();
    if (export_handle_generic(parent, uid, plist) == false)
    {
        return false;
    }
