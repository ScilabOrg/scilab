...
/*--------------------------------------------------------------------------*/
static const std::string fname("export_to_hdf5_new");
/*--------------------------------------------------------------------------*/
types::Function::ReturnValue sci_export_to_hdf5_new(types::typed_list &in, int _iRetCount, types::typed_list &out)
{
    int iH5File = 0;
...
static int export_sparse(int parent, const std::string& name, types::Sparse* data)
{
    ...
    std::vector<int> dimsinner = {1, innercount};
    ...
    std::vector<int> dimsouter = {1, outercount};
