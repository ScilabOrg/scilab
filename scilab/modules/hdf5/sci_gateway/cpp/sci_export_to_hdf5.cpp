...
static bool export_matlab_sparse(int _iH5File, int *_piVar, char *_pstName);
static bool export_ints(int _iH5File, int *_piVar, char *_pstName);
static bool export_handles(int _iH5File, int *_piVar, char *_pstName);
static bool export_strings(int _iH5File, int *_piVar, char *_pstName);
static bool export_u_function(int _iH5File, int *_piVar, char *_pstName);
static bool export_c_function(int _iH5File, int *_piVar, char *_pstName);
static bool export_lib(int _iH5File, int *_piVar, char *_pstName);
static bool export_lufact_pointer(int _iH5File, int *_piVar, char *_pstName);
...
{
    bool bReturn = false;
    sci_types iType = sci_undefined;

    SciErr sciErr = getVarType(pvApiCtx, _piVar, (int *)&iType);
    ...
    case sci_matlab_sparse:
        {
            bReturn = export_matlab_sparse(_iH5File, _piVar, _pstName);
            break;
        }
    case sci_ints:
        {
    ...
    case sci_handles:
        {
            bReturn = export_handles(_iH5File, _piVar, _pstName);
            break;
        }
    case sci_strings:
        {
    ...
    case sci_u_function:
        {
            bReturn = export_u_function(_iH5File, _piVar, _pstName);
            break;
        }
    case sci_c_function:
        {
            bReturn = export_c_function(_iH5File, _piVar, _pstName);
            break;
        }
    case sci_lib:
        {
            bReturn = export_lib(_iH5File, _piVar, _pstName);
            break;
        }
    case sci_list:
    case sci_tlist:
    ...
    case sci_lufact_pointer:
        {
            bReturn = export_lufact_pointer(_iH5File, _piVar, _pstName);
            break;
        }
...
static bool export_u_function(int _iH5File, int *_piVar, char *_pstName)
{
    ...
    sprintf(pstMsg, "u_function (not exported) at %s", _pstName);
    print_type(pstMsg);

    pstData = (char **)MALLOC(sizeof(char *));
    pstData[0] = pstMsg;
    iRet = writeStringMatrix(_iH5File, _pstName, 1, 1, pstData);
    FREE(pstData);
    if (iRet)
    {
        return false;
...
static bool export_c_function(int _iH5File, int *_piVar, char *_pstName)
{
    ...
    sprintf(pstMsg, "c_function (not exported) at %s", _pstName);
    print_type(pstMsg);
