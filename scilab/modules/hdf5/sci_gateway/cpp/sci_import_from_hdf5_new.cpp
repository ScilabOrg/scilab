...
/*--------------------------------------------------------------------------*/
static const std::string fname("import_from_hdf5_new");
/*--------------------------------------------------------------------------*/
types::Function::ReturnValue sci_import_from_hdf5_new(types::typed_list &in, int _iRetCount, types::typed_list &out)
{
    std::string filename;
