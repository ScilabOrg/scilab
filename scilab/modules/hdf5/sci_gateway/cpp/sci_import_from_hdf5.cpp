...
static bool import_data(int* pvCtx, int _iDatasetId, int _iItemPos, int *_piAddress, char *_pstVarname)
{
    ...
    switch (iVarType)
    {
        ...
        case sci_mlist:
        {
            if (import_hypermat(pvCtx, _iDatasetId, iVarType, _iItemPos, _piAddress, _pstVarname) == false)
            {
...
static bool import_hypermat(int* pvCtx, int _iDatasetId, int _iVarType, int _iItemPos, int *_piAddress, char *_pstVarname)
{
    ...
    // an hypermat is stored in an mlist
    ...
    // get second item, the Size of hypermat
    ...
    // get third item, the Data of hypermat
    ...
    // reshape data with size of hypermat
