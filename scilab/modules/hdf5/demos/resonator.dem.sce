...
function resonator_demo()
    ...
    my_test_fig.figure_name = "Ring Resonator from a HDF5 file";
    ...
    e=gce();
    a=gca();
    a.x_label.text="X position [a]";
    a.y_label.text="Y position [a]";
    a.z_label.text="Permittivity";
    a.z_label.font_angle=-90;
    e.thickness=0;
    a.rotation_angles=[20,-140];
    a.title.text="Ring Resonator";
