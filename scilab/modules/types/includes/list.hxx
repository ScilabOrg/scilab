...
namespace types
{
    ...
    public :
        ...
        */
        ...
        InternalType*                   insert(int _iSeqCount, int* _piSeqCoord, int* _piMaxDim, types::result_t* _poSource, bool _bAsVector);
        types::result_t      extract(int _iSeqCount, int* _piSeqCoord, int* _piMaxDim, int* _piDimSize, bool _bAsVector);
