...
namespace types
{
    ...
    public :
        ...
        std::vector<InternalType*>      extract_string(list<string> _stFields);

        /* return type as string ( double, int, cell, list, ... )*/
        virtual std::string             getTypeStr() {return string("tlist");}
        /* return type as short string ( s, i, ce, l, ... )*/
        virtual std::string             getShortTypeStr() {return string("tlist");}
