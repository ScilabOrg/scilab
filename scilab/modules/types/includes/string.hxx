...
namespace types
{
    ...
    public :
        ...
        wchar_t*                getString(int _iRows, int _iCols) const;
        wchar_t*                getString(int _iPos) const;

        bool                    setString(wchar_t **_pstData);
        bool                    setString(int _iRows, int _iCols, const wchar_t *_pstData);
        bool                    setString(int _iPos, const wchar_t *_pstData);
        ...
        static String*          insertNew(int _iSeqCount, int* _piSeqCoord, int* _piMaxDim, int _iDims, String* _poSource, bool _bAsVector);
