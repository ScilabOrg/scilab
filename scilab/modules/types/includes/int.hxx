...
namespace types
{
	...
	template<typename U, typename V> struct is_same_int { const static bool value = false; };
	template<typename U> struct is_same_int<U, U> { const static bool value = true; };

        bool isInt8() { return is_same_int<T, char>::value; }
        bool isInt16() { return is_same_int<T, short>::value; }
        bool isInt32() { return is_same_int<T, int>::value; }
        bool isInt64() { return is_same_int<T, long long>::value; }
        bool isUInt8() { return is_same_int<T, unsigned char>::value; }
        bool isUInt16() { return is_same_int<T, unsigned short>::value; }
        bool isUInt32() { return is_same_int<T, unsigned int>::value; }
        bool isUInt64() { return is_same_int<T, unsigned long long>::value; }
    };
