...
public final class ScilabVariables {
    ...
    public static final void sendDataAsBuffer(String varName, int[] indexes, DoubleBuffer data, int rows, int cols, int handlerId) {
        if (indexes.length != 0) {
            addElement(indexes, new ScilabDouble(null, data, null, rows, cols));
        } else {
            handlers.get(handlerId).handle(new ScilabDouble(varName, data, null, rows, cols));
        }
    }
    ...
    public static final void sendDataAsBuffer(String varName, int[] indexes, DoubleBuffer real, DoubleBuffer imag, int rows, int cols, int handlerId) {
        if (indexes.length != 0) {
            addElement(indexes, new ScilabDouble(null, real, imag, rows, cols));
        } else {
            handlers.get(handlerId).handle(new ScilabDouble(varName, real, imag, rows, cols));
        }
    }
    ...
    public static final void sendDataAsBuffer(String varName, int[] indexes, IntBuffer data, int rows, int cols, int handlerId) {
        if (indexes.length != 0) {
            addElement(indexes, new ScilabInteger(null, data, rows, cols, false));
        } else {
            handlers.get(handlerId).handle(new ScilabInteger(varName, data, rows, cols, false));
        }
    }
    ...
    public static final void sendUnsignedDataAsBuffer(String varName, int[] indexes, ShortBuffer data, int rows, int cols, int handlerId) {
        if (indexes.length != 0) {
            addElement(indexes, new ScilabInteger(null, data, rows, cols, true));
        } else {
            handlers.get(handlerId).handle(new ScilabInteger(varName, data, rows, cols, true));
        }
    }
    ...
    public static final void sendBooleanDataAsBuffer(String varName, int[] indexes, IntBuffer data, int rows, int cols, int handlerId) {
        if (indexes.length != 0) {
            addElement(indexes, new ScilabBoolean(null, data, rows, cols));
        } else {
            handlers.get(handlerId).handle(new ScilabBoolean(varName, data, rows, cols));
        }
    }
     ...
     *            the handler id
     */
    private static final void sendDataAsBuffer(String varName, int[] indexes, int row, int col, int nbItem, IntBuffer nbItemRow, IntBuffer colPos, DoubleBuffer data, int handlerId) {
        if (indexes.length != 0) {
            addElement(indexes, new ScilabSparse(null, row, col, nbItem, nbItemRow, colPos, data, null));
        } else {
            handlers.get(handlerId).handle(new ScilabSparse(varName, row, col, nbItem, nbItemRow, colPos, data, null));
