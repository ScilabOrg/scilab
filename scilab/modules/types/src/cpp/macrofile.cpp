...
namespace types
{
	...
	MacroFile const* MacroFile::getAsMacroFile(void)const
	{
		return this;
	}

	InternalType::RealType MacroFile::getType(void)const
	{
	...
	std::string MacroFile::toString(int _iPrecision, int _iLineLen)const
	{
