...
public class testSerialization {
    String referenceDataPath = "/modules/types/tests/java/org/scilab/tests/modules/types/referenceData/";
    ...
    private void writeReference(ScilabType a, String to) throws IOException {
        ...
        FileOutputStream fos = new FileOutputStream(ScilabConstants.SCI + to);
    ...
    private ScilabType readFromFile(String filename) {
        ScilabType a = null;
        try {
            FileInputStream fis = new FileInputStream(ScilabConstants.SCI + filename);
