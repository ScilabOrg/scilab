...
public class testSerialization {
    ...
    private String getReferenceDataPath() {
        if (!System.getProperty("os.name").toLowerCase().contains("windows")) {
          return "/modules/types/tests/java/org/scilab/tests/modules/types/referenceData/";
        } else {
    ...
    private void writeReference(ScilabType a, String to) throws IOException {
        ...
        if (!System.getProperty("os.name").toLowerCase().contains("windows")) {
          fos = new FileOutputStream(ScilabConstants.SCI + to);
        } 
    ...
    try {
      FileInputStream fis = new FileInputStream(filename);
        if (!System.getProperty("os.name").toLowerCase().contains("windows")) {
           fis = new FileInputStream(ScilabConstants.SCI + filename);
        }
    ...
    private String scilabDoubleFile=getReferenceDataPath()+"double.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void writeDoubleFileReference() throws IOException {
    ...
    private String scilabDoubleComplexFile=getReferenceDataPath()+"double.complex.data";
// Uncomment to regenerate a new reference file
    //@BeforeMethod
  public void writeDoubleComplexFileReference() throws IOException {
    ...
    private String scilabStringFile=getReferenceDataPath()+"string.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedStringTest() throws IOException {
    ...
    private String scilabInt8File=getReferenceDataPath()+"Int8.data";
    private String scilabInt8SignedFile=getReferenceDataPath()+"Int8.signed.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedInt8SignedTest() throws IOException {
    ...
    private String scilabInt16File=getReferenceDataPath()+"Int16.data";
    private String scilabInt16SignedFile=getReferenceDataPath()+"Int16.signed.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedInt16SignedTest() throws IOException {
    ...
    private String scilabInt32File=getReferenceDataPath()+"Int32.data";
    private String scilabInt32SignedFile=getReferenceDataPath()+"Int32.signed.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedInt32SignedTest() throws IOException {
    ...
    private String scilabInt64File=getReferenceDataPath()+"Int64.data";
    private String scilabInt64SignedFile=getReferenceDataPath()+"Int64.signed.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedInt64SignedTest() throws IOException {
    ...
    private String scilabBooleanFile=getReferenceDataPath()+"Boolean.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedBooleanTest() throws IOException {
    ...
    private String scilabListFile=getReferenceDataPath()+"List.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedListTest() throws IOException {
    ...
    private String scilabTListFile=getReferenceDataPath()+"TList.data";
...
// Uncomment to regenerate a new reference file
  ...
  public void readJavaSerializedTListTest() throws IOException {
    ...
    private String scilabMListFile=getReferenceDataPath()+"MList.data";
