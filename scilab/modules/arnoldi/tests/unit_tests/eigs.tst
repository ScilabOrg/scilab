...
d1 = eigs(A, [], k, 'LI');
assert_checkalmostequal(imag(d1), imag(d0([1 2 17 18])), 1.e-10);

d1 = eigs(A, [], k, 'SI');
assert_checkalmostequal(imag(d1), imag(d0([11 12  15 16])), 1.e-10);

d1 = eigs(A, [], k, 4.1); 
assert_checkalmostequal(abs(d1), abs(d0($-k:-1:$-(2*k)+1)), 1.e-10);
...
d1 = eigs(A, [], k, 4.1); 
assert_checkalmostequal(abs(d1), abs(d0($-2:-1:$-k-1)), 1.e-10);  
