...
int sci_eigs(char *fname, unsigned long fname_len)
{
    ...
    *****************************************/
    ...
    eigenvalue = (doublecomplex*) malloc(iNEV * sizeof(doublecomplex));
    memset(eigenvalue, 0, iNEV * sizeof(doublecomplex));
    ...
    if (Lhs > 1)
    {
        mat_eigenvalue = (doublecomplex*) malloc(iNEV * iNEV * sizeof(doublecomplex));
        memset(mat_eigenvalue, 0, iNEV * iNEV * sizeof(doublecomplex));

        eigenvector = (doublecomplex*) malloc(N * iNEV * sizeof(doublecomplex));
        memset(eigenvector, 0, N * iNEV * sizeof(doublecomplex));
    }
