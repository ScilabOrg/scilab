...
public:
     ...
     */
    XMLDocument(const char *path, bool validate, std::string * error, const bool html = false);
     ...
     * @param error a pointer to a string which will receive the error message
     */
    XMLDocument(const std::string & xmlCode, bool validate, std::string * error, const bool html = false);
...
private:
     ...
     * @return a pointer on a xmlDoc
     */
    static xmlDoc *readHTMLDocument(const char *filename, std::string * error);
     ...
     * @return a pointer on a xmlDoc
     */
    static xmlDoc *readHTMLDocument(const std::string & xmlCode, std::string * error);
