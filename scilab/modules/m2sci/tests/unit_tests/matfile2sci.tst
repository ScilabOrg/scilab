...
assert_checkerror('matfile2sci(matfile_content_empty, w_file_content_empty,""w"")', errmsg_c_empty); 
assert_checkerror('matfile2sci(matfile_content_empty, a_file_content_empty,""a"")', errmsg_c_empty); 
...
assert_checkerror('matfile2sci(matfile_empty, w_file_empty, ""w"")', errmsg_empty); 
assert_checkerror('matfile2sci(matfile_empty, a_file_empty, ""a"")', errmsg_empty); 
...
//==============================================================================
//Testing the error message on a call with third argument different than "w" or "a"
matfile_notaw         = pathconvert("SCI/modules/m2sci/tests/unit_tests/m2sci_empty.mat",%F,%T);
w_file_notaw          = pathconvert("TMPDIR/w_empty.sod",%F,%T);

errmsg_notaw = msprintf(_("%s: Wrong value for input argument #%d: ""%s"" expected .\n"), "matfile2sci", 3, "''a'' or ''w''")
assert_checkerror('matfile2sci(matfile_empty, w_file_empty, ""a wrong value"")', errmsg_notaw); 
...
matfile2sci(matfile_not_empty1, a_file_not_empty, "a");
matfile2sci(matfile_not_empty2, a_file_not_empty, "a");
...
matfile2sci(matfile_not_empty1, w_file_not_empty, "w");
...
matfile2sci(matfile_not_empty2, w_file_not_empty, "w");
