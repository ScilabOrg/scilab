...
void C2F(lufact1) (double *val, int *lln, int *col, int *n, int *nel, int *fmatindex, double *eps, double *releps, int *nrank, int *ierr)
{
...
void C2F(luget1) (int *fmatindex, int *indP, double *P, int *indl, double *l, int *indu, double *u, int *indQ, double *Q, int *ierr)
{
    char *fmat;
...
int addluptr(char *ptr)
{
    ...
    if (sci_luptr_table_size == 0)
    {                           /* first call alloacte a small array of pointers */
