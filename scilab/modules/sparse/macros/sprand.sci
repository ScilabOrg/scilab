...
function a=sprand(m,n,density,typ)
    ...
    if typ == "u" | typ == "uniform" then //"u" or "uniform" is the syntax for uniform distribution with rand, the equivalent with grand is "def"
        typ = "def";
    elseif typ == "n" | typ == "normal" then //"n" or "normal" is the syntax for normal distribution with, the equivalent with grand is "nor"
        typ = "nor";
    end
