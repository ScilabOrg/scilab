...
// 1. Interface
// ============
assert_checkfalse(execstr("qmr()","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr(1)","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr([1 2;3 4])","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr([1 2;3 4;5 6],[1;1;1])","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr([1 2;3 4;5 6],[1 1 1])","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr([1 2;3 4],[1 1])","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr([%t %t;%t %t],[1;1])","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
assert_checkfalse(execstr("qmr([],[])","errcatch") == 0);
lasterror(execstr("10000","errcatch") == 0)
