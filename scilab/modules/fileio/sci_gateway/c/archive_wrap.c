...
int verbose_get(SWIG_GatewayParameters) {
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int((int)(verbose))))) return SWIG_ERROR;
  return SWIG_OK;
}


int verbose_set(SWIG_GatewayParameters) {
  SWIG_CheckInputArgument(pvApiCtx, 1, 1);
  SWIG_CheckOutputArgument(pvApiCtx, 1, 1);
  SWIG_Scilab_SetApiContext(pvApiCtx);
...
int _wrap_archive_extract(SWIG_GatewayParameters) {
  char *arg1 = (char *) 0 ;
  int arg2 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  res1 = SWIG_SciString_AsCharPtrAndSize(pvApiCtx, 1, &buf1, NULL, &alloc1, SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "archive_extract" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  ecode2 = SWIG_AsVal_int(2, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "archive_extract" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  result = (int)archive_extract(arg1,arg2);
  SWIG_Scilab_SetOutputPosition(0);
...
extern "C"
#endif
int sci_archive_list_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libsci_archive_list"
#ifdef __cplusplus
extern "C"
#endif
int libsci_archive_list(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"sci_archive_list_Init") == 0) {
    addCFunction((wchar_t *)L"sci_archive_list_Init", &sci_archive_list_Init, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"SWIG_this") == 0) {
    addCFunction((wchar_t *)L"SWIG_this", &SWIG_this, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"SWIG_ptr") == 0) {
    addCFunction((wchar_t *)L"SWIG_ptr", &SWIG_ptr, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"archive_list") == 0) {
    addCFunction((wchar_t *)L"archive_list", &_wrap_archive_list, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"verbose_get") == 0) {
    addCFunction((wchar_t *)L"verbose_get", &verbose_get, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"verbose_set") == 0) {
    addCFunction((wchar_t *)L"verbose_set", &verbose_set, (wchar_t *)MODULE_NAME); 
  }
...
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)sci_archive_list_Init, (char *)"sci_archive_list_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_archive_list, (char *)"archive_list"
  },
  {
    (Myinterfun)sci_gateway, (GT)verbose_get, (char *)"verbose_get"
  },
  {
    (Myinterfun)sci_gateway, (GT)verbose_set, (char *)"verbose_set"
  },
  {
