...
//
// <-- Short Description -->
// movefile, copyfile did not support '~', 'TMPDIR', ... shorcuts in filenames
//

mputl('bug_11081','TMPDIR/bug_11081_txt_1.txt');
copyfile('TMPDIR/bug_11081_txt_1.txt', 'TMPDIR/bug_11081_txt_2.txt');
assert_checkequal(isfile('TMPDIR/bug_11081_txt_2.txt'), %T);
movefile('TMPDIR/bug_11081_txt_2.txt', 'TMPDIR/bug_11081_txt_3.txt');
assert_checkequal(isfile('TMPDIR/bug_11081_txt_3.txt'), %T);
