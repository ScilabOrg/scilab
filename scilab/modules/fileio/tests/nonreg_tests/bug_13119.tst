...
refMsg2 = msprintf(_("%s: Wrong type for input argument #%d: A real number expected.\n"), "mget", 1);
...
refMsg4 = msprintf(_("%s: Wrong type for input argument #%d: A real number expected.\n"), "mgetl", 2);
