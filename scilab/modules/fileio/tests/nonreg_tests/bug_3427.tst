...
err_msg = lasterror();
ref_msg = msprintf(gettext("%s: Wrong type for input argument #%d: A real number expected.\n"),"mgetl",2);
...
if ierr <> 999 then pause,end
err_msg = lasterror();
ref_msg = msprintf(gettext("%s: Wrong size for input argument #%d: A scalar expected.\n"),"mgetl",2);
