...
clear gce scf genfac3d %_plot2d gca %_plot3d;
...
//close windows and clear handles
close();close();close();close();close();close();close();close();
clear hUiControl hMenu hAxis hText hFec hMatplot hGrayplot hSeg hChamp hArc hRectangle hFac3d hPlot2d hPlot3d hF;

varList = listvarinfile(TMPDIR + "/bug_4339.bin");
