...
//invalid calls
if execstr("[wn,zeta]=damp()","errcatch")==0 then pause,end
if execstr("[wn,zeta]=damp(%t)","errcatch")==0 then pause,end
if execstr("[wn,zeta]=damp(P,1:3)","errcatch")==0 then pause,end
if execstr("[wn,zeta]=damp(P,%t)","errcatch")==0 then pause,end
