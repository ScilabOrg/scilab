...
refMsg = msprintf(_("%s: Wrong values for input arguments #%d and #%d."), "contr", 1, 2); 
...
refMsg = msprintf(_("%s: Wrong type for input argument #%d: A real scalar expected."), "contr", 3); 
