...
static int pak_object_info(int ilk, int stk_pos, int *pack, int *np, int *nMax)
{
    ...
    {
    case sci_matrix:
        C2F(spak) (&il, pack, np, nMax);
        break;
    case sci_poly:
        C2F(ppak) (&il, pack, np, nMax);
        break;
    case sci_boolean:
        C2F(bpak) (&il, pack, np, nMax);
        break;
    case sci_sparse:
        C2F(sppak) (&il, pack, np, nMax);
        break;
    case sci_boolean_sparse:
        C2F(bsppak) (&il, pack, np, nMax);
        break;
    case sci_ints:
        C2F(ipak) (&il, pack, np, nMax);
        break;
    case sci_strings:
        C2F(cpak) (&il, pack, np, nMax);
        break;
    case sci_u_function:
    case sci_c_function:
        C2F(mpak) (&il, pack, np, nMax);
        break;
    case sci_lib:
        C2F(libpak) (&il, pack, np, nMax);
        break;
    case sci_list:
    case sci_tlist:
    case sci_mlist:
