            ...
            if (pwstPercent != NULL && bPercentPercent == false)
            {
                ...
                switch (wcType)
                {
                    ...
                    case L'X' : //HEX
                        ...
                        if (isinf(in[iPosArg + 1]->getAs<types::Double>()->get(0)) || ISNAN(in[iPosArg + 1]->getAs<types::Double>()->get(0)))
                        {
        ...
        for (int j = 0 ; j < iLoop ; j++)
        {
            ...
            for (int i = 1 ; i < _iArgsCount + 1 ; i++)
            {
                ...
                else if (pToken[i].outputType == InternalType::ScilabString)
                {
                    ...
                    if (in[iPosArg + 1]->isDouble() && isinf(in[iPosArg + 1]->getAs<types::Double>()->get(0)))
                    {
                        if (signbit(in[iPosArg + 1]->getAs<types::Double>()->get(0)))
                        {
                    ...
                    else if (in[iPosArg + 1]->isDouble() && ISNAN(in[iPosArg + 1]->getAs<types::Double>()->get(0)))
                    {
                        pwstStr = NanString;
                    }
                    else
