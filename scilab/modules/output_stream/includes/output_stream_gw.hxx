...
CPP_GATEWAY_PROTOTYPE(sci_disp, OUTPUT_STREAM_IMPEXP_GW);
CPP_GATEWAY_PROTOTYPE(sci_msprintf, OUTPUT_STREAM_IMPEXP_GW);
CPP_GATEWAY_PROTOTYPE(sci_mprintf, OUTPUT_STREAM_IMPEXP_GW);
