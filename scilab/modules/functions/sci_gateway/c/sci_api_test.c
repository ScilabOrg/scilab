...
int sci_api_empty(scilabEnv env, int nin, scilabVar* in, scilabOpt* opt, int nout, scilabVar* out)
{
...
int sci_api_work(scilabEnv env, int nin, scilabVar* in, scilabOpt* opt, int nout, scilabVar* out)
{
    int i = 0;
    double ret = 0;
    for (i = 0; i < nin; ++i)
