...
double scilab_timer(void)
{
    ...
    utime = ((unsigned long long)user_time.dwHighDateTime << 32) + (unsigned)user_time.dwLowDateTime;

    stime = ((unsigned long long)kernel_time.dwHighDateTime << 32) + (unsigned)kernel_time.dwLowDateTime;
    ...
    usertime = (double)((float)(rbuff.ru_utime).tv_sec + (float)(rbuff.ru_utime).tv_usec / 1000000.0);

    systime = (double)((float)(rbuff.ru_stime).tv_sec + (float)(rbuff.ru_stime).tv_usec / 1000000.0);
