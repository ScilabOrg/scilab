...
extern "C"
{
    ...
    SWIGEXPORT jstring JNICALL Java_org_scilab_modules_commons_ScilabCommonsJNI_getshortpathname(JNIEnv * jenv, jclass jcls, jstring jarg1,
                                                                                                 jintArray jarg2)
    {
        jstring jresult = 0;
        char *arg1 = (char *)0;
        ...
        result = (char *)getshortpathname(arg1, arg2);
        if (result)
            jresult = (*jenv)->NewStringUTF(jenv, (const char *)result);
        {
