...
SWIGEXPORT jlongArray JNICALL Java_org_scilab_modules_commons_CommonFileUtilsJNI_getFileProperties(JNIEnv *jenv, jclass jcls, jstring jarg1) {
  ...
  result = (unsigned long *)getFileProperties(arg1);
  jresult = SWIG_JavaArrayOutUlong(jenv, result, 6); 
  if (arg1) (*jenv)->ReleaseStringUTFChars(jenv, jarg1, (const char *)arg1);
  return jresult;
}
