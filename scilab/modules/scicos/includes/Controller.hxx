...
public:
    ...
    ScicosID cloneObject(ScicosID uid, bool cloneChildren, bool clonePorts = true);
...
private:
    ...
    ScicosID cloneObject(std::map<ScicosID, ScicosID>& mapped, ScicosID uid, bool cloneChildren, bool clonePorts = true);
