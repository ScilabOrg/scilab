...
public:
    ...
    bool referenceObject(const ScicosID uid);
...
private:
    ...
    struct ModelObject
    {
        //    	ModelObject() : m_o(nullptr), m_refCounter(0) {}
        //    	ModelObject(const ModelObject& object) : m_o(object.m_o), m_refCounter(object.m_refCounter) {}
    ...
    typedef std::map<ScicosID, ModelObject > objects_map_t;
