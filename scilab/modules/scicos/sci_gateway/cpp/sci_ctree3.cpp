...
types::Function::ReturnValue sci_ctree3(types::typed_list &in, int _iRetCount, types::typed_list &out)
{
    ...
    types::Double* pIn6Clone = pIn6->clone()->getAs<types::Double>();
    pIn6Clone->convertToInteger();
    types::Double* pIn7Clone = pIn7->clone()->getAs<types::Double>();
    pIn7Clone->convertToInteger();
    types::Double* pIn8Clone = pIn8->clone()->getAs<types::Double>();
    pIn8Clone->convertToInteger();
    ...
    int nord;
    int ipok;
    ctree3((int*) pIn1Clone->getReal(), n, (int*) pIn2Clone->getReal(), (int*) pIn3Clone->getReal(), (int*) pIn4Clone->getReal(), (int*) pIn5Clone->getReal(),
           (int*) pIn6Clone->getReal(), (int*) pIn7Clone->getReal(), (int*) pIn8Clone->getReal(), ipord, &nord, &ipok);
    ...
    pIn5Clone->killMe();
    pIn6Clone->DecreaseRef();
    pIn6Clone->killMe();
    pIn7Clone->DecreaseRef();
    pIn7Clone->killMe();
    pIn8Clone->DecreaseRef();
    pIn8Clone->killMe();
    delete[] ipord;
