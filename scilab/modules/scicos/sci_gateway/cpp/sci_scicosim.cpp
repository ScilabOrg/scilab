...
types::Function::ReturnValue sci_scicosim(types::typed_list &in, int _iRetCount, types::typed_list &out)
{
    ...
    *******************************/
    types::List* lfunpt = new types::List();
    for (int i = 0; i < nblk; ++i) // For each block
    {
        ...
        {
            // Block is defined by a C or Fortran function or a predefined Scilab function
            ...
            types::InternalType* fun = symbol::Context::getInstance()->get(symbol::Symbol(funStr->get(0)));
            if (fun == nullptr)
            {
                Scierror(999, _("%s: Wrong value for element #%d of input argument #%d : Unknown block.\n"), funname.data(), i + 1, 4);
                return types::Function::Error;
            }
            lfunpt->set(i, fun);
        }
    ...
    **********************/
    ...
    {
        // Allocation of 'oz'
        if ((oz = (void **) MALLOC((noz) * sizeof(void *))) == nullptr)
        {
        ...
        // Allocation of 'ozsz'
        if ((ozsz = (int *) MALLOC(2 * (noz) * sizeof(int))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            lfunpt->DecreaseRef();
        ...
        // Allocation of 'oztyp'
        if ((oztyp = (int *) MALLOC((noz) * sizeof(int))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
    ...
    ****************************/
    ...
    {
        // Allocation of 'opar'
        if ((opar = (void **) MALLOC((nopar) * sizeof(void *))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
        ...
        if ((oparsz = (int *) MALLOC(2 * (nopar) * sizeof(int))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
        ...
        if ((opartyp = (int *) MALLOC((nopar) * sizeof(int))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
    ...
    *******************************/
    ...
    if (nlnk > 0)
    {
        ...
        if ((outtbptr = (void **) MALLOC((nlnk) * sizeof(void *))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
        ...
        if ((outtbsz = (int *) MALLOC(2 * (nlnk) * sizeof(int))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
        ...
        // Allocation of 'outtbptrtyp'
        if ((outtbtyp = (int *) MALLOC((nlnk) * sizeof(int))) == nullptr)
        {
            Scierror(999, _("%s: Memory allocation error.\n"), funname.data());
            FREE(oz);
            FREE(ozsz);
