...
template<typename T>
static int fill_string(const double* const tab, const int tabSize, const int iDims, T* &res)
{
    int  iElements = 1;
    int* pDims = new int[iDims];
    for (int i = 0; i < iDims; ++i)
...
static bool readElement(const double* const input, int iType, int iDims, int inputRows, int &offset, types::InternalType* &res)
{
    switch (iType)
    {
        case types::InternalType::ScilabDouble :
        {
            ...
            int resSize = fill_double(input + 2, inputRows, iDims, pDouble);
            if (resSize < 0)
            {
        ...
        case types::InternalType::ScilabInt8   :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pInt8);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt8  :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pUInt8);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabInt16  :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pInt16);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt16 :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pUInt16);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabInt32  :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pInt32);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt32 :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pUInt32);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabInt64  :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pInt64);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt64 :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pUInt64);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabBool   :
        {
            ...
            int resSize = fill_int(input + 2, inputRows, iDims, pBool);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabString :
        {
            ...
            int resSize = fill_string(input + 2, inputRows, iDims, pString);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
