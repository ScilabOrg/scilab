...
template<typename T>
int encode(const double* const tab, const int tabSize, const int iDims, T* &res)
{
    int  iElements = 1;
...
template<>
int encode(const double* const tab, const int tabSize, const int iDims, types::Double* &res)
{
    int  iElements = 1;
    int* pDims = new int[iDims];
    for (int i = 0; i < iDims; ++i)
...
template<>
int encode(const double* const tab, const int tabSize, const int iDims, types::String* &res)
{
    int  iElements = 1;
    int* pDims = new int[iDims];
    for (int i = 0; i < iDims; ++i)
...
static bool readElement(const double* const input, int iType, int iDims, int inputRows, int &offset, types::InternalType* &res)
{
    switch (iType)
    {
        case types::InternalType::ScilabDouble :
        {
            if (inputRows < 5)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset + 5, 1);
                return false;
            }

            types::Double* pDouble = nullptr;
            int resSize = encode<types::Double>(input + 2, inputRows, iDims, pDouble);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
            }
            res = pDouble;
            offset += resSize;
        ...
        case types::InternalType::ScilabInt8   :
        {
            ...
            int resSize = encode<types::Int8>(input + 2, inputRows, iDims, pInt8);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt8  :
        {
            ...
            int resSize = encode<types::UInt8>(input + 2, inputRows, iDims, pUInt8);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabInt16  :
        {
            ...
            int resSize = encode<types::Int16>(input + 2, inputRows, iDims, pInt16);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt16 :
        {
            ...
            int resSize = encode<types::UInt16>(input + 2, inputRows, iDims, pUInt16);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabInt32  :
        {
            ...
            int resSize = encode<types::Int32>(input + 2, inputRows, iDims, pInt32);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt32 :
        {
            ...
            int resSize = encode<types::UInt32>(input + 2, inputRows, iDims, pUInt32);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabInt64  :
        {
            ...
            int resSize = encode<types::Int64>(input + 2, inputRows, iDims, pInt64);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabUInt64 :
        {
            ...
            int resSize = encode<types::UInt64>(input + 2, inputRows, iDims, pUInt64);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabBool   :
        {
            ...
            int resSize = encode<types::Bool>(input + 2, inputRows, iDims, pBool);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
        ...
        case types::InternalType::ScilabString :
        {
            ...
            int resSize = encode<types::String>(input + 2, inputRows, iDims, pString);
            if (resSize < 0)
            {
                Scierror(999, _("%s: Wrong size for input argument #%d: At least %dx%d expected.\n"), funname.c_str(), 1, offset - resSize, 1);
                return false;
