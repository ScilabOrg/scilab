...
//!
  ...
  if path_in==-1 then
    ...
    if typ==0 then
      messagebox([gettext("Highlighted block has connected ports");gettext("with  incompatible sizes.")], gettext("Connection error"), "warning", "modal")

    else
      messagebox([gettext("Highlighted block has connected ports");gettext("with  incompatible types.")], gettext("Connection error"), "warning", "modal")
    end
  ...
  if prt_in <> -1 then  //two connected blocks
    ...
    if path==[] then
      ...
      if typ==0 then
        messagebox([gettext("Highlighted block(s) have connected ports"); gettext("with  incompatible sizes.");" "; ..
        ...
        messagebox([gettext("Highlighted block(s) have connected ports"); gettext("with  incompatible types.");" "; ..
