...
// This function displays an Xcos parameter error message box
// arg1 inform: Information about the nature of the error
// arg2 expected: Information about the expected value
