...
{
public:
    Annotation(): BaseObject(ANNOTATION), m_parentDiagram(0ll), m_parentBlock(0ll),
        m_description(std::string("Text")), m_font(std::string("2")), m_font_size(std::string("1")), m_relatedTo(0ll)
    {
