...
{
public:
    Port() : BaseObject(PORT), m_dataType(0), m_sourceBlock(0ll), m_kind(PORT_UNDEF), m_implicit(false),
        m_style(), m_label(), m_firing(0), m_connectedSignals(std::vector<ScicosID> (1, 0ll)) {};
