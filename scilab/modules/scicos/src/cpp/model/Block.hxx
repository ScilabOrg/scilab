...
private:
    Block() : BaseObject(BLOCK), parentBlock(0), parentDiagram(0), portReference(0) {};
    Block(const Block& o) : BaseObject(BLOCK), parentBlock(o.parentBlock), parentDiagram(o.parentDiagram), portReference(o.portReference) {};
    ~Block() {}
    ...
    const std::wstring& getInterfaceFunction() const
    {
        return interfaceFunction;
    }

    void setInterfaceFunction(const std::wstring& interfaceFunction)
    {
