...
static bool getDoubleArray(types::InternalType* p, double** dest, int size)
{
    *dest = nullptr;
...
static bool getDoubleArrayAsInt(types::InternalType* p, int** dest, int size)
{
    *dest = nullptr;
...
static bool checkType(int type, types::InternalType* p)
{
    if (p == nullptr)
    {
        return false;
