 ...
 */
template<typename T>
inline size_t required_length(T* v)
{
...
template<typename T>
inline int decode(const double* const tab, const int tabSize, const int iDims, const int offset, T* &res)
{
    int  iElements = 1;
...
template<>
inline int decode(const double* const tab, const int tabSize, const int iDims, const int offset, types::Double* &res)
{
    int  iElements = 1;
    int* pDims = new int[iDims];
    for (int i = 0; i < iDims; ++i)
...
template<>
inline int decode(const double* const tab, const int tabSize, const int iDims, const int offset, types::String* &res)
{
    int  iElements = 1;
    int* pDims = new int[iDims];
    for (int i = 0; i < iDims; ++i)
...
static bool readElement(const double* const input, int iType, int iDims, int inputRows, int &offset, types::InternalType* &res)
{
    switch (iType)
    {
        case types::InternalType::ScilabDouble :
        {
            ...
            int resSize = decode<types::Double>(input + 2, inputRows, iDims, offset, pDouble);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabInt8   :
        {
            ...
            int resSize = decode<types::Int8>(input + 2, inputRows, iDims, offset, pInt8);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabUInt8  :
        {
            ...
            int resSize = decode<types::UInt8>(input + 2, inputRows, iDims, offset, pUInt8);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabInt16  :
        {
            ...
            int resSize = decode<types::Int16>(input + 2, inputRows, iDims, offset, pInt16);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabUInt16 :
        {
            ...
            int resSize = decode<types::UInt16>(input + 2, inputRows, iDims, offset, pUInt16);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabInt32  :
        {
            ...
            int resSize = decode<types::Int32>(input + 2, inputRows, iDims, offset, pInt32);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabUInt32 :
        {
            ...
            int resSize = decode<types::UInt32>(input + 2, inputRows, iDims, offset, pUInt32);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabInt64  :
        {
            ...
            int resSize = decode<types::Int64>(input + 2, inputRows, iDims, offset, pInt64);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabUInt64 :
        {
            ...
            int resSize = decode<types::UInt64>(input + 2, inputRows, iDims, offset, pUInt64);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabBool   :
        {
            ...
            int resSize = decode<types::Bool>(input + 2, inputRows, iDims, offset, pBool);
            if (resSize < 0)
            {
                return false;
            }
        ...
        case types::InternalType::ScilabString :
        {
            ...
            int resSize = decode<types::String>(input + 2, inputRows, iDims, offset, pString);
            if (resSize < 0)
            {
                return false;
            }
...
inline bool vec2var(types::Double* in, types::InternalType* &out)
{
    int iType = in->get(0);
    int iDims = in->get(1);
    ...
    int offset = 0;
    if (!readElement(in->get(), iType, iDims, inRows, offset, out))
    {
        return false;
    }
