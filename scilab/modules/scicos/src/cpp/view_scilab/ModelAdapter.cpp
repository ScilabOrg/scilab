...
static types::Double* get_port(const ModelAdapter& adaptor, object_properties_t p, const Controller& controller, object_properties_t p2)
{
    model::Block* adaptee = adaptor.getAdaptee();
    ...
    {
        double data;
        controller.getObjectProperty(*it, PORT, p2, data);
        o[i] = data;
    }
...
struct inSize1
{
    ...
    static types::InternalType* get(const ModelAdapter& adaptor, const Controller& controller)
    {
        return get_port(adaptor, INPUTS, controller, INPUTS_SIZE1);
    }

    static bool set(ModelAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_port(adaptor, v, INPUTS, controller, INPUTS_SIZE1);
    }
};
...
struct inSize2
{
    ...
    static types::InternalType* get(const ModelAdapter& adaptor, const Controller& controller)
    {
        return get_port(adaptor, INPUTS, controller, INPUTS_SIZE2);
    }

    static bool set(ModelAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_port(adaptor, v, INPUTS, controller, INPUTS_SIZE2);
    }
};
...
struct inType
{
    ...
    static types::InternalType* get(const ModelAdapter& adaptor, const Controller& controller)
    {
        return get_port(adaptor, INPUTS, controller, INPUTS_TYPE);
    }

    static bool set(ModelAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_port(adaptor, v, INPUTS, controller, INPUTS_TYPE);
    }
};
