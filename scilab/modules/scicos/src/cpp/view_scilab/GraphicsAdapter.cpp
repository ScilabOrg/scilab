...
struct pin
{
    ...
    static types::InternalType* get(const GraphicsAdapter& adaptor, const Controller& controller)
    {
        return get_ports(adaptor, INPUTS, controller);
    }

    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return create_ports(adaptor, v, INPUTS, controller);
    }
};
...
struct pout
{
    ...
    static types::InternalType* get(const GraphicsAdapter& adaptor, const Controller& controller)
    {
        return get_ports(adaptor, OUTPUTS, controller);
    }

    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return create_ports(adaptor, v, OUTPUTS, controller);
    }
};
...
struct pein
{
    ...
    static types::InternalType* get(const GraphicsAdapter& adaptor, const Controller& controller)
    {
        return get_ports(adaptor, EVENT_INPUTS, controller);
    }

    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return create_ports(adaptor, v, EVENT_INPUTS, controller);
    }
};
...
struct peout
{
    ...
    static types::InternalType* get(const GraphicsAdapter& adaptor, const Controller& controller)
    {
        return get_ports(adaptor, EVENT_OUTPUTS, controller);
    }

    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return create_ports(adaptor, v, EVENT_OUTPUTS, controller);
    }
};
...
struct in_implicit
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_ports_property(adaptor, v, INPUTS, controller, IMPLICIT);
    }
};
...
struct out_implicit
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_ports_property(adaptor, v, OUTPUTS, controller, IMPLICIT);
    }
};
...
struct in_style
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_ports_property(adaptor, v, INPUTS, controller, STYLE);
    }
};
...
struct out_style
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_ports_property(adaptor, v, OUTPUTS, controller, STYLE);
    }
};
...
struct in_label
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_ports_property(adaptor, v, INPUTS, controller, LABEL);
    }
};
...
struct out_label
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        return set_ports_property(adaptor, v, OUTPUTS, controller, LABEL);
    }
};
