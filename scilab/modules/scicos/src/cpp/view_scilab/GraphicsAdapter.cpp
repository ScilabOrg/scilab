...
struct exprs
{
    ...
    static bool set(GraphicsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        if (v->getType() == types::InternalType::ScilabString)
        {
            ...
            exprs.resize(current->getRows() * current->getCols());
...
types::Double* get_port(const GraphicsAdapter& adaptor, object_properties_t p, const Controller& controller)
{
    model::Block* adaptee = adaptor.getAdaptee();
...
bool set_port(const GraphicsAdapter& adaptor, types::InternalType* v, object_properties_t p, Controller& controller)
{
    model::Block* adaptee = adaptor.getAdaptee();
    ...
    for (std::vector<int>::iterator it = newPorts.begin(); it != newPorts.end(); ++it)
    {
