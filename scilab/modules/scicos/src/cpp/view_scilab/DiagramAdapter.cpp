...
std::vector<BlockAdapter*> DiagramAdapter::getBlocks() const
{
    ...
    for (std::vector<BlockAdapter*>::const_iterator it = blockAdapters.begin(); it != blockAdapters.end(); ++it)
    {
        blocks.push_back(new BlockAdapter(**it));
    }
    return blocks;
}

void DiagramAdapter::setBlock(const BlockAdapter* newBlock)
{
...
std::vector<LinkAdapter*> DiagramAdapter::getLinks() const
{
    ...
    for (std::vector<LinkAdapter*>::const_iterator it = linkAdapters.begin(); it != linkAdapters.end(); ++it)
    {
        links.push_back(new LinkAdapter(**it));
    }
    return links;
}

void DiagramAdapter::setLink(const LinkAdapter* newLink)
{
...
{
    std::vector<TextAdapter*> texts;

    for (std::vector<TextAdapter*>::const_iterator it = textAdapters.begin(); it != textAdapters.end(); ++it)
    {
        texts.push_back(new TextAdapter(**it));
    }
    return texts;
}

void DiagramAdapter::setText(const TextAdapter* newText)
{
