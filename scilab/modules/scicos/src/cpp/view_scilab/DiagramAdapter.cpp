...
void DiagramAdapter::setBlocks(const std::vector<BlockAdapter*>& newBlocks)
{
    clearBlocks();
    blockAdapters = newBlocks;
}
...
void DiagramAdapter::setLinks(const std::vector<LinkAdapter*>& newLinks)
{
    clearLinks();
    linkAdapters = newLinks;
}
...
void DiagramAdapter::setTexts(const std::vector<TextAdapter*>& newTexts)
{
    clearTexts();
    textAdapters = newTexts;
}
