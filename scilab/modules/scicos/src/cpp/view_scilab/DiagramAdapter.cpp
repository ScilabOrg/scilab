...
DiagramAdapter::DiagramAdapter(const DiagramAdapter& o) :
    BaseAdapter<DiagramAdapter, org_scilab_modules_scicos::model::Diagram>(o), contrib_content(o.contrib_content) {}
...
void DiagramAdapter::setContribContent(types::InternalType* contrib_content)
{
    this->contrib_content = contrib_content;
}
