...
struct tol
{
    ...
    static types::InternalType* get(const ParamsAdapter& adaptor, const Controller& controller)
    {
        ...
        controller.getObjectProperty(adaptee->id(), adaptee->kind(), TOL, tol);
    ...
    static bool set(ParamsAdapter& adaptor, types::InternalType* v, Controller& controller)
    {
        ...
        controller.setObjectProperty(adaptee->id(), adaptee->kind(), TOL, tol);
        return true;
    }
};
...
struct tf
{
    ...
    static types::InternalType* get(const ParamsAdapter& adaptor, const Controller& controller)
    {
        ...
        controller.getObjectProperty(adaptee->id(), adaptee->kind(), TOL, tf);
