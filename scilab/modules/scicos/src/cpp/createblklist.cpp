...
/*--------------------------------------------------------------------------*/
static types::InternalType* vartosci(void* data, int rows, int cols, int type)
{
    int size = rows * cols;
    switch (type)
    {
...
types::InternalType* createblklist(scicos_block *Blocks, int flag_imp, int funtyp)
{
    ...
    {
        int rows = Blocks->ozsz[k]; /* retrieve number of rows */
        int cols = Blocks->ozsz[Blocks->noz + k]; /* retrieve number of cols */
        int type = Blocks->oztyp[k]; /* retrieve type */
    ...
    {
        int rows = Blocks->outsz[k]; /* retrieve number of rows */
        int cols = Blocks->outsz[Blocks->nout + k]; /* retrieve number of cols */
        int type = Blocks->outsz[2 * Blocks->nout + k]; /* retrieve type */
    ...
    {
        int rows = Blocks->oparsz[k]; /* retrieve number of rows */
        int cols = Blocks->oparsz[Blocks->nopar + k]; /* retrieve number of cols */
        int type = Blocks->opartyp[k]; /* retrieve type */
