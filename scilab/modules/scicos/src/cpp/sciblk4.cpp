    ...
    switch (flag)
    {
        ...
        **********************/
        case 1:
        {
            ...
            if (Blocks->outptr == nullptr)
            {
                Blocks->outptr = (void**)new std::vector<double>[1];
                Blocks->outptr[0] = (void*)new std::vector<double>;
            }

            std::vector<double>** toto = (std::vector<double>**)Blocks->outptr;
            var2vec(t->getField(L"outptr"), *((std::vector<double>**)Blocks->outptr)[0]);
