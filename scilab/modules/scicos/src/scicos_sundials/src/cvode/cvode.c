          ...
          realtype *tret, int itask)
{
  ...
  if (nst > 0) {
    ...
    if (lmm==CV_DORPI) mxstep = CVHinDOPRI(cv_mem, tout, tret);
...
static int CVStepDOPRI(CVodeMem cv_mem)
{
  ...
  c6 = 1.;					a42 = -56/15;
  c7 = 1.;					a43 = 32/9;
  b1 = 35/384;				a51 = 19372/6561;
  b2 = 0;					a52 = -25360/2781;
  b3 = 500/1113;			a53 = 64448/6561;
  b4 = 125/192;				a54 = -212/729;
  b5 = -2187/6784;			a61 = 9017/3168;
  b6 = 11/84;				a62 = -355/33;
  b7 = 0;					a63 = 46732/5247;
  d1 = 5179/57600;			a64 = 49/176;
  d2 = 0;					a65 = -5103/18656;
  d3 = 7571/16695;			a71 = 35/384;
  d4 = 393/640;				a72 = 0;
  d5 = -92097/339200;		a73 = 500/1113;
  d6 = 187/2100;			a74 = 125/192;
  d7 = 1/40;				a75 = -2187/6784;
                            a76 = 11/84;
  ...
  N_VScale(d1, zn[2], y); 								/* y = b1*K1 + 0*K2, */

  N_VLinearSum_Serial (a32*h, zn[3], 1., zn[0], ftemp);	/* ftemp = Yn + K2*a32*h, */
  N_VLinearSum_Serial (a31*h, zn[2], ftemp, ftemp);		/* ftemp += K1*a31*h, */
  retval = f(tn + c2*h, ftemp, tempv, f_data);			/* tempv = K3 = f(Tn+h/2, Yn + (h/2)*K2), */
