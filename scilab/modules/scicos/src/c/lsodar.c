...
extern void C2F(lsodar) (LSRhsFn *f, int *neq, realtype *y, realtype *t, realtype *tout, int *itol, realtype *reltol, realtype *abstol, int *itask, int *istate, int *iopt, realtype *rwork, int *lrw, int *iwork, int *liw,  int *jacobian, int *jacType, LSRootFn *grblk, int *ng, int *jroot);
