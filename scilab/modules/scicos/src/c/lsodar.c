...
extern void C2F(lsodar) (LSRhsFnLSodar *f, int *neq, realtype *y, realtype *t, realtype *tout, int *itol, realtype *reltol, realtype *abstol, int *itask, int *istate, int *iopt, realtype *rwork, int *lrw, int *iwork, int *liw,  int *Jac, int *Jactype, LSRootFnLSodar *grblk, int *ng, int *jroot);
...
int LSodarMalloc (void * lsodar_mem, LSRhsFnLSodar f, realtype t0, N_Vector y, int itol, realtype reltol, void * abstol)
{
...
int LSodarReInit (void * lsodar_mem, LSRhsFnLSodar f, realtype tOld, N_Vector y, int itol, realtype reltol, void * abstol)
{
    LSodarMem ls_mem = NULL;
    if (lsodar_mem == NULL)
    {
...
int LSodarRootInit (void * lsodar_mem, int ng, LSRootFnLSodar g, void *gdata)
{
    LSodarMem ls_mem = NULL;
    if (lsodar_mem == NULL)
    {
