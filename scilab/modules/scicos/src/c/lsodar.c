...
extern void C2F(lsodar) (LSRhsFnLSodar *f, int *neq, realtype *y, realtype *t, realtype *tout, int *itol, realtype *reltol, realtype *abstol, int *itask, int *istate, int *iopt, realtype *rwork, int *lrw, int *iwork, int *liw,  int *jacobian, int *jacType, LSRootFnLSodar *grblk, int *ng, int *jroot);
