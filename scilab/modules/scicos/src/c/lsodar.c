...
int LSodar (void * cvode_mem, int *neq, N_Vector y, realtype t, realtype tout, int itask, int * jroot)
{
...
void LSProcessError(LSodarMem cvode_mem,
...
void LSErrHandler(int error_code, const char *module,
