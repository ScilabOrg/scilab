...
void * LSodarCreate (CVRhsFnLSodar f, int *neq, N_Vector y, int itol, realtype reltol, realtype abstol, CVRootFnLSodar gfun, int ng, int *jroot)
{
    LSodarMem cvode_mem;
    cvode_mem = NULL;
    ...
    C2F(lsodar) (cvode_mem->func, cvode_mem->nEquations, cvode_mem->yVector, &(cvode_mem->tStart), &cvode_mem->tEnd, &cvode_mem->iTol, &cvode_mem->relTol, &cvode_mem->absTol, &itask, &(cvode_mem->iState), &cvode_mem->iOpt, cvode_mem->rWork, &cvode_mem->Lrw, cvode_mem->iWork, &cvode_mem->Liw, &cvode_mem->Jac, &cvode_mem->Jactype, cvode_mem->g_fun, &cvode_mem->ng_fun, cvode_mem->jRoot);
...
int LSodar (void * cvode_mem, realtype tOut, N_Vector y, realtype * tOld, int itask, int * neq)
{
    LSodarMem cv_mem;
 ...
 * =============================
 *
 * Update rootsfound to the computed joots
 */

int LSodarGetRootInfo(LSodarMem cvode_mem, int * rootsfound)
{
    LSodarMem cv_mem;
    int i;
