...
typedef int (*LSRhsFnLSodar) (int * neq, realtype * t, realtype * y, realtype * rwork);
typedef int (*LSRootFnLSodar) (int * neq, realtype * t, realtype * y, int * ng, realtype * rwork);
...
// Specifying the time beyond which the integration is not to proceed
int lsodarSetStopTime (LSodarMem lsodar_mem, realtype itstop);
