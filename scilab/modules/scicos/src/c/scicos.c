    ...
    if (*neq > 0) /* Unfortunately CVODE does not work with NEQ==0 */
    {
        ...
        switch (C2F(cmsolver).solver)
        {
            ...
            case 3:
                ...
                break;
            case 4:
				//cvode_mem = RKCreate(CV_FUNCTIONAL); /* Create the Runge-Kutta problem */
                cvode_mem = CVodeCreate(CV_RK, CV_FUNCTIONAL); /* Create the Runge-Kutta problem */
        }
