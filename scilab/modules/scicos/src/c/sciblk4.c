            ...
            if (Blocks[0].noz != 0)
            {
                ...
                if ((funtyp[kfun - 1] == 4) || (funtyp[kfun - 1] == 10004))
                {
                    for (j = 0; j < Blocks[0].noz; j++)
                    {
                        ...
                        {
                            ne1 = Blocks[0].ozsz[j];
                            C2F(unsfdcopy) (&ne1, (double *)il_ozptr, (i = 1, &i), (double *)Blocks[0].ozptr[j], (k = 1, &k));
                        }
                        else
                        {
                ...
                {
                    ne1 = Blocks[0].ozsz[0];
                    C2F(unsfdcopy) (&ne1, (double *)il_oz, (i = 1, &i), (double *)Blocks[0].ozptr[0], (j = 1, &j));
                }
            }
  ...
  *****************************************/
    ...
    case 8:
        {                       /*check type of int matrix */
            if ((sub_typ != 1) & (sub_typ != 2) & (sub_typ != 4) / (sub_typ != 11) & (sub_typ != 12) & (sub_typ != 14))
            {
                err = 1003;
                return err;
            }
