    ...
    if (Block->noz != 0)
    {
        ...
        for (i = 0; i < Block->noz; i++)
        {
            ...
            case 10:
                ...
                memcpy((double *)Block->ozptr[i], (double *)(&ilh2[4]), mh2 * nh2 * sizeof(double));
                break;
            ...
            case 11:
                ...
                memcpy((double *)Block->ozptr[i], (double *)(&ilh2[4]), 2 * mh2 * nh2 * sizeof(double));
                break;
            ...
            case 84:
                ...
                memcpy((long *)Block->ozptr[i], (long *)(&ilh2[4]), mh2 * nh2 * sizeof(long));
                break;
            ...
            case 82:
                ...
                memcpy((short *)Block->ozptr[i], (short *)(&ilh2[4]), mh2 * nh2 * sizeof(short));
                break;
            ...
            case 81:
                ...
                memcpy((char *)Block->ozptr[i], (char *)(&ilh2[4]), mh2 * nh2 * sizeof(char));
                break;
            ...
            case 814:
                ...
                memcpy((unsigned long *)Block->ozptr[i], (unsigned long *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned long));
                break;
            ...
            case 812:
                ...
                memcpy((unsigned short *)Block->ozptr[i], (unsigned short *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned short));
                break;
            ...
            case 811:
                ...
                memcpy((unsigned char *)Block->ozptr[i], (unsigned char *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned char));
                break;
            }
        }
    }
    ...
    if (Block->nin != 0)
    {
        ...
        for (i = 0; i < Block->nin; i++)
        {
            ...
            case 10:
                ...
                memcpy((double *)Block->inptr[i], (double *)(&ilh2[4]), mh2 * nh2 * sizeof(double));
                break;
            ...
            case 11:
                ...
                memcpy((double *)Block->inptr[i], (double *)(&ilh2[4]), 2 * mh2 * nh2 * sizeof(double));
                break;
            ...
            case 84:
                ...
                memcpy((long *)Block->inptr[i], (long *)(&ilh2[4]), mh2 * nh2 * sizeof(long));
                break;
            ...
            case 82:
                ...
                memcpy((short *)Block->inptr[i], (short *)(&ilh2[4]), mh2 * nh2 * sizeof(short));
                break;
            ...
            case 81:
                ...
                memcpy((char *)Block->inptr[i], (char *)(&ilh2[4]), mh2 * nh2 * sizeof(char));
                break;
            ...
            case 814:
                ...
                memcpy((unsigned long *)Block->inptr[i], (unsigned long *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned long));
                break;
            ...
            case 812:
                ...
                memcpy((unsigned short *)Block->inptr[i], (unsigned short *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned short));
                break;
            ...
            case 811:
                ...
                memcpy((unsigned char *)Block->inptr[i], (unsigned char *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned char));
                break;
            }
        }
    }
    ...
    if (Block->nout != 0)
    {
        ...
        for (i = 0; i < Block->nout; i++)
        {
            ...
            case 10:
                ...
                memcpy((double *)Block->outptr[i], (double *)(&ilh2[4]), mh2 * nh2 * sizeof(double));
                break;
            ...
            case 11:
                ...
                memcpy((double *)Block->outptr[i], (double *)(&ilh2[4]), 2 * mh2 * nh2 * sizeof(double));
                break;
            ...
            case 84:
                ...
                memcpy((long *)Block->outptr[i], (long *)(&ilh2[4]), mh2 * nh2 * sizeof(long));
                break;
            ...
            case 82:
                ...
                memcpy((short *)Block->outptr[i], (short *)(&ilh2[4]), mh2 * nh2 * sizeof(short));
                break;
            ...
            case 81:
                ...
                memcpy((char *)Block->outptr[i], (char *)(&ilh2[4]), mh2 * nh2 * sizeof(char));
                break;
            ...
            case 814:
                ...
                memcpy((unsigned long *)Block->outptr[i], (unsigned long *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned long));
                break;
            ...
            case 812:
                ...
                memcpy((unsigned short *)Block->outptr[i], (unsigned short *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned short));
                break;
            ...
            case 811:
                ...
                memcpy((unsigned char *)Block->outptr[i], (unsigned char *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned char));
                break;
            }
        }
    }
    ...
    if (Block->nopar != 0)
    {
        ...
        for (i = 0; i < Block->nopar; i++)
        {
            ...
            case 10:
                ...
                memcpy((double *)Block->oparptr[i], (double *)(&ilh2[4]), mh2 * nh2 * sizeof(double));
                break;
            ...
            case 11:
                ...
                memcpy((double *)Block->oparptr[i], (double *)(&ilh2[4]), 2 * mh2 * nh2 * sizeof(double));
                break;
            ...
            case 84:
                ...
                memcpy((long *)Block->oparptr[i], (long *)(&ilh2[4]), mh2 * nh2 * sizeof(long));
                break;
            ...
            case 82:
                ...
                memcpy((short *)Block->oparptr[i], (short *)(&ilh2[4]), mh2 * nh2 * sizeof(short));
                break;
            ...
            case 81:
                ...
                memcpy((char *)Block->oparptr[i], (char *)(&ilh2[4]), mh2 * nh2 * sizeof(char));
                break;
            ...
            case 814:
                ...
                memcpy((unsigned long *)Block->oparptr[i], (unsigned long *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned long));
                break;
            ...
            case 812:
                ...
                memcpy((unsigned short *)Block->oparptr[i], (unsigned short *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned short));
                break;
            ...
            case 811:
                ...
                memcpy((unsigned char *)Block->oparptr[i], (unsigned char *)(&ilh2[4]), mh2 * nh2 * sizeof(unsigned char));
                break;
            }
        }
    }
