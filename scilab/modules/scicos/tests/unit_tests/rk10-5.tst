...
// Execute with exec("SCI/modules/xcos/tests/unit_tests/rk10-5.tst");
...
assert_checktrue(importXcosDiagram("SCI/modules/xcos/demos/ACrk10-5.zcos"));
...
assert_checktrue(importXcosDiagram("SCI/modules/xcos/demos/ACcv10-5.zcos"));
scs_m.props.context = ["n = "+string(i)+";" "K = "+string(j)+";" "tau = "+string(k)+";"];
xcos_simulate(scs_m, 4);
cvval = cv.values;
