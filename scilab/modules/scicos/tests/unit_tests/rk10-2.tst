...
// Execute with exec("SCI/modules/scicos/tests/unit_tests/rk10-2.tst");
//  or test_run('scicos', 'rk10-2', ['no_check_error_output']);
...
for j=1:10	 // n, order
 ...
 scs_m.props.tol(1) = 0.01; scs_m.props.tol(6) = 4;						// abstol + solver
