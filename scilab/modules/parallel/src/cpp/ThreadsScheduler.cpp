...
#pragma omp for private(i, exec) schedule(static, chunkSize)
    ...
    void ThreadsRunner::call(types::typed_list& passIn, types::typed_list& getOut, std::size_t i, ast::ExecVisitor& exec)
    {
#ifdef TRACE
#pragma omp critical
        ...
        getOut.clear();
        fun->call(passIn, nbRes, getOut, &exec);
        readSlices(i, getOut);
    }
