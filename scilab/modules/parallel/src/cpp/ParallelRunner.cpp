...
namespace parallel
{
    ...
    ParallelRunner* ParallelRunner::create(typed_list& args, std::size_t res, typed_list& o)
    {
        bool withThreads(true);
        return withThreads
            ? static_cast<ParallelRunner*>(new ThreadsRunner(args, res, o))
            : static_cast<ParallelRunner*>(new ProcessesRunner(args, res, o));
    }
