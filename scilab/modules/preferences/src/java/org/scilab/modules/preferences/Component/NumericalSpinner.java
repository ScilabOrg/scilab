 ...
 *
 */
public class NumericalSpinner extends JPanel implements XComponent, XChooser, ChangeListener {
    ...
    public final String length() {
        return Integer.toString(((JSpinner.DefaultEditor) spinner.getEditor()).getTextField().getColumns());
    }
    ...
    public final void length(String length) {
        if (!length.equals(XCommonManager.NAV) && !length.equals("")) {
            try {
                ((JSpinner.DefaultEditor) spinner.getEditor()).getTextField().setColumns(Integer.parseInt(length));
