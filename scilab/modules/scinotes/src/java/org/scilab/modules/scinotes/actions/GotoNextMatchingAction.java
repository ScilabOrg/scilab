...
/**
 * GotoNextMatchingAction Class
 * @author Calixte DENIZET
 */
public final class GotoNextMatchingAction extends DefaultAction {
     ...
     */
    public GotoNextMatchingAction(String name, SciNotes editor) {
        super(name, editor);
    }
    ...
    public static MenuItem createMenu(String label, final SciNotes editor, KeyStroke key) {
        return createMenu(label, null, new GotoNextMatchingAction(label, editor), key);
    }
}
