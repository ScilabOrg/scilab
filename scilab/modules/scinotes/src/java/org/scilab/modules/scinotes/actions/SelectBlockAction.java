...
public final class SelectBlockAction extends DefaultAction {
    ...
    public void doAction() {
        ...
        KeywordEvent event = sep.getKeywordEvent(false);
        ...
        if (mpos == null) {
            ...
            event = sep.getKeywordEvent(true);
            tok = event.getType();
            if (ScilabLexerConstants.isMatchable(tok)) {
    ...
    public static MenuItem createMenu(String label, final SciNotes editor, KeyStroke key) {
        ...
        ((JMenuItem) menuitem.getAsSimpleMenuItem()).addPropertyChangeListener(new PropertyChangeListener() {
                public void propertyChange(PropertyChangeEvent e) {
                    ...
                    boolean block = ScilabLexerConstants.isMatchable(sep.getKeywordEvent(false).getType());
                    block = block || ScilabLexerConstants.isMatchable(sep.getKeywordEvent(true).getType());
