...
public class SciNotesMessages {
    ...
    public static final String NO_EXISTING_DIR = Messages.gettext("The directory %s does not exits. Create it ?");
    public static final String UNABLE_TO_CREATE_DIR = Messages.gettext("The directory %s cannot be created. Check the permissions.");
    public static final String NOT_WRITABLE_DIR = Messages.gettext("Impossible to write a file in %s. Check the permissions.");
