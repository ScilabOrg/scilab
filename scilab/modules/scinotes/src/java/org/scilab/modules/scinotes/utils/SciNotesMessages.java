...
public class SciNotesMessages {
    ...
    public static final String POSFUN_IN_DOC = Messages.gettext("Cursor in function %s at line %s and column %s.");
    public static final String POS_IN_DOC = Messages.gettext("Cursor at line %s and column %s.");
