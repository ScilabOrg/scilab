        ...
        <Title text="_(Filename)">
            ...
            <Grid>
               ...
               text="{@append-with}">
                ...
                <Radiobutton value="{@append-filename}" expected-value="false" listener="ActionListener" text="_(Replace extension with: )" gridx="1" gridy="2" fill="none" weightx="0" anchor="west" enable="{@enable}">
