...
r = completion(SCI+'/t');
assert_checkequal(r, ['thirdparty\'; 'tools\']);
...
r = completion('ho');
assert_checkequal(r, ['home'; 'horizontalalignment'; 'horner'; 'host'; 'householder']);
...
assert_checkequal(r, ['horner'; 'householder']);
...
assert_checkequal(macros, ['horner'; 'householder']);
