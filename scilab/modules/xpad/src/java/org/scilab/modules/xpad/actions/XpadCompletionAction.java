 ...
 */
public final class XpadCompletionAction extends CompletionAction {
     ...
     */
    class XpadInputParsingManager extends SciInputParsingManager {
     ...
     */
    class XpadCompletionConfiguration implements ConsoleConfiguration {

        private XpadInputParsingManager xipm = new XpadInputParsingManager();
        private SciCompletionManager scm = new SciCompletionManager();
        private XpadCompletionWindow cwi;
