                        ...
                        if (ScilabLexerConstants.isOpenable(kwe.getType())) {
                            try {
                                ...
                                if (pos != -1) {
                                    ...
                                    String tmpVar = "a46d43fa4w5z8512dc7dc2c3";
                                    InterpreterManagement.requestScilabExec(tmpVar + "=get_function_path('" + kw + "');if " + tmpVar +" ~=[] then editor(" + tmpVar + ");clear " + tmpVar + ";end");
                                }
                            } catch (BadLocationException e) { }
                        }
                    }
