...
if ~isdef("levitron_profile") then
...
if ~isdef("levitron_stop") then
    function levitron_stop()
        global Stop;Stop=%t
    endfunction
end

if ~isdef("levitron_reinit") then
...
if ~isdef("levitron_create_gui") then
...
if ~isdef("gui_createParamFrame") then
...
if ~isdef("gui_createButtonFrame") then
