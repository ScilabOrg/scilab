...
//    my_figure_handle.figure_name = gettext("Cylinder");
    ...
    //Setting up the GUI
    param_list = list(direction, slope, y,  x, speed, gravity);
...
>>>>>>> Stashed changes
    ...
    // =========================================================================
    y = y - (slider_height+y_margin)
    text_direction = uicontrol(my_figure_handle, ...
    "position", [x_text y text_width slider_height], ...
    "Style", "text", ...
    "String", "direction", ...
    "BackgroundColor", [1 1 1], ...
    ...
    slider_direction = uicontrol(my_figure_handle, ...
    "position", [x_slider y slider_width slider_height], ...
    "Style", "slider", ...
    "Min", 0, ...
    "Max", 100, ...
    "Value", g_Vdir, ...
    "callback", "change_directionection()", ...
    "tag", "slider_direction");

    value_direction = uicontrol(my_figure_handle, ...
    "position", [x_value y value_width slider_height], ...
    "Style", "text", ...
    ...
    unite_direction = uicontrol(my_figure_handle, ...
    "position", [x_unit y unit_width slider_height], ...
    "Style", "text", ...
    "String", "(deg)", ...
    "BackgroundColor", [1 1 1], ...
