...
double int3d_f(double*, int*, double*);
...
int bvode_gsub(int*, double*, double*);
int bvode_dgsub(int*, double*, double*);
int bvode_fsub(double*, double*, double*);
int bvode_dfsub(double*, double*, double*);
int bvode_guess(double*, double*, double*);
...
extern double C2F(lsodi)(impl_f_t, impl_g_t, impl_jac_t, int*, double*, double*, double*, double*, int*, double*, double*, int*, int*, int*, double*, int*, int*, int*, int*);

int impl_f(int*, double*, double*, double*, double*, int*);
int impl_g(int*, double*, double*, double*, double*, double*, int*);
int impl_jac(int*, double*, double*, double*, double*, double*, double*, int*);
...
int dassl_f(double*, double*, double*, double*, int*, double*, int*);
int dassl_jac(double*, double*, double*, double*, double*, double*, int*);
...
int dasrt_g(int*, double*, double*, int*, double*, double*, int*);
