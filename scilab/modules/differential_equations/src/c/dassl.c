...
extern void C2F(ddassl) (void *res, int *neq, double *t, double *y, double *yprime,
                         ...
                         int *idid, double *rwork, int *lrw, int *iwork, int *liw, double *rpar, int *ipar, void *jac);
...
void C2F(dassl) (void *res, int *neq, double *t, double *y, double *yprime, double *tout,
                 int *info, double *rtol, double *atol, int *idid, double *rwork, int *lrw, int *iwork, int *liw, double *rpar, int *ipar, void *jac)
{
    int itemp[12], i;
    ...
    C2F(ddassl) (res, neq, t, y, yprime, tout, itemp, rtol, atol, idid, rwork, lrw, iwork, liw, rpar, ipar, jac);
}
