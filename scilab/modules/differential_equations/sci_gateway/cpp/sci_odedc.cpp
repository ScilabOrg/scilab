...
// *** check type of input args and get it. ***
    ...
    sizeYc = pDblY0->getSize() - pDblNd->get(0);
    if(sizeYc < 0)
    {
...
// *** Initialization. ***
    ...
    if(iopt == 1)
    {
        mxordn = pDblOdeOptions->get(7);
        mxords = pDblOdeOptions->get(8);
    }
...
//             lmat   = (2*ml + mu + 1)*neq + 2 if jt = 4 or 5.
            ...
            jroot = (int*)malloc(pDblNg->get(0) * sizeof(int));
        }
        case 0 : // lsoda
        {
...
// *** Perform operation. ***
    ...
    if(bOneStep)
    {
        ...
        // Create result
        pDblYOut = new types::Double(pDblY0->getRows() + 1, pDblYOutList.size() * pDblY0->getCols());
        int iSizeList = pDblYOutList.size();
