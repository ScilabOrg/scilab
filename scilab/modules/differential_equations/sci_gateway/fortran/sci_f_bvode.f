...
C     .  bvode: ipar(1) : 0 => linear  1 => nonlinear
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 1",
     $ " of input argument ", err
         call error(116)
...
C         . compute max(m(j))
 ...
 12           continue
      ...
      if(istk(ilipar+1).lt.0 .or. istk(ilipar+1).gt.7) then
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 2",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
C     .  bvode: 0 < ipar(4) <= M
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 4",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
c               nsizef=4 + 3*M + (5+collpnt*N)*(collpnt*N+M) + (2*M-nrec)*2*M
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 5",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
c     .  bvode: ipar(6)>=nmax*nsizei where nsizei= 3 + collpnt*N + M.
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 6",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
c     .  bvode: ipar(7) output control
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 7",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
c     .  bvode: ipar(8)
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 8",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
c     .  bvode: ipar(9)
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 9",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
...
c     .  bvode: ipar(10)
         err=7
         write(BUFERR,'(A, A, I2)') "bvode: Bad value for element 10",
     $ " of input argument ", err
         call error(116)
         call basout(io, iout, BUFERR)
         return
