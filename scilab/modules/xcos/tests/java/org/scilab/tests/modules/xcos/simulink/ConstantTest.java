...
public class ConstantTest {
	...
	public void checkSimulationFunctionType() {
		...
		Assert.assertEquals( toVerify.getSimulationFunctionType() , SimulationFunctionType.C_OR_FORTRAN);
	}
	@Test
	...
	public void checkRealParameters() {
		...
		Assert.assertEquals( toVerify.getRealParameters() , new ScilabDouble(1));
	}
	@Test
