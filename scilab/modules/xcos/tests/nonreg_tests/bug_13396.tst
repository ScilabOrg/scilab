...
//
// <-- Short Description -->
// MBLOCK didn't work with an external file containing the modelica class
//
...
scs_m.objs(9).graphics.exprs(9) = TMPDIR + "/bug_13396.mo";
scs_m.objs(9).model.sim(1) = TMPDIR + "/bug_13396.mo";
MBLOCK("set", scs_m.objs(9));
// compile the diagram
