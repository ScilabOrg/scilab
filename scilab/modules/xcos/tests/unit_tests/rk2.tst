...
// Execute with exec("SCI/modules/xcos/tests/unit_tests/rk2.tst");

// RK + sauvegarde
assert_checktrue(importXcosDiagram("SCI/modules/xcos/demos/Aordre2rk.zcos"));
xcos_simulate(scs_m, 4);
rkval = y.values;
time = y.time;

// CVode + sauvegarde
assert_checktrue(importXcosDiagram("SCI/modules/xcos/demos/Aordre2cv.zcos"));
xcos_simulate(scs_m, 4);
cvval = y.values;
