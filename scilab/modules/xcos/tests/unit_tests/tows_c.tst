...
E_cpy_ref = int32(100*ones(128, 2));  // E_cpy_ref = [100, 100] with 128 rows
E_cpy_ref(:, 2) = 2*E_cpy_ref(:, 2);  // E_cpy_ref = [100, 200] with 128 rows
...
assert_checktrue(E_cpy.values == E_cpy_ref);         // Check that E_cpy contains an int32 vector
