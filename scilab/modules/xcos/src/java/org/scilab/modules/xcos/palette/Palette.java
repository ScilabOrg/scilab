...
public final class Palette {
     ...
     */
    @ScilabExported(module = XCOS, filename = PALETTE_GIWS_XML)
    public static void generateAllIcons(final String iconPath) throws Exception {
        /*
    ...
    public static void generateAllImages(final String[] path) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                if (src == null) {
                    throw new RuntimeException(String.format(WRONG_INPUT_ARGUMENT_S_INVALID_TREE_PATH, "path"));
                }
