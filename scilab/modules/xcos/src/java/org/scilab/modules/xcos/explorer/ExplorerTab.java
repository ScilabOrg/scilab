...
/**
 * Tab of the Xcos Explorer
 */
public class ExplorerTab extends SwingScilabDockablePanel implements SimpleTab {
     ...
     */
    public ExplorerTab(BrowserView view, String uuid) {
    ...
    public static void restore(BrowserView view, String uuid) {
        if (uuid == null) {
            uuid = UUID.randomUUID().toString();
        }

        ExplorerTab tab = new ExplorerTab(view, uuid);
    ...
    static private class UpdateEditorContentListener implements TreeSelectionListener {
        ...
        public void valueChanged(TreeSelectionEvent e) {
            ...
            ExplorerTreeNodeData node = (ExplorerTreeNodeData) ((DefaultMutableTreeNode) p.getLastPathComponent()).getUserObject();
    ...
    private void initComponents() {
        ...
        JSplitPane pane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, tree, new JScrollPane(editor));
        setContentPane(pane);
    }
