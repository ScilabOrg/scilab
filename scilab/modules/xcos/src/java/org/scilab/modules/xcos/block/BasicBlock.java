...
public class BasicBlock extends ScilabGraphUniqueObject implements Serializable {
    ...
    public ScilabType getExprs() {
        ...
        return new ScilabString("1"); // Stub
    }
        ...
        try {
            ...
            final ActionListener action = new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    try {
                        final BasicBlock modifiedBlock = handler.readBlock(BasicBlock.this);
    ...
    public boolean getFlip() {
        ...
        return (angle.get(0) == 0 ? true : false);
    }
