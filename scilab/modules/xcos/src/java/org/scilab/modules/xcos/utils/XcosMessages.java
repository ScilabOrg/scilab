...
public final class XcosMessages {
    ...
    public static final String SAVE_AS_INTERFACE_FUNCTION = Messages
            .gettext("Save as interface function") + DOTS;
    ...
    public static final String BLOCK_PARAMETERS = Messages
            .gettext("Block Parameters") + DOTS;
    public static final String REGION_TO_SUPERBLOCK = Messages
            .gettext("Region to superblock");
    public static final String SUPERBLOCK_MASK = Messages
            .gettext("Superblock mask");
    ...
    public static final String SAVE_BLOCK_GUI = Messages
            .gettext("Save block GUI");

    /* Palette menu in palette browser */
    public static final String LOAD_AS_PAL = Messages
            .gettext("Load as palette") + DOTS;
    ...
    public static final String CREATE_CATEGORY = Messages
            .gettext("Create a category");
    public static final String ADDTO_CATEGORY = Messages
            .gettext("Add to a new category");
    public static final String DEFAULT_CATEGORY_NAME = Messages
            .gettext("Category");

    public static final String DUMP = Messages.gettext("Dump");
    public static final String VIEW_IN_SCICOS = Messages
            .gettext("View in Scicos");

    /* View Menu */
    public static final String VIEW = Messages.gettext("View");
    public static final String FIT_DIAGRAM_TO_VIEW = Messages
            .gettext("Fit diagram to view");
    public static final String NORMAL_100 = Messages.gettext("Normal 100%");
    public static final String PALETTE_BROWSER = Messages
            .gettext("Palette browser");
    public static final String DIAGRAM_BROWSER = Messages
            .gettext("Diagram browser");
    ...
    public static final String SHOW_PARENT = Messages
            .gettext("Show parent diagram");
    ...
    public static final String SHOWHIDE_SHADOW = Messages
            .gettext("Show/Hide shadow");
    public static final String GRID = Messages.gettext("Grid");
    public static final String DIAGRAM_BACKGROUND = Messages
            .gettext("Diagram background") + DOTS;
    ...
    public static final String TEXT_SETTINGS = Messages
    ...
    public static final String CODE_GENERATION = Messages
            .gettext("Code generation");

    /* Help menu */
    public static final String HELP = Messages.gettext("?");
    public static final String XCOS_DOCUMENTATION = Messages
            .gettext("Xcos Help");
    public static final String BLOCK_DOCUMENTATION = Messages
            .gettext("Block Help");
    ...
    public static final String CONTINUOUS_PAL = Messages
            .gettext("Continuous time systems");
    public static final String IMPLICIT_PAL = Messages.gettext("Implicit");
    public static final String DISCONTINUOUS_PAL = Messages
            .gettext("Discontinuities");
    public static final String LOOKUPTABLES_PAL = Messages
            .gettext("Lookup Tables");
    public static final String SIGNALPROCESSING_PAL = Messages
            .gettext("Signal Processing");
    public static final String THRESHOLD_PAL = Messages
            .gettext("Zero crossing detection");
    public static final String MATHSOPS_PAL = Messages
            .gettext("Mathematical Operations");
    ...
    public static final String PORTACTION_PAL = Messages
            .gettext("Port & Subsystem");
    public static final String ANNOTATIONS_PAL = Messages
            .gettext("Annotations");
    public static final String DISCRETE_PAL = Messages
            .gettext("Discrete time systems");
    public static final String EVENTS_PAL = Messages.gettext("Event handling");
    public static final String SIGNALROUTING_PAL = Messages
            .gettext("Signal Routing");
    public static final String COMMONUSED_PAL = Messages
            .gettext("Commonly Used Blocks");
    public static final String USERDEFINEDFUNCTIONS_PAL = Messages
            .gettext("User-Defined Functions");
    public static final String DEMOBLOCKS_PAL = Messages
            .gettext("Demonstrations Blocks");
    public static final String ELECTRICAL_PAL = Messages.gettext("Electrical");
    public static final String THERMOHYDRAULICS_PAL = Messages
            .gettext("Thermo-Hydraulics");
    ...
    public static final String DIAGRAM_MODIFIED = Messages
    ...
    public static final String FAIL_LOADING_DIAGRAM = Messages
            .gettext("Failed to load Diagram");
    public static final String FAIL_SAVING_DIAGRAM = Messages
            .gettext("Could not save diagram.");
    public static final String OVERWRITE_EXISTING_FILE = Messages
            .gettext("Do you want to overwrite existing file?");
    public static final String TRANSPARENT_BACKGROUND = Messages
            .gettext("Do you want a transparent background image?");
    public static final String NO_IMAGE_DATA = Messages
            .gettext("Image contains no data.");
    public static final String UNKNOW_VERSION = Messages
            .gettext("Unknown Diagram Version : ");
    public static final String TRY_TO_CONTINUE = Messages
            .gettext("Will try to continue...");

    public static final String XCOS_ERROR = Messages.gettext("Xcos error");
    public static final String UNABLE_TO_DELETE = Messages
    ...
    public static final String ADDTO_NEW_DIAGRAM = Messages
            .gettext("Add to new diagram");

    public static final String LINK_ERROR_EXPLICIT_IN = Messages
            .gettext("Explicit data input port must be connected to explicit data output port");
    public static final String LINK_ERROR_IMPLICIT_IN = Messages
            .gettext("Implicit data input port must be connected to implicit data output port");
    public static final String LINK_ERROR_EXPLICIT_OUT = Messages
            .gettext("Explicit data output port must be connected to explicit data input port");
    public static final String LINK_ERROR_IMPLICIT_OUT = Messages
            .gettext("Implicit data output port must be connected to implicit data input port");
    public static final String LINK_ERROR_EVENT_IN = Messages
            .gettext("Command port must be connected to control port");
    public static final String LINK_ERROR_EVENT_OUT = Messages
            .gettext("control port must be connected to command port");
    public static final String LINK_ERROR_ALREADY_CONNECTED = Messages
            .gettext("Port is already connected, please select an unconnected port or a valid link.");
    ...
    public static final String LINK_STYLE_STRAIGHT = Messages
            .gettext("Straight");
    public static final String LINK_STYLE_HORIZONTAL = Messages
            .gettext("Horizontal");
    public static final String LINK_STYLE_VERTICAL = Messages
            .gettext("Vertical");
    ...
    public static final String FINAL_INTEGRATION_TIME = Messages
            .gettext("Final integration time");
    public static final String REAL_TIME_SCALING = Messages
            .gettext("Real time scaling");
    public static final String INTEGRATOR_ABSOLUTE_TOLERANCE = Messages
            .gettext("Integrator absolute tolerance");
    public static final String INTEGRATOR_RELATIVE_TOLERANCE = Messages
            .gettext("Integrator relative tolerance");
    public static final String TOLERANCE_ON_TIME = Messages
            .gettext("Tolerance on time");
    public static final String MAX_INTEGRATION_TIME_INTERVAL = Messages
            .gettext("Max integration time interval");
    public static final String SOLVER_CHOICE = Messages
            .gettext("Solver 0 (CVODE) - 100 (IDA)");
    public static final String CVODE = Messages.gettext("CVODE");
    public static final String IDA = Messages.gettext("IDA");
    public static final String MAXIMUN_STEP_SIZE = Messages
            .gettext("maximum step size (0 means no limit)");
    ...
    public static final String LOADING_USER_DEFINE = Messages
            .gettext("Loading user defined palettes") + DOTS;
    public static final String GENERATING_C_CODE = Messages
    ...
    public static final String DEBUGLEVEL_0 = Messages
            .gettext("No trace nor debug printing");
    public static final String DEBUGLEVEL_1 = Messages
            .gettext("Light Simulation trace (Discrete and Continuous part switches)");
    public static final String DEBUGLEVEL_2 = Messages
            .gettext("Per block execution trace and Debug block calls");
    public static final String DEBUGLEVEL_3 = Messages
            .gettext("Debug block calls without trace");
    ...
    public static final String MASK_VARSETTINGS = Messages
            .gettext("Variable settings");
    public static final String MASK_DEFAULTVALUES = Messages
            .gettext("Default values");
    ...
    public static final String MASK_VARNAME = Messages
            .gettext("Variable names");
    public static final String MASK_VARDESC = Messages
            .gettext("Variable descriptions");
    ...
    public static final String MASK_DEFAULTWINDOWNAME = Messages
            .gettext("Set block parameters");
    ...
    public static final String ERR_CONFIG_INVALID = Messages
            .gettext("The user configuration file (xcos.xml) is invalid.<BR> Switching to the default one.");

    /* Modelica Compiler */
    public static final String INITIALIZING_MODELICA_COMPILER = Messages
            .gettext("Setting up Modelica Compiler.");
    public static final String INIT_MODELICA = Messages
            .gettext("Modelica initialize");
	...
	/* Compilation errors */
	public static final String LINK_NOT_CONNECTED = Messages.gettext("<html><body>Compilation error: link ignored because it is not connected. <br/>Please reconnect it.</body></html>");
