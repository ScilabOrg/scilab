...
public class XcosDiagramCodec extends ScilabGraphCodec {
	...
	private static final String SOME_BLOCKS_HAS_BEEN_REMOVED = Messages.gettext("Some blocks has been removed to ensure compatibility.");
	...
	private void showUpdateDialog() {
		ScilabModalDialog.show(null, new String[] {
				SOME_BLOCKS_HAS_BEEN_REMOVED, "", PLEASE_CHECK_THE_DIAGRAM },
