...
public abstract class XcosRouteUtils {
     ...
     */
    public final static double ALIGN_STRICT_ERROR = 1;
    ...
    public final static double SPLITBLOCK_AWAY_DISTANCE = 5;
     ...
     * @return
     */
    protected static mxPoint getCenterPoint(mxICell cell) {
        ...
        if (cell instanceof BasicPort) {
            ...
            if (parent instanceof SplitBlock) {
                ...
                double parentX = parentGeo.getX();
                double parentY = parentGeo.getY();
                point.setX(parentX + portX + portW / 2);
                point.setY(parentY + portY + portH / 2);
            }
