...
public class BasicBlockCodec extends XcosObjectCodec {
    ...
    public static void register() {
        try {
            ...
            Map<Class <? extends BasicBlock>, List<BlockInterFunction>> customBlocks = EnumSet.allOf(XcosCellFactory.BlockInterFunction.class).stream()
                    .collect(Collectors.groupingBy(XcosCellFactory.BlockInterFunction::getKlass));
