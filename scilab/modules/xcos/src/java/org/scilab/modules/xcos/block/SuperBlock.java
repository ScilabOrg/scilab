...
public final class SuperBlock extends BasicBlock {
     ...
     */
    private Hashtable<String, List<? extends mxICell>> extractContextBlocks(Map<IOBlocks, List<BasicBlock>> blocksMap)
    {
     ...
     * @return the hashtable
     */
    private Hashtable<String, List<? extends mxICell>> extractContextPorts(Map<IOBlocks, List<mxICell>> portsMap)
    {
    ...
    public void updateExportedPort() {
        ...
        Hashtable<String, List<? extends mxICell>> context_block = extractContextBlocks(blocksMap);
        // extracting ports from the superblock
        Hashtable<String, List<? extends mxICell>> context_port = extractContextPorts(portsMap);
