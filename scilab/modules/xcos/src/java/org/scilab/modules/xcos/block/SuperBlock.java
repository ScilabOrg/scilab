...
public final class SuperBlock extends BasicBlock {
     ...
     * 
     */
    private List <mxICell > orderingSort(final List <mxICell > ports) 
    {
     ...
     * 
     */
    private void fillBlockPortMap(Map<IOBlocks, List<BasicBlock>> blocksMap, Map<IOBlocks, List<mxICell>> portsMap, 
            Hashtable<String, List<? extends mxICell>> context_block, Map<String, List<? extends mxICell>> context_port)
    {
     ...
     * 
     */
    private void addingPorts(String key, Hashtable<String, List<? extends mxICell>> context_block, Map<String, List<? extends mxICell>> context_port)
    {
     ...
     * 
     */
    private void removingPorts(String key, Hashtable<String, List<? extends mxICell>> context_block, Map<String, List<? extends mxICell>> context_port)
    {
     ...
     * 
     */
    private void replacingPort(String key, Hashtable<String, List<? extends mxICell>> context_block, Map<String, List<? extends mxICell>> context_port)
    {
        // iterate on the superdiagram blocks
        for (mxICell cell : context_block.get(key))
        {
    ...
    public void updateExportedPort() {
        ...
        fillBlockPortMap(blocksMap, portsMap, context_block, context_port);
        ...
        for (String key : context_block.keySet())
        {
            ...
            {
                addingPorts(key, context_block, context_port);
            } else if (context_block.get(key).size() < context_port.get(key).size())
            {
                removingPorts(key, context_block, context_port);
            } else
            {
                removeDeadPorts(key, context_block, context_port);

                replacingPort(key, context_block, context_port);
            }
        }
