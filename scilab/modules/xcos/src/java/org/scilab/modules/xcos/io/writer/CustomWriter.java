...
public class CustomWriter extends ScilabWriter {
    ...
    private final VectorOfScicosID children;

    public CustomWriter(XcosWriter writer) {
        super(writer);

        children = new VectorOfScicosID();
    }
    ...
    public void write(long uid, Kind kind) throws XMLStreamException {
        ...
        switch (kind) {
            case DIAGRAM:
                ...
                writeDiagramAndSuperDiagramContent(uid, kind);
    ...
    private void writeDiagramAndSuperDiagramContent(long uid, Kind kind) throws XMLStreamException {
