...
public final class BlockElement extends AbstractElement<BasicBlock> {
    ...
    public BasicBlock decode(BasicBlock into) throws ScicosFormatException {
        ...
        /*
         * Apply the zoom factor to the dimensions of the model if needed (instantiation or update)
         */
        long[] parent = {0};
        controller.getObjectProperty(block.getID(), Kind.BLOCK, ObjectProperties.PARENT_DIAGRAM, parent);
        if (parent[0] == 0) {
