...
public class RoundBlock extends BasicBlock {
	...
	public RoundBlock(String interFunction) {
		...
		if (interFunction.equals("SUM_f")) {
			parameters.addPropertyChangeListener("integerParameters", SumPortLabelingListener.getInstance());
		} else if (interFunction.equals("PROD_f")) {
			parameters.addPropertyChangeListener("realParameters", ProdPortLabelingListener.getInstance());
		}
	}
