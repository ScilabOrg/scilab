...
public class ExplorerTreeNodeData {
    ...
    public boolean equals(Object obj) {
        ...
        ExplorerTreeNodeData other = (ExplorerTreeNodeData) obj;
        if (uid != other.uid) {
            return false;
        }
        return true;
