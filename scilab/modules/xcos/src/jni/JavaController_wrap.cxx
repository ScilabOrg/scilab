...
void SwigDirector_View::objectUnreferenced(ScicosID const &uid, kind_t kind) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    juid = (jlong)uid;
    jkind = (jint) kind;
    jenv->CallStaticVoidMethod(Swig::jclass_JavaControllerJNI, Swig::director_methids[2], swigjobj, juid, jkind);
    jthrowable swigerror = jenv->ExceptionOccurred();
    if (swigerror) {
      jenv->ExceptionClear();
      throw Swig::DirectorException(jenv, swigerror);
...
void SwigDirector_View::objectDeleted(ScicosID const &uid, kind_t kind) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    juid = (jlong)uid;
    jkind = (jint) kind;
    jenv->CallStaticVoidMethod(Swig::jclass_JavaControllerJNI, Swig::director_methids[3], swigjobj, juid, jkind);
    jthrowable swigerror = jenv->ExceptionOccurred();
    if (swigerror) {
      jenv->ExceptionClear();
      throw Swig::DirectorException(jenv, swigerror);
...
void SwigDirector_View::propertyUpdated(ScicosID const &uid, kind_t kind, object_properties_t property, update_status_t status) {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    ...
    jstatus = (jint) status;
    jenv->CallStaticVoidMethod(Swig::jclass_JavaControllerJNI, Swig::director_methids[4], swigjobj, juid, jkind, jproperty, jstatus);
    jthrowable swigerror = jenv->ExceptionOccurred();
    if (swigerror) {
      jenv->ExceptionClear();
      throw Swig::DirectorException(jenv, swigerror);
