...
// Run with exec("SCI/modules/xcos/examples/solvers/benchIPendulum.sce");

// Import the diagram, augment the ending time and store its compilation in Info()
loadScicos();
loadXcosLibs();
importXcosDiagram("SCI/modules/xcos/demos/Inverted_pendulum.xcos");
...
solverName = ["LSodar", "CVode BDF/Newton", "CVode BDF/Functional", "CVode Adams/Newton", "CVode Adams/Functional", "DOPRI5", "Explicit RK45", "Implicit RK45"];
