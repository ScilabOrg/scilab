...
#endif
/*--------------------------------------------------------------------------*/ 
static int commonFindLabel(void* pv_ctx, int * param_addr, char const * const label_to_find);
static int commonFindLabelPartial(void* pv_ctx, int * param_addr, char const * const label_to_find);
/*--------------------------------------------------------------------------*/ 
...
SciErr createPList(void* pv_ctx, int iVar, int ** param_addr, char ** label_names, int nb_params)
{
    ...
    if (label_list) 
    {
        freeArrayOfString(label_list, nb_params + 1);
    }
