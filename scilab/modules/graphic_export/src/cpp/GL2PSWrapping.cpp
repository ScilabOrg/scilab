...
int sci_gl2psBeginPage(const char *title, const char *producer,
                       ...
                       float colormap_b[], float colormap_a[], int nr, int ng, int nb, int buffersize, const char *filename)
{
...
int sci_gl2psTextOpt(const char *str, const char *fontname, short fontsize, int align, float angle)
{
...
/* undocumented */
int sci_gl2psDrawImageMap(int width, int height, float position[3], const char *imagemap)
{
