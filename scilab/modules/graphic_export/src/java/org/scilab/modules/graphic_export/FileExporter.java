...
public class FileExporter {
     ...
     */
    public static String fileExport(int figureIndex, String fileName, int fileType, int fileOrientation) {
        return fileExport(figureIndex, fileName, fileType, ExportBitmap.DEFAULTJPEGCOMPRESSION, fileOrientation);
    }
