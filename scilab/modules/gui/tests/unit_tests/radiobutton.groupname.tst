...
rb2 = uicontrol(f1, "style", "radiobutton", "string", "radiobutton 2", "position", [30 85 100 25], "groupname", "group1");
rb3 = uicontrol(f2, "style", "radiobutton", "string", "radiobutton 3", "position", [30 35 100 25], "groupname", "group1");
rb4 = uicontrol(f2, "style", "radiobutton", "string", "radiobutton 4", "position", [30 85 100 25], "groupname", "group1");
