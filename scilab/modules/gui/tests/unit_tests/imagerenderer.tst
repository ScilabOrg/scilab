...
// Unitary tests for Scilab Java imagerender
...
h = uicontrol("style", "imagerenderer", "/home/han/Desktop/puffin.png", "position", [0 0 300 300]);
set(h, "scale", [0.3 2]);
set(h, "shear", [0.1, 2]);
set(h, "rotate", [30]);
...
set(h, "string", "/home/han/Desktop/puffin.png");
