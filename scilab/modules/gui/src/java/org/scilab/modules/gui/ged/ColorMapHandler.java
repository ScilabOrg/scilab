...
public class ColorMapHandler {
    ...
    * @return scilabColor Index of the color map corresponding to the color selected by the user.
    */
    ...
    * @param green
    * @param blue
    * @return selectedColor Color in the new format.
    */
    private static Double[] rgbTOscilab(double red, double green, double blue) {
        Double[] selectedColor = new Double[3];
        selectedColor[0] = red / 255.0;
        selectedColor[1] = green / 255.0;
        selectedColor[2] = blue / 255.0;
    ...
    * @param greenSci
    * @param blueSci
    * @return rgbColor Color in the new format.
    */
    private static Double[] scilabTOrgb(Double redSci, Double greenSci, Double blueSci) {
        Double[] rgbColor = new Double[3];
        rgbColor[0] = redSci * 255.0;
        rgbColor[1] = greenSci * 255.0;
        rgbColor[2] = blueSci * 255.0;
        return rgbColor;
    }
    ...
    * @return newColorMap New color map with a color insert.
    */
    ...
    * @param figureID Enters the identification of Figure.
    * @param scilabColor Index of the color map corresponding to the color current.
    * @return scilabRGBcolor Color in RGB format converted to the color map of the scilab.
    */
    private static Double[] searchRGBcolor(String figureID, Integer scilabColor) {
        ...
        if (scilabColor < 1 || scilabColor > size) {
            ...
            scilabRGBcolor[2] = colormap[size+size+scilabColor-1];
        }
