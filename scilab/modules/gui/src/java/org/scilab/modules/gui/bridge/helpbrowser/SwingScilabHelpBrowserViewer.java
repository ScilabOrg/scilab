...
public class SwingScilabHelpBrowserViewer extends BasicContentViewerUI {
    ...
    public URL resolvScilabLink(HyperlinkEvent event) {
        ...
        if (subLocation.equals("help")) {
            ...
            execExample(event.getSourceElement().getParentElement().getParentElement().getParentElement().getElement(0));
        } else if (subLocation.equals("editexample")) {
            editExample(event.getSourceElement().getParentElement().getParentElement().getParentElement().getElement(0));
        }
