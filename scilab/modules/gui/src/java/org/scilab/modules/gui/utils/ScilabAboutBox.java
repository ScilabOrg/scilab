...
public class ScilabAboutBox {
     ...
     * @param ackTitle
     *            Title for acknowledgements button and window
     */
    public static void createAboutBox(final String aboutTitle, final String ackFile, final String ackTitle) {
        ...
        aboutBox.setContentPane(new AboutPanel(aboutBox, ackFile, ackTitle));
    ...
    private static final class AboutPanel extends javax.swing.JPanel {
        ...
        public AboutPanel(final JFrame parent, final String ackFile, final String ackTitle) {
            this.parent = parent;
        ...
        private void initComponents() {
            ...
            acknowledgements.setText(ackTitle);
