...
public class Style extends BaseProperties {
    ...
    protected static javax.swing.JLabel cBackColor;
    protected static javax.swing.JLabel cForeColor;
    ...
    protected static javax.swing.JDialog backcolorDialog;
    protected static javax.swing.JColorChooser chooserBack;
    protected static javax.swing.JColorChooser chooserFore;
    protected static javax.swing.JDialog forecolorDialog;
    protected static javax.swing.JButton okBack;
    protected static javax.swing.JButton okFore;
    ...
    */
    public void initPropertiesStyle(String objectID) {
        if (objectID != null) {
            ...
            cBackColor.setBackground(new java.awt.Color(rgbBackgroundColor[0].intValue(), rgbBackgroundColor[1].intValue(), rgbBackgroundColor[2].intValue()));
            ...
            Integer scilabForegroundColor = (Integer) GraphicController.getController()
                  .getProperty(currentcurve, GraphicObjectProperties.__GO_LINE_COLOR__);
            Double[] rgbForegroundColor = ColorMapHandler.getRGBcolor(parentFigure, scilabForegroundColor);
            cForeColor.setBackground(new java.awt.Color(rgbForegroundColor[0].intValue(), rgbForegroundColor[1].intValue(), rgbForegroundColor[2].intValue()));
