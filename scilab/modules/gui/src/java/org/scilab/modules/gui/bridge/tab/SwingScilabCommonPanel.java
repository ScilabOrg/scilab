...
public class SwingScilabCommonPanel {
    ...
    protected static void addMember(SwingScilabPanel component, SwingViewObject member) {
        ...
        System.err.println("[addMember] "+member.getClass().getCanonicalName()+" into "+component.getClass().getCanonicalName());
        System.err.println("[addMember] "+component.getWidgetPane().getClass().getCanonicalName());
        //System.err.println("[addMember] "+component.getWidgetPane().getLayout().getClass().getCanonicalName());
