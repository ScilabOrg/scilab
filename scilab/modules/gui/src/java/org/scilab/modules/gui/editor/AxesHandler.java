...
public class AxesHandler {
    ...
    */
    public static void copyAxesStyle(String axesFrom, String axesTo) {
        ...
        String figureFrom = (String)GraphicController.getController().getProperty(axesFrom, GraphicObjectProperties.__GO_PARENT__);
        ...
        String figureTo = (String)GraphicController.getController().getProperty(axesTo, GraphicObjectProperties.__GO_PARENT__);
