    ...
    public SwingScilabDockablePanel(String figureTitle, int figureId, final Figure figure) {
        ...
        addComponentListener(new ComponentListener() {
            ...
            public void componentResized(ComponentEvent arg0) {
                ...
                if (true /*isResizeListenerEnabled()*/) {
                    ...
                    System.out.println("Dokcable Commponent resize");
                    System.out.println("dock Height=" + getTitlebar().getSize().getHeight());
                    System.out.println("menu Height=" + ((SwingScilabMenuBar) getMenuBar().getAsSimpleMenuBar()).getSize().getHeight());
                    System.out.println("tool Height=" + ((SwingScilabToolBar) getToolBar().getAsSimpleToolBar()).getSize().getHeight());
                    System.out.println("info Height=" + ((SwingScilabTextBox) getInfoBar().getAsSimpleTextBox()).getSize().getHeight());
                    ...
                    System.out.println("END Dokcable Commponent resize");
                    System.out.println("");
                }
            }
        ...
        ClosingOperationsManager.registerClosingOperation(SwingScilabDockablePanel.this, new ClosingOperationsManager.ClosingOperation() {
            ...
            public int canClose() {
                ...
                if (!closeRequestFcn.equals("")) {
                    String closeCommand = "if exists(\"gcbo\") then %oldgcbo = gcbo; end;" + "gcbo = getcallbackobject(" + getId() + ");" + closeRequestFcn + ";fire_closing_finished();"
                                          + ";if exists(\"%oldgcbo\") then gcbo = %oldgcbo; else clear gcbo; end;";
