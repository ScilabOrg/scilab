        ...
        cLogFlagsX.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (check[0]) {
                    ...
                    String msg = "The data bounds from the axis X must be strictly positive to be changed to logarithmic scale.";
                    JOptionPane.showConfirmDialog(null, Messages.gettext(msg), Messages.gettext("Warning"), JOptionPane.DEFAULT_OPTION);
        ...
        cLogFlagsY.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (check[1]) {
                    ...
                    String msg = "The data bounds from the axis Y must be strictly positive to be changed to logarithmic scale.";
                    JOptionPane.showConfirmDialog(null, Messages.gettext(msg), Messages.gettext("Warning"), JOptionPane.DEFAULT_OPTION);
        ...
        cLogFlagsZ.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (check[2]) {
                    ...
                    String msg = "The data bounds from the axis Z must be strictly positive to be changed to logarithmic scale.";
                    JOptionPane.showConfirmDialog(null, Messages.gettext(msg), Messages.gettext("Warning"), JOptionPane.DEFAULT_OPTION);
