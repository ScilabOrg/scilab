...
public class ClippableContouredObject extends ContentLayout {
    private JComboBox cClipState = new JComboBox();
    private JTextField cClipBox = new JTextField();
    private JTextField cClipBoxUpper = new JTextField();
    private JTextField cClipBoxPoint = new JTextField();
    private JTextField cClipBoxWidth = new JTextField();
    private JTextField cClipBoxHeight = new JTextField();
