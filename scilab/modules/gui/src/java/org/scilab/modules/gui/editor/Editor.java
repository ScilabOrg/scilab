...
public class Editor {
	...
	*/
	public void init() {
		...
		copy = new JMenuItem(names[0]); 	copy.setToolTipText(hint[0]);
		cut = new JMenuItem(names[1]); 		cut.setToolTipText(hint[1]);
		paste = new JMenuItem(names[2]); 	paste.setToolTipText(hint[2]);
		delete = new JMenuItem(names[3]); 	delete.setToolTipText(hint[3]);
		clear = new JMenuItem(names[4]); 	clear.setToolTipText(hint[4]);
		hide = new JMenuItem(names[5]); 	hide.setToolTipText(hint[5]);
		unhide = new JMenuItem(names[6]); 	unhide.setToolTipText(hint[6]);
		clipboardCopy = new JMenuItem(names[7]); clipboardCopy.setToolTipText(hint[7]);
