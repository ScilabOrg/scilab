...
public class SciTranslator {
	...
	public static final int WINDOW_HIDDEN     = 1001;
	public static final int WINDOW_MOVED      = 1002;
	public static final int WINDOW_RESIZED    = 1003;
	public static final int WINDOW_SHOWN      = 1004;
