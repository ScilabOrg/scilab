...
slider_frame = uicontrol(f, "Position", [15 230 240 65], ...
"Style", "frame", ...
"Relief", "groove",...
...
slider_text = uicontrol(f, "Position", [20 240 230 20],...
"Style", "text",...
"FontSize", 11,...
"FontWeight", "bold",...
...
theslider = uicontrol(f, "Position", [20 270 230 15],...
"Style", "slider",...
"Min", 0,...
"Max", 100,...
"Value", 50,...
...
edit_frame = uicontrol(f, "Position", [15 85 240 110],...
"Style", "frame",...
"Relief", "groove",...
"BackgroundColor", [0.8 0.8 0.8]);
...
edit_edit = uicontrol(f, "Position", [20 160 230 25],...
"Style", "edit",...
"FontSize", 11,...
...
edit_button = uicontrol(f, "Position", [19 125 230 25], ...
"Style", "pushbutton",...
"FontSize", 11,...
"String", gettext("Add color in listbox"), ...
"callback", "act_color_in_list(1)");

edit_button_del = uicontrol(f, "Position", [19 95 230 25], ...
"Style", "pushbutton", ...
"FontSize", 11, ...
...
thelistbox = uicontrol(f, "Position", [270 85 165 220],...
"Style", "listbox",...
"FontSize", 11,...
