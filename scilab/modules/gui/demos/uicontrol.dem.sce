...
function act_selected_colors(flag)
    ...
    if isempty(indices) then
        ...
        messagebox(msg, gettext("Colors selection"), "info", "modal");
        return
    end
    if (flag==1) then
...
function reset_uicontrols_demo()
    findChildren = findobj("Tag", "popupmenu_demo");
    findChildren.value = [];
    findChildren = findobj("Tag", "demo_slider");
    findChildren.value = 50;
    slider_update();
    findChildren = findobj("Tag", "colors_edit");
    findChildren.string = gettext("<Enter color name here>");
    findChildren = findobj("Tag", "colors_listbox");
...
plot3d_menu = uimenu("Parent", graphics_menu, "Label", gettext("Launch plot3d"), "callback", "gcf();plot3d();");
...
// A popup menu
popup_demo = uicontrol(f, "Position", [15 330 200 20],...
"Style", "popupmenu",...
...
slider_frame = uicontrol(f, "Position", [15 230 200 65], ...
"Style", "frame", ...
"Relief", "groove",...
"BackgroundColor", [0.8 0.8 0.8])
slider_frame_title = uicontrol(f, "Position", [16 300 170 15],...
"Style", "text",...
"String", gettext("Slider demo"),...
"BackgroundColor", [0.9 0.9 0.9]);

slider_text = uicontrol(f, "Position", [20 240 190 20],...
"Style", "text",...
"FontSize", 11,...
"FontWeight", "bold",...
...
theslider = uicontrol(f, "Position", [20 270 190 15],...
"Style", "slider",...
"Min", 0,...
"Max", 100,...
"Value", 50,...
...
edit_frame = uicontrol(f, "Position", [15 85 200 110],...
"Style", "frame",...
"Relief", "groove",...
"BackgroundColor", [0.8 0.8 0.8]);
edit_frame_title = uicontrol(f, "Position", [16 200 170 15],...
"Style", "text",...
"String", gettext("Colors list edition"),...
"BackgroundColor", [0.9 0.9 0.9]);

edit_edit = uicontrol(f, "Position", [20 160 190 25],...
"Style", "edit",...
"FontSize", 11,...
...
edit_button = uicontrol(f, "Position", [19 125 145 25], ...
"Style", "pushbutton",...
"FontSize", 11,...
"String", gettext("Add color in listbox"), ...
"callback", "act_color_in_list(1)");

edit_button_del = uicontrol(f, "Position", [19 95 145 25], ...
"Style", "pushbutton", ...
"FontSize", 11, ...
...
thelistbox = uicontrol(f, "Position", [270 85 140 220],...
"Style", "listbox",...
"FontSize", 11,...
...
disp_button = uicontrol(f, "Position", [270 345 140 25],...
"Style", "pushbutton",...
"FontSize", 11,...
...
disp_button = uicontrol(f, "Position", [270 315 140 25],...
"Style", "pushbutton",...
"FontSize", 11,...
...
// Reset application
quit_button = uicontrol(f, "Position", [16 15 140 25],...
"Style", "pushbutton",...
...
// Exit application
quit_button = uicontrol(f, "Position", [270 15 140 25],...
"Style", "pushbutton",...
