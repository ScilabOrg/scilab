...
function usedeprecatedskin()
    ...
    f = figure("dockable", "off" ,"infobar_visible", "off", "toolbar_visible", "off", "menubar_visible", "off", "position", [200 200 240 430]);
    ...
    f = figure("dockable", "off" ,"infobar_visible", "off", "toolbar_visible", "off", "menubar_visible", "off", "position", [200 200 240 410]);
    fr1 = uicontrol("style", "frame", "position", [10 10 220 390], "border", createBorder("etched"));
    editbox = uicontrol(fr1, "style", "edit", "string", "Edit", "position", [10 350 200 30]);
    label = uicontrol(fr1, "style", "text", "string", "Text", "position", [10 310 200 30]);
    button = uicontrol(fr1, "style", "pushbutton", "string", "Pushbutton", "position", [10 270 200 30]);
    checkbox = uicontrol(fr1, "style", "checkbox", "string", "Checkbox", "position", [10 230 200 30]);
    radio = uicontrol(fr1, "style", "radiobutton", "string", "Radiobutton", "position", [10 190 200 30]);
