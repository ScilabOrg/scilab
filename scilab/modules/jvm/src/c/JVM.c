...
#include "ScilabSplashscreen.h"
#include "CountScilabConsole.h"
        ...
        else
        {
                ...
                else
                {
                        ...
                        */
                        ...
                        jvm_options = getJvmOptions(SCI_PATH,jvm_options_filename,&nOptions,&splashscreen);
...
#ifndef _MSC_VER
                                if (splashscreen && getScilabMode() == SCILAB_STD && !getNumberOfScilabConsole())
                                {
