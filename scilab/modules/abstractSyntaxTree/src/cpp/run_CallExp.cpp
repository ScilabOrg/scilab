...
/*
** Explicit definition of specialized functions.
*/

template void RunVisitorT<TimedVisitor>::visitprivate(const CallExp &e);
template void RunVisitorT<ExecVisitor>::visitprivate(const CallExp &e);

template void RunVisitorT<TimedVisitor>::visitprivate(const CellCallExp &e);
template void RunVisitorT<ExecVisitor>::visitprivate(const CellCallExp &e);
