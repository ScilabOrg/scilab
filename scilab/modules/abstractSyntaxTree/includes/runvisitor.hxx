...
namespace ast
{
    ...
    protected :
        ...
        //        {
        //            Bool *pB    = execMeArg.result_get()->getAs<types::Bool>();
        //            int *piB    = pB->get();
        ...
        //        {
        //            String* pS	= execMeArg.result_get()->getAs<types::String>();
        ...
        //                {
        //                    pdbl[j] =  pTL->getIndexFromString(pS->get(j));
        ...
        ** \{ */
        ...
        void visitprivate(const NotExp &e)
        {
            ...
            */
            ...
            {
                Bool *pb			= execMe.result_get()->getAs<types::Bool>();
