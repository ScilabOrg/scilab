...
public class ZoomInAction extends DefaultAction {
	...
	public ZoomInAction(ScilabGraph scilabGraph) {
		...
		final KeyStroke[] keystrokes = new KeyStroke[] {
				ScilabKeyStroke.getKeyStroke("OSSCKEY shift EQUALS"),
				KeyStroke.getKeyStroke(KeyEvent.VK_ADD, ACCELERATOR_KEY),
				KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, ACCELERATOR_KEY),
				KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, ACCELERATOR_KEY | KeyEvent.SHIFT_DOWN_MASK)
		};
