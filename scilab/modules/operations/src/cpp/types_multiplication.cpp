...
{
    Polynom* pPoly = new Polynom(_pPoly->getVariableName(), _pDouble->getDims(), _pDouble->getDimsArray());
    pPoly->setCoef(_pDouble);
    int iErr = DotMultiplyPolyByPoly(pPoly, _pPoly, _pPolyOut);
    delete pPoly;
    return iErr;
}
