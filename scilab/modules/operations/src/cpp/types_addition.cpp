...
static add_function pAddfunction[InternalType::IdLast][InternalType::IdLast] = {NULL};

add_function getAddFunction(InternalType::ScilabId leftId, InternalType::ScilabId rightId)
{
...
#define scilab_fill_add(id1, id2, func, typeIn1, typeIn2, typeOut) \
    pAddfunction[InternalType::Id ## id1][InternalType::Id ## id2] = (add_function)&add_##func<typeIn1, typeIn2, typeOut>
