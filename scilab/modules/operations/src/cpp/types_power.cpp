...
int PowerDoubleByDouble(Double const* _pDouble1, Double const* _pDouble2, Double** _pDoubleOut)
{
...
int PowerPolyByDouble(MatrixPoly const* _pPoly, Double const* _pDouble, MatrixPoly** _pPolyOut)
{
	return 0;
}
