...
EXTERN_OP int SubstractSparseToSparse(Sparse* _pSparse1, Sparse* _pSparse2, Sparse **_pSparseOut);
EXTERN_OP int SubstractSparseToDouble(Sparse* _pSparse, Double* _pDouble, Double **_pDoubleOut);
EXTERN_OP int SubstractDoubleToSparse(Double* _pDouble, Sparse* _pSparse, Double **_pDoubleOut);
