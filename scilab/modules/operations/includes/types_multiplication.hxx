...
EXTERN_OP int MultiplySparseBySparse(Sparse* _pSparse1, Sparse* _pSparse2, Sparse** _pSparseOut);
EXTERN_OP int MultiplyDoubleBySparse(Double* _pDouble, Sparse *_pSparse, Double** _pDoubleOut);
EXTERN_OP int MultiplySparseByDouble(Sparse *_pSparse, Double*_pDouble, Double** _pDoubleOut);
