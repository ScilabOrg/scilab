...
EXTERN_OP int AddDoubleToDouble(types::Double *_pDouble1, types::Double *_pDouble2, types::Double** _pDoubleOut);
EXTERN_OP int AddDoubleToPoly(types::Polynom *_pPoly, types::Double *_pDouble, types::Polynom ** _pPolyOut);
EXTERN_OP int AddPolyToPoly(types::Polynom* pPoly1, types::Polynom* _pPoly2, types::Polynom ** _pPolyOut);
EXTERN_OP int AddStringToString(types::String *_pString1, types::String *_pString2, types::String** _pStringOut);
