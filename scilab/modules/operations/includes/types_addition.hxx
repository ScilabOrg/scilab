...
EXTERN_OP int AddSparseToSparse(Sparse *_pSparse1, Sparse *_pSparse2, Sparse** _pSparseOut);
EXTERN_OP int AddSparseToDouble(Sparse *_pSparse,  Double* _pDouble, Double** _pDoubleOut);
EXTERN_OP int AddDoubleToSparse(Double* _pDouble, Sparse* _pSparse, Double** _pDoubleOut);
