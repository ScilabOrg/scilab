...
#define SWIGTYPE_p_CURLcode swig_types[2]
#define SWIGTYPE_p_CURLoption swig_types[3]
...
int _wrap_curl_easy_init(char *fname, unsigned long fname_len) {
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), SWIG_as_voidptr(result), SWIGTYPE_p_CURL, 0 |  0 )))) return SWIG_ERROR;
  return SWIG_OK;
}
...
int _wrap_curl_easy_setopt(char *fname, unsigned long fname_len) {
  ...
  SWIG_CheckOutputArgument(pvApiCtx, 1, 1);
  SWIG_Scilab_SetFname(fname);
  res1 = SwigScilabPtrToObject(pvApiCtx, 1, &argp1, SWIGTYPE_p_CURL, 0 |  0 , fname);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "curl_easy_setopt" "', argument " "1"" of type '" "CURL *""'"); 
  }
  arg1 = (CURL *)(argp1);
  {
    res2 = SwigScilabPtrToObject(pvApiCtx, 2, &argp2, SWIGTYPE_p_CURLoption,  0 , fname);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "curl_easy_setopt" "', argument " "2"" of type '" "CURLoption""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "curl_easy_setopt" "', argument " "2"" of type '" "CURLoption""'");
    } else {
      arg2 = *((CURLoption *)(argp2));
    }
  }
  result = curl_easy_setopt(arg1,arg2,arg3);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), (CURLcode *)memcpy((CURLcode *)malloc(sizeof(CURLcode)),&result,sizeof(CURLcode)), SWIGTYPE_p_CURLcode, SWIG_POINTER_OWN |  0 )))) return SWIG_ERROR;
  return SWIG_OK;
}
...
int _wrap_curl_easy_getinfo(char *fname, unsigned long fname_len) {
  ...
  arg1 = (CURL *)(argp1);
  {
    res2 = SwigScilabPtrToObject(pvApiCtx, 2, &argp2, SWIGTYPE_p_CURLINFO,  0 , fname);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "curl_easy_getinfo" "', argument " "2"" of type '" "CURLINFO""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "curl_easy_getinfo" "', argument " "2"" of type '" "CURLINFO""'");
    } else {
      arg2 = *((CURLINFO *)(argp2));
    }
  }
  result = curl_easy_getinfo(arg1,arg2,arg3);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), (CURLcode *)memcpy((CURLcode *)malloc(sizeof(CURLcode)),&result,sizeof(CURLcode)), SWIGTYPE_p_CURLcode, SWIG_POINTER_OWN |  0 )))) return SWIG_ERROR;
  return SWIG_OK;
}
...
int _wrap_curl_easy_recv(char *fname, unsigned long fname_len) {
  ...
  arg4 = (size_t *)(argp4);
  result = curl_easy_recv(arg1,arg2,arg3,arg4);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), (CURLcode *)memcpy((CURLcode *)malloc(sizeof(CURLcode)),&result,sizeof(CURLcode)), SWIGTYPE_p_CURLcode, SWIG_POINTER_OWN |  0 )))) return SWIG_ERROR;
  return SWIG_OK;
}
...
int _wrap_curl_easy_send(char *fname, unsigned long fname_len) {
  ...
  arg4 = (size_t *)(argp4);
  result = curl_easy_send(arg1,(void const *)arg2,arg3,arg4);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), (CURLcode *)memcpy((CURLcode *)malloc(sizeof(CURLcode)),&result,sizeof(CURLcode)), SWIGTYPE_p_CURLcode, SWIG_POINTER_OWN |  0 )))) return SWIG_ERROR;
  return SWIG_OK;
}
...
static swig_type_info _swigt__p_CURL = {"_p_CURL", "CURL *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_CURLINFO = {"_p_CURLINFO", "CURLINFO *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_CURLcode = {"_p_CURLcode", "CURLcode *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_CURLoption = {"_p_CURLoption", "CURLoption *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_CURL[] = {  {&_swigt__p_CURL, 0, 0, 0},{0, 0, 0, 0}};
