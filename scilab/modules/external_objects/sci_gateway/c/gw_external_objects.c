...
static gw_generic_table Tab[] =
{
    ...
    {sci_pyWrap, "pyWrap"},
    {sci_pyAllowModuleReloading, "pyAllowModuleReloading"},
    ...
    {sci_pyGetVar, "pyGetVar"},
    {sci_pyShowPrivate, "pyShowPrivate"},
    {sci_pyAttachModule, "pyAttachModule"},
    {sci_pyGetAttr, "pyGetAttr"},
    {sci_pyBuiltin, "pyBuiltin"},
    {sci_pyMain, "pyMain"},
    {sci_pyInvoke, "pyInvoke"},
    {sci_pyNpWrap, "pyNpWrap"}
};
