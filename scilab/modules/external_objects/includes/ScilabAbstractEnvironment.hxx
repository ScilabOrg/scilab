...
public:
    ...
    virtual void evalString(const char ** code, int nbLines) = 0;
     ...
     * @return the id of the corresponding object
     */
    virtual int loadclass(char * className, bool allowReload) = 0;
     ...
     * @return the id of the object returned by the method invocation
     */
