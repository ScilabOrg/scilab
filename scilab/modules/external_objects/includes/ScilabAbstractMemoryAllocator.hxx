...
protected:
    ...
    inline static long long * alloc(void * pvApiCtx, const int position, const int rows, const int cols, long long * ptr)
    {
        throw ScilabAbstractEnvironmentException("Invalid operation: cannot allocate a matrix of Integer64");
    }
    ...
    inline static unsigned long long * alloc(void * pvApiCtx, const int position, const int rows, const int cols, unsigned long long * ptr)
    {
        throw ScilabAbstractEnvironmentException("Invalid operation: cannot allocate a matrix of UInteger64");
    }
...
private:
    ...
    inline static void checkError(const SciErr & err)
    {
        if (err.iErr)
        {
            throw ScilabAbstractEnvironmentException("Cannot allocate memory");
        }
    }
...
public:
    ...
    T * allocate(const int rows, const int cols, T * dataPtr) const
    {
        if (!rows || !cols)
        {
...
public:
    ...
    int * allocate(const int rows, const int cols, T * dataPtr)
    {
        ...
        {
            throw ScilabAbstractEnvironmentException("Invalid operation: cannot allocate a matrix of Boolean");
        }
    }
};
