...
class ScilabPythonEnvironment : public ScilabAbstractEnvironment
{
    ...
    static bool usable;
    static std::map<std::string, int> mapModuleId;
    static std::map<int, std::string> mapIdModule;
...
public :
    ...
    ScilabPythonDirInvoker getDirInvoker()
    {
        return ScilabPythonDirInvoker(scope);
    }
    ...
    int loadclass(char * className, bool isNamedVarCreated, bool allowReload);
