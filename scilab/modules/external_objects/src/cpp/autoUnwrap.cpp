...
int ScilabGateway::autoUnwrap(char * fname, const int envId, void * pvApiCtx)
{
    SciErr sciErr;
    int * addr = 0;
    int val = 0;
    ...
    if (Rhs == 0)
    {
        createScalarBoolean(pvApiCtx, 1, (int)helper.getAutoUnwrap());
