...
api_return API_PROTO(getCellArray)(scilabEnv env, scilabVar var, scilabVar** vals);
api_return API_PROTO(setCellArray)(scilabEnv env, scilabVar var, scilabVar* vals);
#ifdef __cplusplus
}
#endif
#endif /* __CELL_API__ */
