...
#define scilab_setStructData2d      API_PROTO(setStructData2d)
    ...
    /*array*/
    scilabStatus API_PROTO(getStructArray)(scilabEnv env, scilabVar var, const wchar_t* field, scilabVar** vals);
    scilabStatus API_PROTO(setStructArray)(scilabEnv env, scilabVar var, const wchar_t* field, const scilabVar* vals);
    ...
    scilabStatus API_PROTO(setStructData)(scilabEnv env, scilabVar var, const wchar_t* field, const int* dims, const scilabVar data);
    scilabStatus API_PROTO(setStructData2d)(scilabEnv env, scilabVar var, const wchar_t* field, int row, int col, const scilabVar data);
