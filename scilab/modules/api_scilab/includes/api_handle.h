...
#define scilab_setHandle                API_PROTO(setHandle)
    ...
    api_return API_PROTO(getHandleArray)(scilabEnv env, scilabVar var, const long long** vals);
    api_return API_PROTO(getHandle)(scilabEnv env, scilabVar var, long long* vals);
    api_return API_PROTO(setHandleArray)(scilabEnv env, scilabVar var, const long long* vals);
    api_return API_PROTO(setHandle)(scilabEnv env, scilabVar var, long long vals);
#ifdef __cplusplus
}
#endif
