...
#define scilab_appendToList     API_PROTO(appendToList)
    ...
    int API_PROTO(setListItem)(scilabEnv env, scilabVar var, int pos, scilabVar val);
    ...
    int API_PROTO(setTListField)(scilabEnv env, scilabVar var, wchar_t* field, scilabVar val);
    int API_PROTO(setMListField)(scilabEnv env, scilabVar var, wchar_t* field, scilabVar val);

    int API_PROTO(appendToList)(scilabEnv env, scilabVar var, scilabVar val);
#ifdef __cplusplus
}
#endif
#endif /* __LIST_API__ */
