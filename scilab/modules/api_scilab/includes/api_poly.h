...
#define scilab_setComplexPolyArray  API_PROTO(setComplexPolyArray)
    ...
    api_return API_PROTO(setPolyArray)(scilabEnv env, scilabVar var, int index, int rank, const double* real);
    api_return API_PROTO(setComplexPolyArray)(scilabEnv env, scilabVar var, int index, int rank, const double* real, const double* img);
