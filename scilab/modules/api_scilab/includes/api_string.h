...
#define scilab_setString                API_PROTO(setString)
    ...
    api_return API_PROTO(getStringArray)(scilabEnv env, scilabVar var, wchar_t*** strs);
    api_return API_PROTO(getString)(scilabEnv env, scilabVar var, wchar_t** str);
    api_return API_PROTO(setStringArray)(scilabEnv env, scilabVar var, const wchar_t* const* strs);
    api_return API_PROTO(setString)(scilabEnv env, scilabVar var, const wchar_t* str);
