...
#define scilab_setUnsignedInteger64Array    API_PROTO(setUnsignedInteger64Array)
    ...
    int API_PROTO(getIntegerArray)(scilabEnv env, scilabVar var, void** vals);
    int API_PROTO(getInteger8Array)(scilabEnv env, scilabVar var, char** vals);
    int API_PROTO(getInteger16Array)(scilabEnv env, scilabVar var, short** vals);
    int API_PROTO(getInteger32Array)(scilabEnv env, scilabVar var, int** vals);
    int API_PROTO(getInteger64Array)(scilabEnv env, scilabVar var, long long** vals);
    int API_PROTO(getUnsignedInteger8Array)(scilabEnv env, scilabVar var, unsigned char** vals);
    int API_PROTO(getUnsignedInteger16Array)(scilabEnv env, scilabVar var, unsigned short** vals);
    int API_PROTO(getUnsignedInteger32Array)(scilabEnv env, scilabVar var, unsigned int** vals);
    int API_PROTO(getUnsignedInteger64Array)(scilabEnv env, scilabVar var, unsigned long long** vals);

    int API_PROTO(setIntegerArray)(scilabEnv env, scilabVar var, void* vals);
    int API_PROTO(setInteger8Array)(scilabEnv env, scilabVar var, char* vals);
    int API_PROTO(setInteger16Array)(scilabEnv env, scilabVar var, short* vals);
    int API_PROTO(setInteger32Array)(scilabEnv env, scilabVar var, int* vals);
    int API_PROTO(setInteger64Array)(scilabEnv env, scilabVar var, long long* vals);
    int API_PROTO(setUnsignedInteger8Array)(scilabEnv env, scilabVar var, unsigned char* vals);
    int API_PROTO(setUnsignedInteger16Array)(scilabEnv env, scilabVar var, unsigned short* vals);
    int API_PROTO(setUnsignedInteger32Array)(scilabEnv env, scilabVar var, unsigned int* vals);
    int API_PROTO(setUnsignedInteger64Array)(scilabEnv env, scilabVar var, unsigned long long* vals);
