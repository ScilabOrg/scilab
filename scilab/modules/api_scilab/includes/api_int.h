...
#define scilab_createIntegerMatrix8                 API_PROTO(createIntegerMatrix8)
#define scilab_createIntegerMatrix16                API_PROTO(createIntegerMatrix16)
#define scilab_createIntegerMatrix32                API_PROTO(createIntegerMatrix32)
#define scilab_createIntegerMatrix64                API_PROTO(createIntegerMatrix64)
#define scilab_createUnsignedIntegerMatrix8         API_PROTO(createUnsignedIntegerMatrix8)
#define scilab_createUnsignedIntegerMatrix16        API_PROTO(createUnsignedIntegerMatrix16)
#define scilab_createUnsignedIntegerMatrix32        API_PROTO(createUnsignedIntegerMatrix32)
#define scilab_createUnsignedIntegerMatrix64        API_PROTO(createUnsignedIntegerMatrix64)

#define scilab_createIntegerMatrix2d                API_PROTO(createIntegerMatrix2d)
#define scilab_createIntegerMatrix2d8               API_PROTO(createIntegerMatrix2d8)
#define scilab_createIntegerMatrix2d16              API_PROTO(createIntegerMatrix2d16)
#define scilab_createIntegerMatrix2d32              API_PROTO(createIntegerMatrix2d32)
#define scilab_createIntegerMatrix2d64              API_PROTO(createIntegerMatrix2d64)
#define scilab_createUnsignedIntegerMatrix2d8       API_PROTO(createUnsignedIntegerMatrix2d8)
#define scilab_createUnsignedIntegerMatrix2d16      API_PROTO(createUnsignedIntegerMatrix2d16)
#define scilab_createUnsignedIntegerMatrix2d32      API_PROTO(createUnsignedIntegerMatrix2d32)
#define scilab_createUnsignedIntegerMatrix2d64      API_PROTO(createUnsignedIntegerMatrix2d64)
