...
mkdir(pathconvert(TMPDIR+"/overload"));
cd(pathconvert(TMPDIR+"/overload"));
copyfile(SCI+"/modules/api_scilab/tests/nonreg_tests/bug_11046.c",pathconvert(TMPDIR+"/overload/bug_11046.c",%F));
