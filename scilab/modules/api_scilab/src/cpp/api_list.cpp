...
void pushNamedListAddress(std::string _stNamedList, int* _piAddr, int _iLast)
{
    ...
    {
        //char pstLog[1024];
        //sprintf_s(pstLog, 1024, "Add new list : %s(%d)\n", _stNamedList.c_str(), _piAddr[1]);
        //printf("%s", pstLog);
        //fflush(NULL);
        VectListInfo* pVect = new VectListInfo();
        pVect->push_back(new ListInfo(_piAddr, _iLast));
    ...
    {
        //for(int i = 0 ; i < (int)stackNamedListPosition[_stNamedList]->size(); i++)
        //{
        //    printf("%s", "    ");
        //}
        //printf("Add sub list : %x (%d)\n", _piAddr, _piAddr[1]);
        //fflush(NULL);
...
void popNamedListAddress(std::string _stNamedList)
{
    ...
    if(it != stackNamedListPosition.end())
    {
        ...
        //    printf("%s", "    ");
        //}
        //printf("Close Sub List: %x\n", it->second->back()->m_piAddr);
        //fflush(NULL);

        //printf("Last : %d\n", it->second->back()->m_iLast);
        delete it->second->back();
...
int* getLastNamedListAddress(std::string _stNamedList, int _iItemPos)
{
    StackNamedList::iterator it = stackNamedListPosition.find(_stNamedList);
    ...
    //    printf("%s", "    ");
    //}
    //printf("Add child (%i): %x\n", it->second->back()->m_piAddr[0], it->second->back()->m_piAddr);
    //fflush(NULL);
