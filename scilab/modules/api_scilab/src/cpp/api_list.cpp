...
static SciErr fillCommonSparseMatrixInList(void* _pvCtx, int _iVar, int* _piParent, int _iItemPos, int _iComplex, int _iRows, int _iCols, int _iNbItem, const int* _piNbItemRow, const int* _piColPos, const double* _pdblReal, const double* _pdblImg, int* _piTotalSize)
{
    ...
    sciErr = checkListItemPosition(_pvCtx, _piParent, _iItemPos, API_ERROR_FILL_SPARSE_IN_LIST, _iComplex ? "createComplexSparseMatrixInList" : "createComplexSparseMatrixInList");
    if (sciErr.iErr)
    {
        return sciErr;
    }
...
static SciErr createCommonSparseMatrixInList(void* _pvCtx, int _iVar, const char* _pstName, int* _piParent, int _iItemPos, int _iComplex, int _iRows, int _iCols, int _iNbItem, const int* _piNbItemRow, const int* _piColPos, const double* _pdblReal, const double* _pdblImg)
{
    ...
    if (_pstName == NULL)
    {
        funcName = _iComplex ? "createComplexSparseMatrixInList" : "createComplexSparseMatrixInList";
    }
    else
    {
        funcName = _iComplex ? "createComplexSparseMatrixInNamedList" : "createComplexSparseMatrixInNamedList";
    ...
    int piTotalSize = 0;
    sciErr = fillCommonSparseMatrixInList(_pvCtx, _iVar, (int*)pSparse, _iItemPos, _iComplex, _iRows, _iCols, _iNbItem, _piNbItemRow, _piColPos, _pdblReal, _pdblImg, &piTotalSize);
    if (sciErr.iErr)
    {
...
static SciErr fillBooleanSparseMatrixInList(void* _pvCtx, int _iVar, const char* _pstName, int* _piParent, int _iItemPos, int _iRows, int _iCols, int _iNbItem, const int* _piNbItemRow, const int* _piColPos)
{
    ...
    sciErr = checkListItemPosition(_pvCtx, _piParent, _iItemPos, API_ERROR_FILL_BOOLEAN_SPARSE_IN_LIST, "createBooleanSparseMatrixInList");
    if (sciErr.iErr)
    {
        return sciErr;
    }
...
SciErr createBooleanSparseMatrixInList(void* _pvCtx, int _iVar, int* _piParent, int _iItemPos, int _iRows, int _iCols, int _iNbItem, const int* _piNbItemRow, const int* _piColPos)
{
    ...
    sciErr = checkListItemPosition(_pvCtx, _piParent, _iItemPos, API_ERROR_CREATE_BOOLEAN_SPARSE_IN_LIST, "createBooleanSparseMatrixInList");
    if (sciErr.iErr)
    {
        return sciErr;
    }
    ...
    {
        addErrorMessage(&sciErr, API_ERROR_NO_MORE_MEMORY, _("%s: %ls"), "createBooleanSparseMatrixInList", se.GetErrorMessage().c_str());
        return sciErr;
    }

    if (pSparse == NULL)
    {
        addErrorMessage(&sciErr, API_ERROR_NO_MORE_MEMORY, _("%s: No more memory to allocate variable"), "createBooleanSparseMatrixInList");
        return sciErr;
    }

    sciErr = fillBooleanSparseMatrixInList(_pvCtx, _iVar, NULL, (int*)pSparse, _iItemPos, _iRows, _iCols, _iNbItem, _piNbItemRow, _piColPos);
    if (sciErr.iErr)
    {
...
SciErr createBooleanSparseMatrixInNamedList(void* _pvCtx, const char* _pstName, int* _piParent, int _iItemPos, int _iRows, int _iCols, int _iNbItem, const int* _piNbItemRow, const int* _piColPos)
{
    ...
    sciErr = checkListItemPosition(_pvCtx, _piParent, _iItemPos, API_ERROR_CREATE_BOOLEAN_SPARSE_IN_NAMED_LIST, "createBooleanSparseMatrixInNamedList");
    if (sciErr.iErr)
    {
        return sciErr;
    }
    ...
    {
        addErrorMessage(&sciErr, API_ERROR_NO_MORE_MEMORY, _("%s: %ls"), "createBooleanSparseMatrixInNamedList", se.GetErrorMessage().c_str());
        return sciErr;
    }

    if (pSparse == NULL)
    {
        addErrorMessage(&sciErr, API_ERROR_NO_MORE_MEMORY, _("%s: No more memory to allocate variable"), "createBooleanSparseMatrixInNamedList");
        return sciErr;
    }
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_CREATE_BOOLEAN_SPARSE_IN_NAMED_LIST, _("%s: Unable to create list item #%d in Scilab memory"), "createBooleanSparseMatrixInNamedList", _iItemPos + 1);
        return sciErr;
    }
