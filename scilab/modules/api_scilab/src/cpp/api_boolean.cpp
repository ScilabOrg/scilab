...
SciErr getMatrixOfBoolean(void *_pvCtx, int *_piAddress, int *_piRows, int *_piCols, int **_piBool)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_GET_BOOLEAN, _("%s: Unable to get argument #%d"), "getMatrixOfBoolean",
...
SciErr createNamedMatrixOfBoolean(void *_pvCtx, const char *_pstName, int _iRows, int _iCols, const int *_piBool)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_CREATE_NAMED_BOOLEAN, _("%s: Unable to create %s named \"%s\""), "createNamedMatrixOfBoolean",
                        _("matrix of boolean"), _pstName);
        return sciErr;
    }
...
int getScalarBoolean(void *_pvCtx, int *_piAddress, int *_piBool)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_GET_SCALAR_BOOLEAN, _("%s: Unable to get argument #%d"), "getScalarBoolean",
                        getRhsFromAddress(_pvCtx, _piAddress));
        printError(&sciErr, 0);
        return sciErr.iErr;
    }
...
int createNamedScalarBoolean(void *_pvCtx, const char *_pstName, int _iBool)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_CREATE_NAMED_SCALAR_BOOLEAN, _("%s: Unable to create variable in Scilab memory"),
