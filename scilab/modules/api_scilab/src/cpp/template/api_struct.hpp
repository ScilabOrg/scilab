...
scilabStatus API_PROTO(setStructData)(scilabEnv env, scilabVar var, const wchar_t* field, const int* dims, scilabVar data)
{
    types::Struct* s = (types::Struct*)var;
#ifdef __API_SCILAB_SAFE__
    if (s->isStruct() == false)
...
scilabStatus API_PROTO(setStructData2d)(scilabEnv env, scilabVar var, const wchar_t* field, int row, int col, scilabVar data)
{
    int dims[2] = {row, col};
    types::Struct* s = (types::Struct*)var;
#ifdef __API_SCILAB_SAFE__
