...
int API_PROTO(setPoly)(scilabEnv env, scilabVar var, int index, int rank, double* real)
{
    types::Polynom* p = (types::Polynom*)var;
    types::SinglePoly* sp = p->get(index);
    if (sp)
...
int API_PROTO(setComplexPoly)(scilabEnv env, scilabVar var, int index, int rank, double* real, double* img)
{
    types::Polynom* p = (types::Polynom*)var;
    types::SinglePoly* sp = p->get(index);
    if (sp)
