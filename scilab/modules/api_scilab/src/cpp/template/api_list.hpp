...
api_return API_PROTO(setListItem)(scilabEnv env, scilabVar var, int index, const scilabVar val)
{
    types::List* l = (types::List*)var;
#ifdef __API_SCILAB_SAFE__
    if (l->isList() == false)
...
api_return API_PROTO(setTListField)(scilabEnv env, scilabVar var, const wchar_t* field, const scilabVar val)
{
    types::TList* l = (types::TList*)var;
#ifdef __API_SCILAB_SAFE__
    if (l->isTList() == false)
...
api_return API_PROTO(setMListField)(scilabEnv env, scilabVar var, const wchar_t* field, const scilabVar val)
{
    types::MList* l = (types::MList*)var;
#ifdef __API_SCILAB_SAFE__
    if (l->isMList() == false)
...
api_return API_PROTO(appendToList)(scilabEnv env, scilabVar var, const scilabVar val)
{
    types::List* l = (types::List*)var;
#ifdef __API_SCILAB_SAFE__
    if (l->isList() == false)
