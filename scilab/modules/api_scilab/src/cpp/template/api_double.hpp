...
api_return API_PROTO(getDoubleArray)(scilabEnv env, scilabVar var, const double** real)
{
...
api_return API_PROTO(getDoubleComplexArray)(scilabEnv env, scilabVar var, const double** real, const double** img)
{
    types::Double* d = (types::Double*)var;
#ifdef __API_SCILAB_SAFE__
...
api_return API_PROTO(setDoubleArray)(scilabEnv env, scilabVar var, const double* real)
{
    types::Double* d = (types::Double*)var;
#ifdef __API_SCILAB_SAFE__
    if (d->isDouble() == false)
...
api_return API_PROTO(setDoubleComplexArray)(scilabEnv env, scilabVar var, const double* real, const double* img)
{
    types::Double* d = (types::Double*)var;
#ifdef __API_SCILAB_SAFE__
    if (d->isDouble() == false || d->isComplex() == false)
