...
SciErr getComplexZMatrixOfDouble(void *_pvCtx, int *_piAddress, int *_piRows, int *_piCols, doublecomplex ** _pdblZ)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_GET_ZDOUBLE, _("%s: Unable to get argument #%d"), "getComplexZMatrixOfDouble",
...
SciErr getCommonMatrixOfDouble(void *_pvCtx, int *_piAddress, int _iComplex, int *_piRows, int *_piCols, double **_pdblReal, double **_pdblImg)
{
    ...
    if (_piAddress == NULL)
    {
        addErrorMessage(&sciErr, API_ERROR_INVALID_POINTER, _("%s: Invalid argument address"),
                        _iComplex ? "getComplexMatrixOfDouble" : "getMatrixOfDouble");
        return sciErr;
    }
    ...
    if (sciErr.iErr || iType != sci_matrix)
    {
        addErrorMessage(&sciErr, API_ERROR_INVALID_TYPE, _("%s: Invalid argument type, %s excepted"),
                        _iComplex ? "getComplexMatrixOfDouble" : "getMatrixOfDouble", _("double matrix"));
        return sciErr;
    }
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_GET_DOUBLE, _("%s: Unable to get argument #%d"),
                        _iComplex ? "getComplexMatrixOfDouble" : "getMatrixOfDouble", getRhsFromAddress(_pvCtx, _piAddress));
        return sciErr;
    }
...
SciErr createCommonNamedMatrixOfDouble(void *_pvCtx, const char *_pstName, int _iComplex, int _iRows, int _iCols, const double *_pdblReal,
...
SciErr readCommonNamedMatrixOfDouble(void *_pvCtx, const char *_pstName, int _iComplex, int *_piRows, int *_piCols, double *_pdblReal,
                                     double *_pdblImg)
{
    SciErr sciErr;
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_READ_NAMED_DOUBLE, _("%s: Unable to get variable \"%s\""),
                        _iComplex ? "readNamedComplexMatrixOfDouble" : "readNamedMatrixOfDouble", _pstName);
        return sciErr;
    }
...
static int getCommonScalarDouble(void *_pvCtx, int *_piAddress, int _iComplex, double *_pdblReal, double *_pdblImg)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_GET_SCALAR_DOUBLE, _("%s: Unable to get argument #%d"),
...
static int getCommonNamedScalarDouble(void *_pvCtx, const char *_pstName, int _iComplex, double *_pdblReal, double *_pdblImg)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_GET_NAMED_SCALAR_DOUBLE, _("%s: Unable to get argument \"%s\""),
                        _iComplex ? "getNamedScalarComplexDouble" : "getNamedScalarDouble", _pstName);
        printError(&sciErr, 0);
        return sciErr.iErr;
    }
...
static int createCommonScalarDouble(void *_pvCtx, int _iVar, int _iComplex, double _dblReal, double _dblImg)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_CREATE_SCALAR_DOUBLE, _("%s: Unable to create variable in Scilab memory"),
                        _iComplex ? "createScalarComplexDouble" : "createScalarDouble");
        printError(&sciErr, 0);
        return sciErr.iErr;
    }
...
static int createCommonNamedScalarDouble(void *_pvCtx, const char *_pstName, int _iComplex, double _dblReal, double _dblImg)
{
    ...
    if (sciErr.iErr)
    {
        addErrorMessage(&sciErr, API_ERROR_CREATE_NAMED_SCALAR, _("%s: Unable to create variable in Scilab memory"),
                        _iComplex ? "createNamedScalarComplexDouble" : "createNamedScalarDouble");
        printError(&sciErr, 0);
        return sciErr.iErr;
    }
