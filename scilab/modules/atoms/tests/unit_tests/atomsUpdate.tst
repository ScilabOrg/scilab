...
atomsRepositorySetOfl("http://scene11."+string(version(:,1))+"."+string(version(:,2))+".test.atoms.scilab.org");
...
atomsRepositorySetOfl("http://scene12."+string(version(:,1))+"."+string(version(:,2))+".test.atoms.scilab.org");
