...
if isfile(SCIHOME+"/.atoms/config.bak") then
	movefile(SCIHOME+"/.atoms/config.bak",SCIHOME+"/.atoms/config");
end
movefile(SCIHOME+"/.atoms/config",SCIHOME+"/.atoms/config.bak");
...
// =============================================================================
movefile(SCIHOME+"/.atoms/config.bak",SCIHOME+"/.atoms/config");
deletefile(SCIHOME+"/.atoms/config.bak");
