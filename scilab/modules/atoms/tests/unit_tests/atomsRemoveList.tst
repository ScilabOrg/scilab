...
"-" "P" "toolbox_4" "1.1-1" "user" ;
"-" "P" "toolbox_2" "1.0-1" "user" ;
"-" "P" "toolbox_3" "1.0-1" "user" ;
"-" "P" "toolbox_2" "2.1-1" "user" ];
...
ref = [ "-" "U" "toolbox_2" "2.1-1" "user" ;
"-" "P" "toolbox_3" "1.0-1" "user" ;
"~" "C" "toolbox_1" "1.0-1" "user" ];

if or(atomsRemoveList(["toolbox_2" "2.1"],"user")<>ref) then pause, end
