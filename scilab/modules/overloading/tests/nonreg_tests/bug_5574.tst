...
fun_exec = "hm_constants + [""a"", ""b""]";
err_msg = msprintf(_("%s: This feature has not been implemented: Addition of hypermatrices of <%s> and matrices of <%s>"), "%hm_a_c", "constant", "string");
assert_checkerror(fun_exec, err_msg);
...
err_msg =  msprintf(_("%s: Wrong size for input argument #%d: %d-by-%d matrix expected.\n"), "%c_a_hm", 1, 1, 1);
assert_checkerror(fun_exec, err_msg);
fun_exec = "[""a"", ""b""] + hm_constants";
err_msg = msprintf(_("%s: This feature has not been implemented: Addition of matrices of <%s> and hypermatrices of <%s>"), "%c_a_hm", "string", "constant");
assert_checkerror(fun_exec, err_msg);
...
assert_checkerror(fun_exec, err_msg);
fun_exec= "hm_constants < [""a"", ""b""]";
err_msg = msprintf(_("%s: This feature has not been implemented: Comparison between hypermatrices of <%s> and matrices of <%s>"), "%hm_1_c", "constant", "string");
assert_checkerror(fun_exec, err_msg);
...
assert_checkerror(fun_exec, err_msg);
fun_exec= "hm_constants > [""a"", ""b""]";
err_msg = msprintf(_("%s: This feature has not been implemented: Comparison between hypermatrices of <%s> and matrices of <%s>"), "%hm_2_c", "constant", "string");
assert_checkerror(fun_exec, err_msg);
...
assert_checkerror(fun_exec, err_msg);
fun_exec= "hm_constants <= [""a"", ""b""]";
err_msg = msprintf(_("%s: This feature has not been implemented: Comparison between hypermatrices of <%s> and matrices of <%s>"), "%hm_3_c", "constant", "string");
assert_checkerror(fun_exec, err_msg);
...
assert_checkerror(fun_exec, err_msg);
fun_exec= "hm_constants >= [""a"", ""b""]";
err_msg = msprintf(_("%s: This feature has not been implemented: Comparison between hypermatrices of <%s> and matrices of <%s>"), "%hm_4_c", "constant", "string");
assert_checkerror(fun_exec, err_msg);
