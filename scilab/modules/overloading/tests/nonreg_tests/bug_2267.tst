...
clf(); plot2d(); a=gca();
errmsg1=msprintf(_("%s: Incompatible input arguments %s and %s: Same sizes expected.\n"), "generic_i_h", "x_ticks.locations", "x_ticks.labels");
...
errmsg2=msprintf(_("%s: Incompatible input arguments %s and %s: Same sizes expected.\n"), "generic_i_h", "y_ticks.locations", "y_ticks.labels");
