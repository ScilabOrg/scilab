...
function hm_text1 = %hm_4_c(hm_text1, text2)
    if typeof(hm_text1(1)) <> "string"
        error(msprintf(_("%s: This feature has not been implemented: Comparison between hypermatrices of <%s> and matrices of <%s>"), "%hm_4_c", typeof(hm_text1(1)), typeof(text2)));
    end
    if size(text2, '*') <> 1
