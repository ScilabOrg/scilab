...
extern "C"
{
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_appendLineToScilabHistory(JNIEnv * jenv, jclass jcls,
                                                                                                                        jstring jarg1)
    {
        jboolean jresult = 0;
        char *arg1 = (char *)0;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_appendLinesToScilabHistory(JNIEnv * jenv, jclass jcls,
                                                                                                                         jobjectArray jarg1,
                                                                                                                         jint jarg2)
    {
        jboolean jresult = 0;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_writeScilabHistoryToFile(JNIEnv * jenv, jclass jcls,
                                                                                                                       jstring jarg1)
    {
        jboolean jresult = 0;
        char *arg1 = (char *)0;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_loadScilabHistoryFromFile(JNIEnv * jenv, jclass jcls,
                                                                                                                        jstring jarg1)
    {
        jboolean jresult = 0;
        char *arg1 = (char *)0;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_setFilenameScilabHistory(JNIEnv * jenv, jclass jcls,
                                                                                                                       jstring jarg1)
    {
        jboolean jresult = 0;
        char *arg1 = (char *)0;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_setDefaultFilenameScilabHistory(JNIEnv * jenv,
                                                                                                                              jclass jcls)
    {
        jboolean jresult = 0;
        BOOL result;
    ...
    SWIGEXPORT jobjectArray JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_getAllLinesOfScilabHistory(JNIEnv * jenv,
                                                                                                                             jclass jcls)
    {
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_setSearchedTokenInScilabHistory(JNIEnv * jenv,
                                                                                                                              jclass jcls,
                                                                                                                              jstring jarg1)
    {
        jboolean jresult = 0;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_resetSearchedTokenInScilabHistory(JNIEnv * jenv,
                                                                                                                                jclass jcls)
    {
        jboolean jresult = 0;
        BOOL result;
    ...
    SWIGEXPORT jstring JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_getSearchedTokenInScilabHistory(JNIEnv * jenv,
                                                                                                                             jclass jcls)
    {
        jstring jresult = 0;
        char *result = 0;
    ...
    SWIGEXPORT jstring JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_getPreviousLineInScilabHistory(JNIEnv * jenv,
                                                                                                                            jclass jcls)
    {
        jstring jresult = 0;
        char *result = 0;
    ...
    SWIGEXPORT void JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_setSaveConsecutiveDuplicateLinesInScilabHistory(JNIEnv *
                                                                                                                                          jenv,
                                                                                                                                          jclass jcls,
                                                                                                                                          jboolean
                                                                                                                                          jarg1)
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_getSaveConsecutiveDuplicateLinesInScilabHistory(JNIEnv *
                                                                                                                                              jenv,
                                                                                                                                              jclass
                                                                                                                                              jcls)
    {
    ...
    SWIGEXPORT void JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_setAfterHowManyLinesScilabHistoryIsSaved(JNIEnv * jenv,
                                                                                                                                   jclass jcls,
                                                                                                                                   jint jarg1)
    {
        int arg1;
    ...
    SWIGEXPORT jint JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_getAfterHowManyLinesScilabHistoryIsSaved(JNIEnv * jenv,
                                                                                                                                   jclass jcls)
    {
        jint jresult = 0;
        int result;
    ...
    SWIGEXPORT jstring JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_getNthLineInScilabHistory(JNIEnv * jenv, jclass jcls,
                                                                                                                       jint jarg1)
    {
        jstring jresult = 0;
        int arg1;
    ...
    SWIGEXPORT jboolean JNICALL Java_org_scilab_modules_history_1manager_HistoryManagementJNI_deleteNthLineScilabHistory(JNIEnv * jenv, jclass jcls,
                                                                                                                         jint jarg1)
    {
        jboolean jresult = 0;
        int arg1;
