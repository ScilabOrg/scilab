...
#define DEFAULTEXPORT "JH"
    ...
    int sci_buildDocv2(char *fname,unsigned long l)
    {
        ...
        catch(GiwsException::JniException ex)
        {
            ...
            Scierror(999,_("If Scilab is started in a chroot, you might want to try to set the two environnement variables: SCI_DISABLE_TK=1 SCI_JAVA_ENABLE_HEADLESS=1\n"));
            return FALSE;
        }
