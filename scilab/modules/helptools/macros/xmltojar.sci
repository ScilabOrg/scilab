...
function generated_files = xmltojar(dirs,titles,directory_language,default_language,toolbox_id)
    ...
    case 5 then
        generated_files = xmltoformat("javaHelp",dirs,titles,directory_language,default_language,toolbox_id);
    else
