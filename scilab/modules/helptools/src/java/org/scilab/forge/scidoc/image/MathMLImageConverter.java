...
public class MathMLImageConverter implements ExternalImageConverter {
     ...
     * {@inheritDoc}
     */
    public String convertToImage(String mathml, Map<String, String> attributes, File imageFile) {
	Document doc = null;
	try {
     ...
     * {@inheritDoc}
     */
    public String convertToImage(File mathml, Map<String, String> attributes, File imageFile) {
	Document doc = null;
	try {
