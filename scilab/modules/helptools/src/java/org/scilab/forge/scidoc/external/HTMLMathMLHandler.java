...
public class HTMLMathMLHandler extends ExternalXMLHandler {
     ...
     */
    public HTMLMathMLHandler(String baseDir) {
	...
	if (MATH.equals(localName)) {
	    ...
	    File f = new File(baseDir, BASENAME + (compt++) + ".png");
	    Map<String, String> attributes = new HashMap();
	    attributes.put("fontsize", "16");

	    String ret = ImageConverter.getImageByCode(buffer.toString(), attributes, "image/mathml", f);
	    buffer.setLength(0);
