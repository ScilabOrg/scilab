...
//            }
    ...
    //        }
        ...
        else if(iContr == 1 && iAlgo == 2) // bounds not setted && algo gc
        {
            ...
            switch(iMode)
            {
                case 0 :  iIndOpt = 0;   break;
                case 1 :  iIndOpt = 1;   break;
                case 2 :  iIndOpt = -10; break;
                case 7 :
                case 3 :  iIndOpt = 7;   break;
                case 4 :  iIndOpt = 5;   break;
                case 5 :  iIndOpt = 4;   break;
                case 6 :  iIndOpt = 3;   break;
                default : iIndOpt = 9;
            }
