...
c
      subroutine gcbd(indgc,simul,nomf,n,x,f,g,verbosity,io,zero,
...
c     g gradient de f                                             s
c     verbosity si =0 pas d impression
...
906   format (5x,"printing level (verbosity):",i4)
c
...
c
     ...
     &(nindic),nfac,verbosity,io,epsx,epsf,epsg,vect(ndir),df0,
