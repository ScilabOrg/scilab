    ...
    if ( this.withderivatives ) then 
        if ( this.nbineqconst == 0 ) then
            ...
            if ( funtype == "function" ) then
                ...
                [ f , g , index ] = __optimbase_f__ ( x , index , this.fun(2:$) );
            end
            varargout(1) = this
            varargout(2) = f
            varargout(3) = g
            ...
            if ( funtype == "function" ) then
                ...
                [ f , g , c , gc , index ] = __optimbase_f__ ( x , index , this.fun(2:$) );
            end
            varargout(1) = this
            varargout(2) = f
            varargout(3) = g
        ...
        if ( this.nbineqconst == 0 ) then
            ...
            if ( funtype == "function" ) then
                ...
                [ f , index ] = __optimbase_f__ ( x , index , this.fun(2:$) );
            end
            varargout(1) = this
            varargout(2) = f
            varargout(3) = index
            ...
            if ( funtype == "function" ) then
                ...
                [ f , c , index ] = __optimbase_f__ ( x , index , this.fun(2:$) );
            end
            varargout(1) = this
            varargout(2) = f
            varargout(3) = c
