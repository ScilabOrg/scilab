...
assert_checkerror ( cmd , "optimsimplex_randbounds: The boundsmin vector is expected to have 2 columns, but current shape is 1 x 3" );
...
boundsmax = [5 5 5];
cmd = "newobj = optimsimplex_new ( ""randbounds"" , x0 , rosenbrock , boundsmin , boundsmax );";
assert_checkerror ( cmd , "optimsimplex_randbounds: The boundsmax vector is expected to have 2 columns, but current shape is 1 x 3" );
