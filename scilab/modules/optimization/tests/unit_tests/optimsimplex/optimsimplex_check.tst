...
assert_checkerror ( cmd , "optimsimplex_setallfv: The number of rows in the function value array is 4, while expected 5.");
s1 = optimsimplex_destroy(s1);
//
...
assert_checkerror(cmd,"optimsimplex_setallx: The number of rows in x is 4, while expected 5.");
s1 = optimsimplex_destroy(s1);
//
...
cmd = "s1 = optimsimplex_setallx ( s1 , newsimplex );";
assert_checkerror(cmd,"optimsimplex_setallx: The number of columns in x is 1, while expected 2.");
s1 = optimsimplex_destroy(s1);
//
...
assert_checkerror(cmd,"optimsimplex_check: Number of rows of x is 5, which is different from number of vertices = 6.");
s1 = optimsimplex_destroy(s1);
//
...
s1 = optimsimplex_setallx ( s1 , newsimplex );
cmd = "optimsimplex_check ( s1 );";
assert_checkerror(cmd,"optimsimplex_check: Number of rows of fv is 6, which is different from number of vertices = 5.");
s1 = optimsimplex_destroy(s1);
//
...
assert_checkerror(cmd,"optimsimplex_setallfv: The number of columns in the function value array is 2, while expected 1.");
s1 = optimsimplex_destroy(s1);
//
...
cmd = "optimsimplex_check ( s1 );";
assert_checkerror(cmd,"optimsimplex_check: Number of columns of x is 2, which is different from dimension = 3.");
s1 = optimsimplex_destroy(s1);
