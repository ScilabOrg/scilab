...
// optimsimplex_check
s1 = optimsimplex_new ();
refMsg = msprintf(_("%s: Wrong type for intput argument #%d: TSIMPLEX expected.\n"), "optimsimplex_check", 1);
...
refMsg2 = msprintf(_("%s: Wrong type for input argument #%d: Real vector expected.\n"), "optimsimplex_setallfv", 2);
...
refMsg2 = msprintf(_("%s: Wrong type for input argument #%d: Real matrix expected.\n"), "optimsimplex_setallx", 2);
...
refMsg2 = msprintf(_("%s: Wrong type for input argument #%d: Real scalar expected.\n"), "optimsimplex_setfv", 2);
refMsg3 = msprintf(_("%s: Wrong size for input argument #%d: (%d,%d) expected.\n"), "optimsimplex_setfv", 2, 1, 1);
refMsg4 = msprintf(_("%s: Wrong value for input argument #%d: Integer expected.\n"), "optimsimplex_setfv", 2);
refMsg5 = msprintf(_("%s: Wrong type for input argument #%d: Real vector expected.\n"), "optimsimplex_setfv", 3);
...
refMsg6 = msprintf(_("%s: Wrong type for input argument #%d: Real matrix expected.\n"), "optimsimplex_setve", 4);
...
refMsg = msprintf(_("%s: Wrong type for intput argument #%d: TSIMPLEX expected.\n"), "optimsimplex_setx", 1);
refMsg2 = msprintf(_("%s: Wrong type for input argument #%d: Real scalar expected.\n"), "optimsimplex_setx", 2);
refMsg3 = msprintf(_("%s: Wrong size for input argument #%d: (%d,%d) expected.\n"), "optimsimplex_setx", 2, 1, 1);
refMsg4 = msprintf(_("%s: Wrong value for input argument #%d: Integer expected.\n"), "optimsimplex_setx", 2);
refMsg5 = msprintf(_("%s: Wrong type for input argument #%d: Real matrix expected.\n"), "optimsimplex_setx", 3);
