...
typedef fftw_plan(*PROC_FFTW_PLAN_GURU_SPLIT_DFT) (int rank, const fftw_iodim * dims, int howmany_rank, const fftw_iodim * howmany_dims, double *ri,
...
BOOL IsLoadedFFTW(void)
{
    if ((MY_FFTW_EXECUTE_SPLIT_DFT) && (MY_FFTW_PLAN_GURU_SPLIT_DFT) && (MY_FFTW_DESTROY_PLAN) &&
        (MY_FFTW_EXPORT_WISDOM_TO_STRING) && (MY_FFTW_IMPORT_WISDOM_FROM_STRING) && (MY_FFTW_FORGET_WISDOM))
        return TRUE;
    return FALSE;
}
...
/*--------------------------------------------------------------------------*/
fftw_plan call_fftw_plan_guru_split_dft(int rank, const fftw_iodim * dims, int howmany_rank, const fftw_iodim * howmany_dims, double *ri, double *ii,
