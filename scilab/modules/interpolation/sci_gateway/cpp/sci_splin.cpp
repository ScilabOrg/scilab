...
// *** Perform operation. ***
    ...
    switch(iType)
    {
        ...
        case 0:
        {
            rwork1 = (double*)malloc(iSize       * sizeof(double));
            rwork2 = (double*)malloc((iSize - 1) * sizeof(double));
            rwork3 = (double*)malloc((iSize - 1) * sizeof(double));
            rwork4 = rwork1;
            ...
            if(iType == 3)
            {
                rwork4 = (double*)malloc((iSize - 1) * sizeof(double));
            }
