...
// *** Perform operation. ***
    ...
    C2F(cshep2)(&rows, pDblXYZ->get(), pDblXYZ->get() + rows, pDblXYZ->get() + (2 * rows), &nc, &nw, &nr, pInt32Cell->get(), pInt32Next->get(), pDblGrid->get(), pDblGrid->get() + 1, pDblGrid->get() + 2, pDblGrid->get() + 3, pDblRMax->get(), pDblRW->get(), pDblA->get(), &ier);
