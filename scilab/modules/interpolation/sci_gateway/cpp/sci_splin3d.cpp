...
// *** Perform operation. ***
    ...
    double* work = (double*)malloc((nxyz + 2 * max) * sizeof(double));
    ...
    C2F(db3ink)(pDblXYZ[0]->get(), &xyzSize[0], pDblXYZ[1]->get(), &xyzSize[1], pDblXYZ[2]->get(), &xyzSize[2], pDblV->get(), &xyzSize[0], &xyzSize[1], &pdOrder[0], &pdOrder[1], &pdOrder[2], pDblOutX->get(), pDblOutY->get(), pDblOutZ->get(), pDblCoef->get(), work, &flag);
