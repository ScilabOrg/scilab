...
int _wrap_curl_easy_init(char *fname, unsigned long fname_len)
{
    ...
    SWIG_Scilab_SetOutputPosition(1);
    if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), SWIG_as_voidptr(result), SWIGTYPE_p_CURL, 0 |  0 ))))
    {
        return SWIG_ERROR;
    }
    return SWIG_OK;
...
int _wrap_curl_easy_setopt(char *fname, unsigned long fname_len)
{
    ...
    SWIG_Scilab_SetOutputPosition(1);
    if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), (CURLcode *)memcpy((CURLcode *)malloc(sizeof(CURLcode)), &result, sizeof(CURLcode)), SWIGTYPE_p_CURLcode, SWIG_POINTER_OWN |  0 ))))
    {
        return SWIG_ERROR;
    }
    return SWIG_OK;
