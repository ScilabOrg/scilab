...
non_positive_time=msprintf(_("%s: Wrong value for input argument #%d: the expected value must be greater than or equal to %d.\n"),"soundsec",1,0);
non_positive_freq=msprintf(_("%s: Wrong value for input argument #%d: the expected value must be greater than or equal to %d.\n"),"soundsec",2,0);
