    ...
    while (1)
    {
        ...
        case 10:               /*EOF */
            ...
            *cur_pos = *cur_pos + 4 + Len;
            return;
        case 638:
            /*RK*/ C2F(mgetnc) (fd, (void *)&row, &one, typ_ushort, err);
            if (*err > 0)
                goto ErrL;
        ...
        case 189:
            /*MULRK*/ C2F(mgetnc) (fd, (void *)&row, &one, typ_ushort, err);
            if (*err > 0)
                goto ErrL;
        ...
        case 253:
            /*LABELSST*/ C2F(mgetnc) (fd, (void *)labelsst1, &three, typ_short, err);
            if (*err > 0)
                goto ErrL;
...
static void getString(int *fd, short *PosInRecord, short *RecordLen, int flag, char **str, int *err)
{
    ...
    *err = 0;
    ...
    if (flag && (*PosInRecord == *RecordLen))
    {                           /* data limit encountered */
        /*check for continue tag */
    ...
    {                           /* getString called by getBoundsheets */
    ...
    *PosInRecord += 1;
    ...
    {                           /* char stream contains at least one "continue" */
