...
// <-- JVM NOT MANDATORY -->
// =============================================================================
r_string = csv_read(SCI+"/modules/spreadsheet/" + "tests/nonreg_tests/bug_2.csv", ",", [], "string");
r_double = csv_read(SCI+"/modules/spreadsheet/" + "tests/nonreg_tests/bug_2.csv", ",", ".", "double");
// =============================================================================
