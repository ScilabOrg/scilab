...
// <-- JVM NOT MANDATORY -->
// =============================================================================
r1_string = csv_read(SCI+"/modules/spreadsheet/" + "tests/nonreg_tests/bug_5.csv", ",", [], "string");
r1_double = csv_read(SCI+"/modules/spreadsheet/" + "tests/nonreg_tests/bug_5.csv", ",", ".", "double");
// =============================================================================
