...
assert_checkalmostequal(res, ref);
...
assert_checkalmostequal(x, res);

// Bug #13409 test case
dims=3; A1=matrix(1:12, [2,2,3]); A2=[13 14;15 16]; A3=matrix(21:36,[2,2,4]); y=cat(dims,A1,A2,A3);
assert_checkalmostequal(A1, y(:,:,1:3));
assert_checkalmostequal(A2, y(:,:,4));
assert_checkalmostequal(A3, y(:,:,5:8));
