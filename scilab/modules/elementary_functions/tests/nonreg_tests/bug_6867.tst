...
if lasterror() <> gettext("base2dec: Wrong value for input argument(s): Valid base 13 representations expected.") then pause, end

execstr("base2dec(""FFFF"",14);""","errcatch");
if lasterror() <> gettext("base2dec: Wrong value for input argument(s): Valid base 14 representations expected.") then pause, end
