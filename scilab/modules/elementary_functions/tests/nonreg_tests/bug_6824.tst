...
// Error checks
refMsg = msprintf(_("%s: Wrong size for input argument #%d: Matrix or 3D hypermatrix expected.\n"), "resize_matrix", 1);
assert_checkerror("resize_matrix(rand(2,2,2,2), 3, 3);", refMsg);

refMsg = msprintf(_("%s: Wrong type for input argument #%d: %s, %s, %s, %s, %s or %s matrix expected.\n"),..
"resize_matrix", 1, "Real", "Complex", "Integer", "Boolean", "String", "Hypermatrix");
