...
for i = 1:Ntest,
    ...
    assert_checkalmostequal(norm([am-a1(1,1),(ak(1)+(m)*(ak(2)-1))-ak1(1,1)]), %eps, [], %eps);
end
...
for i = 1:Ntest,
    m = 100;a = rand(1,m);
    [am,ak] = max(a); [a1,ak1] = gsort(a);
    assert_checkalmostequal(norm([am-a1(1,1),(ak-ak1(1,1))]), %eps, [], %eps);
end
...
for i=1:Ntest,
    ...
    assert_checkalmostequal(norm([am+ami,ak-aki]), %eps, [], %eps);
end
...
assert_checkalmostequal(norm(Am1-Am), %eps, [], %eps);
assert_checkalmostequal(norm(Ak1-Ak), %eps, [], %eps);
...
assert_checkalmostequal(norm(Am-Am1), %eps, [], %eps);
assert_checkalmostequal(norm(Akm-Ak1), %eps, [], %eps);
