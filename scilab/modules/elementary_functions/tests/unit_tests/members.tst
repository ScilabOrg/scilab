...
A_for_later = A;
S_for_later = S;
expected_for_later = expected;
expected2_for_later = expected2;
expectednb_for_later = expectednb;
...
expected = expected_for_later;
expected2 = expected2_for_later;
expectednb = expectednb_for_later;
...
S = S_for_later;
expected(:, :, 2) = expected;
expected2(:, :, 2) = expected2;
expectednb(:, :, 2) = expectednb;
