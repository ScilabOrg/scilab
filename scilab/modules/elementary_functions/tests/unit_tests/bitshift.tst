...
assert_checkequal(bitshift(int8(65),  int8(1)), -int8(126));
assert_checkequal(bitshift(int8(65), int8(-1)), int8(2^5));
...
// Cross types
assert_checkequal(bitshift(2^10,  int8(1), "drop"), 2^11);
assert_checkequal(bitshift(int8(1e2), -1, "drop"), int8(50));

assert_checkequal(bitshift(int32([2^10 2^10]), int16([3 -3]), "drop"), int32([2^13 2^7]));
assert_checkequal(bitshift(int16([2^10 2^4]), int8(3), "drop"), int16([2^13 2^7]));
assert_checkequal(bitshift(int32(2^10), int8([3 -3]), "drop"), int32([2^13 2^7]));
assert_checkequal(bitshift([2^10 2^10; 3 4], int32([3 -3; -1 5]), "drop"), [2^13 2^7; 1 2^7]);

assert_checkequal(bitshift(uint8(200),  int16(1), "drop"), uint8(255));
assert_checkequal(bitshift(-int8(65), uint8(1), "drop"), -int8(128));

assert_checkequal(bitshift(uint16([2^10 2^10]), uint8([3 2])), uint16([2^13 2^12]));
assert_checkequal(bitshift(uint16([2^10 2^4]), uint32(3)), uint16([2^13 2^7]));
assert_checkequal(bitshift(uint32(2^10), uint8([3 2])), uint32([2^13 2^12]));
assert_checkequal(bitshift(uint32([2^10 2^10; 3 4]), uint16([3 2; 1 5])), uint32([2^13 2^12; 6 2^7]));


// Rounding
assert_checkequal(bitshift(65, -1), 32);
assert_checkequal(bitshift(-65, -1), -32);

assert_checkequal(bitshift(int8(65),  int8(-1)), int8(32));
assert_checkequal(bitshift(-int8(65), int8(-1)), -int8(32));

assert_checkequal(bitshift(int16(65),  int16(-1)), int16(32));
assert_checkequal(bitshift(-int16(65), int16(-1)), -int16(32));

assert_checkequal(bitshift(int32(65),  int32(-1)), int32(32));
assert_checkequal(bitshift(-int32(65), int32(-1)), -int32(32));
