...
errmsg3=msprintf(_("%s: Wrong type for input argument #%d: A real or complex matrix expected.\n"), "cross", 1);
assert_checkerror("cross([""s"";""t"";""u""],B)", errmsg3);
errmsg4=msprintf(_("%s: Wrong type for input argument #%d: A real or complex matrix expected.\n"), "cross", 2);
assert_checkerror("cross(A,[""s"";""t"";""u""])", errmsg4);
errmsg5=msprintf(_("%s: Wrong size for input argument #%d: %d-by-%d matrix expected.\n"), "cross", 1, 3, 1);
assert_checkerror("cross([1;2;3;4],B)", errmsg5);
errmsg6=msprintf(_("%s: Wrong size for input argument #%d: %d-by-%d matrix expected.\n"), "cross", 2, 3, 1);
assert_checkerror("cross(A,[1;2])",errmsg6);
