...
// Encoded integers
assert_checkequal(modulo( int8(-123), int16(-7)), int16(-4));
assert_checkequal(pmodulo(int8(-123), int16(-7)), int16(3));
assert_checkequal(modulo( int8(-123), int16([-7 5])),int16([4,3]));
assert_checkequal(pmodulo(int8(-123), int16([-7 5])),int16([4,3]));
assert_checkequal(modulo( int8([-123 51]), int16(-7)),  int16([-4,2]));
assert_checkequal(pmodulo(int8([-123 51]), int16(-7)),int16([3,2]));
assert_checkequal(modulo( int8([-123 51]), int16([-7 5])),int16([-4,1]) );
assert_checkequal(pmodulo(int8([-123 51]), int16([-7 5])),  int16([3,1]));
