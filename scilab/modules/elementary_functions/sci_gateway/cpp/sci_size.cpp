    ...
    default :
        // All types inherits of GenericType, so have this algorithm as default.
        {
            ...
            if(in.size() == 2)
            {
                ...
                if((iMode == 1 || iMode == 2) && in[0]->getAs<ArrayOf<double> >()->get_dims() > 2)
                {
            ...
            int iDims   = in[0]->getAs<ArrayOf<double> >()->get_dims();
            int* piDims = in[0]->getAs<ArrayOf<double> >()->get_dims_array();
            ...
            if(_iRetCount == 1)
            {
                ...
                case -1 : //lhs == 1
                    ...
                    break;
                case 0 : //"*"
                    pdbl[0] = in[0]->getAs<ArrayOf<double> >()->size_get();
                    break;
                case 1 : //"r"
                    iColsOut = 1;
                    pdbl[0] = in[0]->getAs<ArrayOf<double> >()->rows_get();
                    break;
                case 2 : //"c"
                    iColsOut = 1;
                    pdbl[0] = in[0]->getAs<ArrayOf<double> >()->cols_get();
                    break;
                }
                out.push_back(pD);
            }
