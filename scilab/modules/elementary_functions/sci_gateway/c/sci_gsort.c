...
#define COMPLEX 1
    ...
    if (Rhs == 3)
    {
        ...
        if (strcmp(pstData, "i") && strcmp(pstData, "d"))
        {
            if (getWarningMode())
            {
                sciprint(_("WARNING: %s\n"), _("Third argument of gsort is obsolete."));
                sciprint(_("WARNING: %s\n"), _("It will be more strict after Scilab 5."));
                sciprint(_("WARNING: %s\n"), _("Please use \"d\" \"i\" instead."));
            }
        }
    ...
    if (Rhs >= 2)
    {
        ...
        if (strcmp(pstData, "c") && strcmp(pstData, "r") && strcmp(pstData, "g") && strcmp(pstData, "lc") && strcmp(pstData, "lr"))
        {
            if (getWarningMode())
            {
                sciprint(_("WARNING: %s\n"), _("Second argument of gsort is obsolete."));
                sciprint(_("WARNING: %s\n"), _("It will be more strict after Scilab 5."));
                sciprint(_("WARNING: %s\n"), _("Please use \"r\" \"c\" \"g\" \"lr\" \"lc\" instead."));
            }
        }
