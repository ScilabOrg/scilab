        ...
        if(wstrProcess == L"r" || wstrProcess == L"c" || wstrProcess == L"g")
        {
            ...
            else
            {
                if(wstrProcess == L"g")
                {
                    ...
                    if(wstrWay == L"i")
                    {
                        std::sort(pdblOutR, pdblOutR + pOut->getSize());
                    }
                    else // strWay == L"d"
                    {
                        std::sort(pdblOutR, pdblOutR + pOut->getSize(), std::greater<double>());
                    }
                }
                else if(wstrProcess == L"c")
                {
                    ...
                    if(wstrWay == L"i")
                    {
                        for(int i = 0; i < iTimes; i++)
                        {
                            std::sort(pdblOutR + (iItem * i), pdblOutR + (iItem * (i + 1)));
                        }
                    }
                    else // strWay == L"d"
                    {
                        for(int i = 0; i < iTimes; i++)
                        {
                            std::sort(pdblOutR + (iItem * i), pdblOutR + (iItem * (i + 1)), std::greater<double>());
                        }
                    }
