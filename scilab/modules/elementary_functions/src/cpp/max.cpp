...
/*--------------------------- Sparse ---------------------------------------*/
////void max(std::vector<types::Sparse*> vectIn, int iOrientation, types::Sparse* pSparseIndex, types::Sparse* pOut)
////{
////    int iDims       = vectIn[0]->getDims();
////    int* iDimsArray = vectIn[0]->getDimsArray();
////    int iSize       = vectIn[0]->getSize();
...
////        }
////
////        for(int iter = 1; iter < vectIn.size(); iter++) // find the max values
////        {
...
////        }
////
////        // check that the negative values are really the max values.
...
////            {
////                if(dMax < pNonZeroR[i] || ISNAN(dMax))
////                {
////                    dMax = pNonZeroR[i];
////                    iIndex = i;
////                }
...
////
////            if((dMax < 0 || ISNAN(dMax))&& iNonZeros < iSize) // get the first 0
////            {
////                dMax = 0;
////                if(pSparseIndex)
////                {
...
////}
//
//void max(types::Sparse* SparseIn, types::Double* pDblIndex, types::Double* pOut)
//{
