...
void ColSortstring(char * *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (j = 0; j < p; j++)
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(char *), sizeof(int), (dir == 'i') ? compareCstring : compareDstring, swapcodestring, swapcodeind);
    }
}
...
void RowSortstring(char * *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (i = 0; i < n; i++)
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(char *), n * sizeof(int), (dir == 'i') ? compareCstring : compareDstring, swapcodestring, swapcodeind);
    }
}
...
void LexiRowstring(char * *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(char *), sizeof(int), (dir == 'i') ? LexiRowcompareCstring : LexiRowcompareDstring, LexiRowswapcodestring, swapcodeind);
}
...
void LexiColstring(char * *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(char *), sizeof(int), (dir == 'i') ? LexiColcompareCstring : LexiColcompareDstring, LexiColswapcodestring, swapcodeind);
}
