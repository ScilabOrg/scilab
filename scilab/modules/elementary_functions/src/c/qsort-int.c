...
void ColSortint(int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (j = 0; j < p; j++)
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(int), sizeof(int), (dir == 'i') ? compareCint : compareDint, swapcodeint, swapcodeind);
    }
}
...
void ColSortuint(unsigned int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(int), sizeof(int), (dir == 'i') ? compareCuint : compareDuint, swapcodeint, swapcodeind);
    }
}
...
void RowSortint(int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (i = 0; i < n; i++)
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(int), n * sizeof(int), (dir == 'i') ? compareCint : compareDint, swapcodeint, swapcodeind);
    }
}
...
void RowSortuint(unsigned int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(int), n * sizeof(int), (dir == 'i') ? compareCuint : compareDuint, swapcodeint, swapcodeind);
    }
}
...
void GlobalSortint(int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n * p, sizeof(int), sizeof(int), (dir == 'i') ? compareCint : compareDint, swapcodeint, swapcodeind);
}
...
void GlobalSortuint(unsigned int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n * p, sizeof(int), sizeof(int), (dir == 'i') ? compareCuint : compareDuint, swapcodeint, swapcodeind);
}
...
void LexiRowint(int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(int), sizeof(int), (dir == 'i') ? LexiRowcompareCint : LexiRowcompareDint, LexiRowswapcodeint, swapcodeind);
}
...
void LexiRowuint(unsigned int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(int), sizeof(int), (dir == 'i') ? LexiRowcompareCuint : LexiRowcompareDuint, LexiRowswapcodeint, swapcodeind);
}
...
void LexiColint(int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(int), sizeof(int), (dir == 'i') ? LexiColcompareCint : LexiColcompareDint, LexiColswapcodeint, swapcodeind);
}
...
void LexiColuint(unsigned int *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(int), sizeof(int), (dir == 'i') ? LexiColcompareCuint : LexiColcompareDuint, LexiColswapcodeint, swapcodeind);
}
