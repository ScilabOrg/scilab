...
void ColSortshort(short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (j = 0; j < p; j++)
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(short), sizeof(int), (dir == 'i') ? compareCshort : compareDshort, swapcodeshort, swapcodeind);
    }
}
...
void RowSortshort(short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (i = 0; i < n; i++)
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(short), n * sizeof(int), (dir == 'i') ? compareCshort : compareDshort, swapcodeshort, swapcodeind);
    }
}
...
void ColSortushort(unsigned short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(short), sizeof(int), (dir == 'i') ? compareCushort : compareDushort, swapcodeshort, swapcodeind);
    }
}
...
void RowSortushort(unsigned short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(short), n * sizeof(int), (dir == 'i') ? compareCushort : compareDushort, swapcodeshort, swapcodeind);
    }
}
...
void LexiRowshort(short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(short), sizeof(int), (dir == 'i') ? LexiRowcompareCshort : LexiRowcompareDshort, LexiRowswapcodeshort, swapcodeind);
}
...
void LexiRowushort(unsigned short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(short), sizeof(int), (dir == 'i') ? LexiRowcompareCushort : LexiRowcompareDushort, LexiRowswapcodeshort, swapcodeind);
}
...
void LexiColshort(short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(short), sizeof(int), (dir == 'i') ? LexiColcompareCshort : LexiColcompareDshort, LexiColswapcodeshort, swapcodeind);
}
...
void LexiColushort(unsigned short *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(short), sizeof(int), (dir == 'i') ? LexiColcompareCushort : LexiColcompareDushort, LexiColswapcodeshort, swapcodeind);
}
