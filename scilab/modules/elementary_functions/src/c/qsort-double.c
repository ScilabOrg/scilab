...
void ColSortdouble(double *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (j = 0; j < p; j++)
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(double), sizeof(int), (dir == 'i') ? compareCdouble : compareDdouble, swapcodedouble, swapcodeind);
    }
}
...
void RowSortdouble(double *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (i = 0; i < n; i++)
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(double), n * sizeof(int), (dir == 'i') ? compareCdouble : compareDdouble, swapcodedouble, swapcodeind);
    }
}
...
void LexiRowdouble(double *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(double), sizeof(int), (dir == 'i') ? LexiRowcompareCdouble : LexiRowcompareDdouble, LexiRowswapcodedouble, swapcodeind);
}
...
void LexiColdouble(double *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(double), sizeof(int), (dir == 'i') ? LexiColcompareCdouble : LexiColcompareDdouble, LexiColswapcodedouble, swapcodeind);
}
