...
void ColSortchar(char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (j = 0; j < p; j++)
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(char), sizeof(int), (dir == 'i') ? compareCchar : compareDchar, swapcodechar, swapcodeind);
    }
}
...
void RowSortchar(char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    for (i = 0; i < n; i++)
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(char), n * sizeof(int), (dir == 'i') ? compareCchar : compareDchar, swapcodechar, swapcodeind);
    }
}
...
void ColSortuchar(unsigned char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    {
        sciqsort((char *)(a + n * j), (char *)(ind + n * j), flag, n,
                 sizeof(char), sizeof(int), (dir == 'i') ? compareCuchar : compareDuchar, swapcodechar, swapcodeind);
    }
}
...
void RowSortuchar(unsigned char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    {
        sciqsort((char *)(a + i), (char *)(ind + i), flag, p,
                 n * sizeof(char), n * sizeof(int), (dir == 'i') ? compareCuchar : compareDuchar, swapcodechar, swapcodeind);
    }
}
...
void LexiRowchar(char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(char), sizeof(int), (dir == 'i') ? LexiRowcompareCchar : LexiRowcompareDchar, LexiRowswapcodechar, swapcodeind);
}
...
void LexiRowuchar(unsigned char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, n,
             sizeof(char), sizeof(int), (dir == 'i') ? LexiRowcompareCuchar : LexiRowcompareDuchar, LexiRowswapcodechar, swapcodeind);
}
...
void LexiColchar(char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(char), sizeof(int), (dir == 'i') ? LexiColcompareCchar : LexiColcompareDchar, LexiColswapcodechar, swapcodeind);
}
...
void LexiColuchar(unsigned char *a, int *ind, int flag, int n, int p, char dir)
{
    ...
    sciqsort((char *)(a), (char *)(ind), flag, p,
             n * sizeof(char), sizeof(int), (dir == 'i') ? LexiColcompareCuchar : LexiColcompareDuchar, LexiColswapcodechar, swapcodeind);
}
