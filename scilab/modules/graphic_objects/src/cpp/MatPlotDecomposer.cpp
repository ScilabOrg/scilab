...
int MatPlotDecomposer::fillTextureData(char* id, char* buffer, int bufferLength)
{
  double* value;
...
int MatPlotDecomposer::fillTextureData(char* id, char* buffer, int bufferLength, int x, int y, int width, int height)
{
  double* value;
  getGraphicObjectProperty(id, __GO_DATA_MODEL_Z__, jni_double_vector, (void**) &value);
