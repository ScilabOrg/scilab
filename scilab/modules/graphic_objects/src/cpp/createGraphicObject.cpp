...
int createFigure(int iDockable, int iMenubarType, int iToolbarType, int iDefaultAxes)
{
    return Builder::createFigure(getScilabJavaVM(), iDockable != 0, iMenubarType, iToolbarType, iDefaultAxes != 0);
}
