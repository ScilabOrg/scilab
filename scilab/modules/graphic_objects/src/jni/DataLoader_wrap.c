...
SWIGEXPORT jobject JNICALL Java_org_scilab_modules_graphic_1objects_DataLoaderJNI_getDirectBuffer(JNIEnv *jenv, jclass jcls, jint jarg1)
{
    jobject jresult = 0 ;
    int arg1 ;
    JavaDirectBuffer result;
...
SWIGEXPORT void JNICALL Java_org_scilab_modules_graphic_1objects_DataLoaderJNI_releaseDirectByteBuffer(JNIEnv *jenv, jclass jcls, jobject jarg1)
{
    ...
    releaseDirectByteBuffer(arg1);
}


SWIGEXPORT void JNICALL Java_org_scilab_modules_graphic_1objects_DataLoaderJNI_releaseDirectIntBuffer(JNIEnv *jenv, jclass jcls, jobject jarg1)
{
    int *arg1 = (int *) 0 ;
    ...
    releaseDirectIntBuffer(arg1);
}


SWIGEXPORT void JNICALL Java_org_scilab_modules_graphic_1objects_DataLoaderJNI_releaseDirectFloatBuffer(JNIEnv *jenv, jclass jcls, jobject jarg1)
{
    float *arg1 = (float *) 0 ;
