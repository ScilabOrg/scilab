...
SWIGEXPORT jint JNICALL Java_org_scilab_modules_graphic_1objects_ScilabNativeViewJNI_ScilabNativeView_1_1getObjectHandle(JNIEnv *jenv, jclass jcls, jint jarg1)
{
    jint jresult = 0 ;
    int arg1 ;
    long result;
    ...
    (void)jcls;
    arg1 = (int)jarg1;
    result = (long)ScilabNativeView__getObjectHandle(arg1);
    jresult = (jint)result;
    return jresult;
}
