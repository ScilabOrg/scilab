...
%inline %{
    ...
    extern int getIndicesSize(char* id);       extern int fillIndices(char* id, int* BUFF, int bufferLength, int logMask);
    extern int getWireIndicesSize(char* id);       extern int fillWireIndices(char* id, int* BUFF, int bufferLength, int logMask);
