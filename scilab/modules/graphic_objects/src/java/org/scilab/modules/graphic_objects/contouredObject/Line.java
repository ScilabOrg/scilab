...
public class Line {
	...
	public enum LineType { SOLID, STYLE1, STYLE2, STYLE3, STYLE4, STYLE5, STYLE6;
        ...
        /**
         * Converts the line type to a 16-bits pattern.
         * @return the 16-bits pattern corresponding to the line type.
         */
        public short asPattern() {
            switch (this) {
                case STYLE1:
                    return (short) 0x07FF; // 5 blanks, 11 solid
                case STYLE2:
                    return (short) 0x0F0F; // 4 blanks, 4 solids, 4 blanks, 4 solidS
                case STYLE3:
                    return (short) 0x1FC2; // 3 blanks, 3 solids, 3 blnaks, 7 solids
                case STYLE4:
                ...
                case STYLE6:
                    return (short) 0x5555; // (1 blanks, 1 solids) x 8
