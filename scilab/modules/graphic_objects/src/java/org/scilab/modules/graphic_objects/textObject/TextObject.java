...
import static org.scilab.modules.graphic_objects.graphicObject.GraphicObjectProperties.__GO_FONT_ANTIALIASED__;
...
public abstract class TextObject extends ContouredObject {
    ...
    public Object getPropertyFromName(String propertyName) {
        if (propertyName.equals(__GO_FORMATTED_TEXT__)) {
            ...
            return Font.FontProperty.ANTIALIASED;
        } else {
    ...
    public Object getProperty(Object property) {
        ...
        } else if (property == Font.FontProperty.ANTIALIASED) {
    ...
    /**
     * @return the font antialiasing
     */
    public Boolean getFontAntialiased() {
        return text[0].getFont().getAntialiased();
    }

    /**
     * @param fractional the font antialiasing to set
     */
    public void setFontAntialiased(Boolean antialiased) {
        for (int i = 0; i < dimensions[0] * dimensions[1]; i++) {
            text[i].getFont().setAntialiased(antialiased);
        }
    }
}
