...
public class Figure extends GraphicObject {
	...
	private class EventHandler{
		...
		private boolean eventHandlerEnable;
	}
	...
	/**
	 * @return the eventHandler enable
	 */
	public Boolean getEventHandlerEnable() {
		return eventHandler.eventHandlerEnable;
	}

	/**
	 * @param eventHandlerString the eventHandler string to set
	 */
	public void setEventHandlerEnable(Boolean eventHandlerEnable) {
		eventHandler.eventHandlerEnable = eventHandlerEnable;
	}
