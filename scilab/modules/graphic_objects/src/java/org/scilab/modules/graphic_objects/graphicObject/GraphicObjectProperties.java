...
public class GraphicObjectProperties {
    ...
    public static final int __GO_GRID_OPT_GRID__ = 366;
    public static final int __GO_GRID_OPT_PADDING__ = 367;
    public static final int __GO_BORDER_OPT_PADDING__ = 368;
    public static final int __GO_UI_FRAME_BORDER__ = 369;
    public static final int __GO_UI_FRAME_BORDER_COLOR__ = 370;
    public static final int __GO_UI_FRAME_BORDER_HIGHLIGHT_IN__ = 371;
    public static final int __GO_UI_FRAME_BORDER_HIGHLIGHT_OUT__ = 372;
    public static final int __GO_UI_FRAME_BORDER_IN_BORDER__ = 373;
    public static final int __GO_UI_FRAME_BORDER_JUSTIFICATION__ = 374;
    public static final int __GO_UI_FRAME_BORDER_OUT_BORDER__ = 375;
    public static final int __GO_UI_FRAME_BORDER_ROUNDED__ = 376;
    public static final int __GO_UI_FRAME_BORDER_SHADOW_IN__ = 377;
    public static final int __GO_UI_FRAME_BORDER_SHADOW_OUT__ = 378;
    public static final int __GO_UI_FRAME_BORDER_TITLE__ = 379;
    public static final int __GO_UI_FRAME_BORDER_POSITION__ = 380;
    public static final int __GO_UI_FRAME_BORDER_STYLE__ = 381;
    public static final int __GO_UI_GROUP_NAME__ = 382;
    public static final int __GO_UI_TITLE_POSITION__ = 383;
    public static final int __GO_UI_TITLE_SCROLL__ = 384;
    public static final int __GO_UI_FRAME_BORDER_TYPE__ = 385;
    public static final int __GO_UI_SCROLLABLE__ = 386;
