...
public class GraphicObjectProperties {
    ...
    public static final int __GO_UI_ENABLE__ = 253;
    public static final int __GO_UI_FOREGROUNDCOLOR__ = 254;
    public static final int __GO_UI_VALUE__ = 255;
    public static final int __GO_UIPARENTMENU__ = 256;
    public static final int __GO_UICHILDMENU__ = 257;
    public static final int __GO_UICHECKEDMENU__ = 258;
    public static final int __GO_UI_CHECKED__ = 259;
    public static final int __GO_UI_LABEL__ = 260;
    public static final int __GO_UI_MNEMONIC__ = 261;
    public static final int __GO_UI_ACCELERATOR__ = 262;
    public static final int __GO_UI_SEPARATOR__ = 263;
    public static final int __GO_UI_ICON__ = 264;
    public static final int __GO_CONSOLE__ = 265;
    public static final int __GO_SHOWHIDDENHANDLES__ = 266;
    public static final int __GO_WAITBAR__ = 267;
    public static final int __GO_PROGRESSIONBAR__ = 268;
    public static final int __GO_UI_MESSAGE__ = 269;
    public static final int __GO_UI_MESSAGE_SIZE__ = 270;
    public static final int __GO_DATATIP__ = 271;
    public static final int __GO_DATATIP_DATA__ = 272;
    public static final int __GO_DATATIP_ORIENTATION__ = 273;
    public static final int __GO_DATATIP_3COMPONENT__ = 274;
    public static final int __GO_DATATIP_AUTOORIENTATION__ = 275;
    public static final int __GO_DATATIP_INTERP_MODE__ = 276;
    public static final int __GO_DATATIP_DISPLAY_FNC__ = 277;
    public static final int __GO_DATATIP_BOX_MODE__ = 278;
    public static final int __GO_DATATIP_LABEL_MODE__ = 279;
    public static final int __GO_AMBIENTCOLOR__ = 280;
    public static final int __GO_DIFFUSECOLOR__ = 281;
    public static final int __GO_SPECULARCOLOR__ = 282;
    public static final int __GO_COLOR_MATERIAL__ = 283;
    public static final int __GO_MATERIAL_SHININESS__ = 284;
    public static final int __GO_LIGHT__ = 285;
    public static final int __GO_LIGHT_TYPE__ = 286;
