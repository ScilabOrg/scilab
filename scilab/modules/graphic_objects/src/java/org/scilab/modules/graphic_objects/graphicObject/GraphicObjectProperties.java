...
public class GraphicObjectProperties {
    ...
    public static final int __GO_TOOLBAR_VISIBLE__ = 324;
    public static final int __GO_MENUBAR__ = 325;
    public static final int __GO_MENUBAR_VISIBLE__ = 326;
    public static final int __GO_INFOBAR_VISIBLE__ = 327;
    public static final int __GO_DOCKABLE__ = 328;
    public static final int __GO_LAYOUT__ = 329;
    public static final int __GO_LAYOUT_SET__ = 330;
    public static final int __GO_UI_BORDER_CONTRAINTS__ = 331;
    public static final int __GO_UI_GRID_CONTRAINTS__ = 332;
