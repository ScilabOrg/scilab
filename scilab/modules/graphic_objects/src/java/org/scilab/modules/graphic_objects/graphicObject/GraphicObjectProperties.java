...
public class GraphicObjectProperties {
    ...
    public static final int __GO_TICKS_DIRECTION__ = 191;
    public static final int __GO_X_NUMBER_TICKS__ = 192;
    public static final int __GO_Y_NUMBER_TICKS__ = 193;
    public static final int __GO_X_TICKS_COORDS__ = 194;
    public static final int __GO_Y_TICKS_COORDS__ = 195;
    public static final int __GO_TICKS_COLOR__ = 196;
    public static final int __GO_TICKS_SEGMENT__ = 197;
    public static final int __GO_TICKS_STYLE__ = 198;
    public static final int __GO_SUBTICKS__ = 199;
    public static final int __GO_NUMBER_TICKS_LABELS__ = 200;
    public static final int __GO_TICKS_LABELS__ = 201;
    public static final int __GO_FORMATN__ = 202;
    public static final int __GO_FONT__ = 203;
    public static final int __GO_FONT_STYLE__ = 204;
    public static final int __GO_FONT_SIZE__ = 205;
    public static final int __GO_FONT_COLOR__ = 206;
    public static final int __GO_FONT_FRACTIONAL__ = 207;
    public static final int __GO_Z_BOUNDS__ = 208;
    public static final int __GO_OUTSIDE_COLOR__ = 209;
    public static final int __GO_COLOR_RANGE__ = 210;
    public static final int __GO_DATA_MAPPING__ = 211;
    public static final int __GO_FONT_ANGLE__ = 212;
    public static final int __GO_AUTO_POSITION__ = 213;
    public static final int __GO_CORNERS__ = 214;
    public static final int __GO_AUTO_ROTATION__ = 215;
    public static final int __GO_LINKS__ = 216;
    public static final int __GO_LINKS_COUNT__ = 217;
    public static final int __GO_LEGEND_LOCATION__ = 218;
    public static final int __GO_CLOSED__ = 219;
    public static final int __GO_ARROW_SIZE_FACTOR__ = 220;
    public static final int __GO_POLYLINE_STYLE__ = 221;
    public static final int __GO_INTERP_COLOR_VECTOR__ = 222;
    public static final int __GO_INTERP_COLOR_VECTOR_SET__ = 223;
    public static final int __GO_INTERP_COLOR_MODE__ = 224;
    public static final int __GO_X_SHIFT__ = 225;
    public static final int __GO_Y_SHIFT__ = 226;
    public static final int __GO_Z_SHIFT__ = 227;
    public static final int __GO_BAR_WIDTH__ = 228;
    public static final int __GO_SURFACE_MODE__ = 229;
    public static final int __GO_COLOR_MODE__ = 230;
    public static final int __GO_COLOR_FLAG__ = 231;
    public static final int __GO_ALIGNMENT__ = 232;
    public static final int __GO_BOX__ = 233;
    public static final int __GO_TEXT_BOX__ = 234;
    public static final int __GO_TEXT_BOX_MODE__ = 235;
    public static final int __GO_AUTO_DIMENSIONING__ = 236;
    public static final int __GO_FORMATTED_TEXT__ = 237;
    public static final int __GO_TEXT_ARRAY_DIMENSIONS__ = 238;
    public static final int __GO_TEXT_STRINGS__ = 239;
    public static final int __GO_BASE__ = 240;
    public static final int __GO_BASE_X__ = 241;
    public static final int __GO_BASE_Y__ = 242;
    public static final int __GO_BASE_Z__ = 243;
    public static final int __GO_DIRECTION__ = 244;
    public static final int __GO_DIRECTION_X__ = 245;
    public static final int __GO_DIRECTION_Y__ = 246;
    public static final int __GO_DIRECTION_Z__ = 247;
    public static final int __GO_ARROW_SIZE__ = 248;
    public static final int __GO_SEGS_COLORS__ = 249;
    public static final int __GO_COLORED__ = 250;
    public static final int __GO_ARROWS__ = 251;
    public static final int __GO_NUMBER_ARROWS__ = 252;
    public static final int __GO_CHAMP_DIMENSIONS__ = 253;
    public static final int __GO_BOUNDING_BOX__ = 254;
    public static final int __GO_MAX_LENGTH__ = 255;
    public static final int __GO_MAX_USABLE_LENGTH__ = 256;
    public static final int __GO_HIDDEN_COLOR__ = 257;
    public static final int __GO_STYLE__ = 258;
    public static final int __GO_UI_CHECKBOX__ = 259;
    public static final int __GO_UI_EDIT__ = 260;
    public static final int __GO_UI_FRAME__ = 261;
    public static final int __GO_UI_IMAGE__ = 262;
    public static final int __GO_UI_LISTBOX__ = 263;
    public static final int __GO_UI_POPUPMENU__ = 264;
    public static final int __GO_UI_PUSHBUTTON__ = 265;
    public static final int __GO_UI_RADIOBUTTON__ = 266;
    public static final int __GO_UI_SLIDER__ = 267;
    public static final int __GO_UI_TABLE__ = 268;
    public static final int __GO_UI_TEXT__ = 269;
    public static final int __GO_UI_BACKGROUNDCOLOR__ = 270;
    public static final int __GO_UI_ENABLE__ = 271;
    public static final int __GO_UI_FONTANGLE__ = 272;
    public static final int __GO_UI_FONTNAME__ = 273;
    public static final int __GO_UI_FONTSIZE__ = 274;
    public static final int __GO_UI_FONTUNITS__ = 275;
    public static final int __GO_UI_FONTWEIGHT__ = 276;
    public static final int __GO_UI_FOREGROUNDCOLOR__ = 277;
    public static final int __GO_UI_HORIZONTALALIGNMENT__ = 278;
    public static final int __GO_UI_LISTBOXTOP__ = 279;
    public static final int __GO_UI_LISTBOXTOP_SIZE__ = 280;
    public static final int __GO_UI_MAX__ = 281;
    public static final int __GO_UI_MIN__ = 282;
    public static final int __GO_UI_RELIEF__ = 283;
    public static final int __GO_UI_STRING__ = 284;
    public static final int __GO_UI_STRING_SIZE__ = 285;
    public static final int __GO_UI_STRING_COLNB__ = 286;
    public static final int __GO_UI_TOOLTIPSTRING__ = 287;
    public static final int __GO_UI_TOOLTIPSTRING_SIZE__ = 288;
    public static final int __GO_UI_SLIDERSTEP__ = 289;
    public static final int __GO_UI_UNITS__ = 290;
    public static final int __GO_UI_VALUE__ = 291;
    public static final int __GO_UI_VALUE_SIZE__ = 292;
    public static final int __GO_UI_VERTICALALIGNMENT__ = 293;
    public static final int __GO_UIPARENTMENU__ = 294;
    public static final int __GO_UICHILDMENU__ = 295;
    public static final int __GO_UICHECKEDMENU__ = 296;
    public static final int __GO_UI_CHECKED__ = 297;
    public static final int __GO_UI_LABEL__ = 298;
    public static final int __GO_UI_MNEMONIC__ = 299;
    public static final int __GO_UI_ACCELERATOR__ = 300;
    public static final int __GO_UI_SEPARATOR__ = 301;
    public static final int __GO_UI_ICON__ = 302;
    public static final int __GO_CONSOLE__ = 303;
    public static final int __GO_SHOWHIDDENHANDLES__ = 304;
    public static final int __GO_WAITBAR__ = 305;
    public static final int __GO_PROGRESSIONBAR__ = 306;
    public static final int __GO_UI_MESSAGE__ = 307;
    public static final int __GO_UI_MESSAGE_SIZE__ = 308;
    public static final int __GO_DATATIP__ = 309;
    public static final int __GO_DATATIP_DATA__ = 310;
    public static final int __GO_DATATIP_ORIENTATION__ = 311;
    public static final int __GO_DATATIP_3COMPONENT__ = 312;
    public static final int __GO_DATATIP_AUTOORIENTATION__ = 313;
    public static final int __GO_DATATIP_INTERP_MODE__ = 314;
    public static final int __GO_DATATIP_DISPLAY_FNC__ = 315;
    public static final int __GO_DATATIP_BOX_MODE__ = 316;
    public static final int __GO_DATATIP_LABEL_MODE__ = 317;
    public static final int __GO_AMBIENTCOLOR__ = 318;
    public static final int __GO_DIFFUSECOLOR__ = 319;
    public static final int __GO_SPECULARCOLOR__ = 320;
    public static final int __GO_COLOR_MATERIAL__ = 321;
    public static final int __GO_MATERIAL_SHININESS__ = 322;
    public static final int __GO_LIGHT__ = 323;
    public static final int __GO_LIGHT_TYPE__ = 324;
    public static final int __GO_DATATIPS__ = 325;
    public static final int __GO_DATATIPS_COUNT__ = 326;
    public static final int __GO_DATATIP_INDEXES__ = 327;
    public static final int __GO_DATA_MODEL_DISPLAY_FUNCTION__ = 328;
    public static final int __GO_DATA_MODEL_DISPLAY_FUNCTION_SIZE__ = 329;
    public static final int __GO_RESIZE__ = 330;
    public static final int __GO_TOOLBAR__ = 331;
    public static final int __GO_TOOLBAR_VISIBLE__ = 332;
    public static final int __GO_MENUBAR__ = 333;
    public static final int __GO_MENUBAR_VISIBLE__ = 334;
    public static final int __GO_INFOBAR_VISIBLE__ = 335;
    public static final int __GO_DOCKABLE__ = 336;
    public static final int __GO_LAYOUT__ = 337;
    public static final int __GO_LAYOUT_SET__ = 338;
    public static final int __GO_UI_BORDER_CONSTRAINTS__ = 339;
    public static final int __GO_UI_GRID_CONSTRAINTS__ = 340;
