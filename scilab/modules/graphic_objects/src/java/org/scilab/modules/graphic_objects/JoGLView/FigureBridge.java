...
import org.scilab.modules.graphic_objects.JoGLView.glcanvas.ScilabGLCanvas;
    ...
    private FigureBridge(String id) throws Exception {
        ...
        if (type instanceof String && type.equals("Figure")) {
            ...
            if (object instanceof Figure) {
                ...
                AbstractGLCanvas page = new ScilabGLCanvas(canvas) {
                    @Override
                    public void performDraw() {
                        IVisitor visitor = new DrawerVisitor(this);
