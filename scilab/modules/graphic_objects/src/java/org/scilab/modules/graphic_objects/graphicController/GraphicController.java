...
public class GraphicController {
    ...
    */
    ...
    /**
     * Experimental fast property set method
     * @param id the object id
     * @param prop the property name
     * @param value the property value
     */
    public void setPropertyFastHack(UID id, String prop, Object value) {
    	GraphicModel.getModel().setPropertyFastHack(id, prop, value);
    }
     ...
     * @param value the property value
     */
    public void setPropertyFast2(UID id, String prop, Object value) {
    	GraphicModel.getModel().setPropertyFast2(id, prop, value);
    }

    /**
     * Fast property get method version 2
     * @param id the object id
     * @param prop the property name
     * @return the property value
     */
    public Object getPropertyFast2(UID id, String prop) {
    	return GraphicModel.getModel().getPropertyFast2(id, prop);
    }
