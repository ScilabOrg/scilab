...
import static org.scilab.modules.graphic_objects.graphicObject.GraphicObjectProperties.__GO_UI_BORDER_CONTRAINTS__;
...
import static org.scilab.modules.graphic_objects.graphicObject.GraphicObjectProperties.__GO_UI_GRID_CONTRAINTS__;
...
public class Uicontrol extends GraphicObject {
    ...
    public Object getPropertyFromName(int propertyName) {
        switch (propertyName) {
            ...
            case __GO_UI_BORDER_CONTRAINTS__:
                return UicontrolProperty.BORDERCONTRAINTS;
            case __GO_UI_GRID_CONTRAINTS__:
                return UicontrolProperty.GRIDCONTRAINTS;
            default :
    ...
    public Object getProperty(Object property) {
        if (property == UicontrolProperty.STYLE) {
            ...
            return getMargins();
        } else if (property == UicontrolProperty.BORDERCONTRAINTS) {
            return getBorderContraints();
        } else if (property == UicontrolProperty.GRIDCONTRAINTS) {
            return getGridContraints();
        } else {
    ...
    public UpdateStatus setProperty(Object property, Object value) {
        ...
        switch (p) {
            ...
            case BORDERCONTRAINTS:
                return setBorderContraints((Integer) value);
            case GRIDCONTRAINTS:
                return setGridContraints((Double[]) value);
            default:
                return super.setProperty(property, value);
        }
    }
    ...
    public Integer getBorderContraints() {
        return borderConstraints.ordinal();
    }

    public BorderLayoutType getBorderContraintsAsEnum() {
        return borderConstraints;
    }

    public UpdateStatus setBorderContraints(Integer value) {
        return setBorderContraints(BorderLayoutType.intToEnum(value));
    }

    public UpdateStatus setBorderContraints(BorderLayoutType borderConstraints) {
    ...
    public Double[] getGridContraints() {
        return gridConstraints;
    }

    public UpdateStatus setGridContraints(Double[] gridConstraints) {
        UpdateStatus status = UpdateStatus.NoChange;
