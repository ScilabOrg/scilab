...
public class Uicontrol extends GraphicObject {
    ...
    public UpdateStatus setBackgroundColor(Color color) {
        if (color == null) {
            return UpdateStatus.Fail;
        }

        Double[] back = new Double[] {
            (double)color.getRed() / 255,
            (double)color.getGreen() / 255,
            (double)color.getBlue() / 255
        };
        return setBackgroundColor(back);
    }
    ...
    public UpdateStatus setForegroundColor(Color color) {
        if (color == null) {
            return UpdateStatus.Fail;
        }
        ...
        return setForegroundColor(back);
    }
