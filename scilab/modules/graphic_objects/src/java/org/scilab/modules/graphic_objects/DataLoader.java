...
public class DataLoader {
    ...
    public static java.nio.ByteBuffer getDirectBuffer(int size) {
        return DataLoaderJNI.getDirectBuffer(size);
    }

    public static void releaseDirectByteBuffer(java.nio.ByteBuffer buffer) {
        assert buffer.isDirect() : "Buffer must be allocated direct.";
        {
            DataLoaderJNI.releaseDirectByteBuffer(buffer);
        }
    }

    public static void releaseDirectIntBuffer(java.nio.IntBuffer buffer) {
        assert buffer.isDirect() : "Buffer must be allocated direct.";
        {
            DataLoaderJNI.releaseDirectIntBuffer(buffer);
        }
    }

    public static void releaseDirectFloatBuffer(java.nio.FloatBuffer buffer) {
        assert buffer.isDirect() : "Buffer must be allocated direct.";
        {
            DataLoaderJNI.releaseDirectFloatBuffer(buffer);
        }
    }
