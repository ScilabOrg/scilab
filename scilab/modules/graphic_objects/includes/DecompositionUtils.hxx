...
public :
   ...
   /**
    * Utility function which outputs the triangle indices of a quad decomposed
    * into 2 adjacent triangles. Decomposition is always performed the same way as it does not
    * depend on input vertex values. This function should therefore be used only for planar and
    * convex 4-vertex polygons.
    * @param[out] the triangle indices (v0, v1, v2), (v3, v4, v5)
    */
    static void getDecomposedQuadTriangleIndices(int* indices);
};
