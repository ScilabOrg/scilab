...
public :
     ...
     * @param[in] the size of the colormap used.
     */
    Fac3DColorComputer(double* colors, int numColors, int colorFlag, int dataMapping, int numGons, int numVerticesPerGon, int colormapSize);
     ...
     * which are then stored as internal properties.
     */
