...
public:
  ...
  static int fillTextureData(char* id, char* buffer, int bufferLength);
  static int fillTextureData(char* id, char* buffer, int bufferLength, int x, int y, int width, int height);
};
