...
#define __DO_NOT_USE__ (abort() ? NULL : NULL)
#define sciGetFirstAccessibleSon(pObj)          __DO_NOT_USE__
#define sciGetNextAccessibleSon(son)            __DO_NOT_USE__
#define sciGetLastSons(pobj)                    __DO_NOT_USE__
#define sciRelocateHandles(handles, nbHandles, newParentHandle)         __DO_NOT_USE__
#define swapHandles(firstHdl, secondHdl)        __DO_NOT_USE__
