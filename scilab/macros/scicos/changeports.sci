...
//** 22 August 2007: this is a veru dirty solution that I hope to improve later 
...
//** The second pass is indispensable because the link deletion can create more unconnected ports and this information
//** must be used to correctly allocate the ports on the new blocks. 
...
//**------------------------------ End of second pass --------------------------------------------
  ...
  if LinkToDel<>[] then 
    disp("LinkToDel must be empty at the end of the second pass"); pause
  end     
