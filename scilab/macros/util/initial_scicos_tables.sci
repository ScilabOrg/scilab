...
//**        This function is called from "scilab/scilab.star" at Scilab's startup
 ...
 //**------------------------------
  ...
  %scicos_help=tlist(['sch']);
  deff('%scicos_help=scicos_help(entry,doc)',...
 ...
 //***********************/
  ...
  %scicos_help=scicos_help('Rename',...
               [" This menu allows to change the diagram name. An editable";
                "  dialog box opens."])

  %scicos_help=scicos_help('Save',...
  ...
  %scicos_help=scicos_help('Save As',...
  ...
  %scicos_help=scicos_help('Save as Interf Func',...
...
//***********************/
  ...
  %scicos_help=scicos_help('Replot',...
  ...
  %scicos_help=scicos_help('Set Diagram Info',...
  ...
  %scicos_help=scicos_help('Region to Super Block',...
...
//TODO
//   %scicos_help=scicos_help('Up To Main Diagram',...
//                [""])

  %scicos_help=scicos_help('Context',...
...
//***********************/
  ...
  %scicos_help=scicos_help('Delete',...
  ...
  %scicos_help=scicos_help('Smart Move',...
               [" To move a block in  the active editor Scicos window";
...
//***********************/
  ...
  %scicos_help=scicos_help('Compile',...
  ...
  %scicos_help=scicos_help('Debug Level',...
...
//***********************/
  ...
  %scicos_help=scicos_help('Background color',...
               [" This menu allows to change the background and default";
                " foreground colors."])

  %scicos_help=scicos_help('Show Block Shadow',...
               [" This menu allows to select 3D shape for blocks and ";
                " associated parameters."])

  %scicos_help=scicos_help('Resize',...
  ...
  %scicos_help=scicos_help('Icon Editor',...
               [" Icon Editor allows you to define graphically the icon of the block."])

//***** Tools Menu ******/
//***********************/

  %scicos_help=scicos_help('Get Info',...
...
//TODO
//   %scicos_help=scicos_help('Details',...
//                [""])

  %scicos_help=scicos_help('Browser',...
  ...
  %scicos_help=scicos_help('Code Generation',...
  ...
  %scicos_help=scicos_help('Shortcuts',...
               [" Used to define personalized shortcuts."])

//TODO
//   %scicos_help=scicos_help('Activate Scilab Window',...
//                [""])

  %scicos_help=scicos_help('Calc',...
...
//   %scicos_help=scicos_help('Duplicate Region',...
...
//   %scicos_help=scicos_help('Replace',...
...
//   %scicos_help=scicos_help('Delete Region',...
...
//   %scicos_help=scicos_help('Open/Set',...
