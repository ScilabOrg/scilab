...
Source: contrib\{#XCOS_TOOLBOX_SKELETON}\images\gif\TBX_MUT_STYLE.gif; DestDir: {app}\contrib\{#XCOS_TOOLBOX_SKELETON}\images\gif; Flags: recursesubdirs; Components: {#COMPN_TOOLBOX_SKELETON} and {#COMPN_XCOS}
...
Source: contrib\{#XCOS_TOOLBOX_SKELETON}\images\svg\TBX_MUT_STYLE.svg; DestDir: {app}\contrib\{#XCOS_TOOLBOX_SKELETON}\images\svg; Flags: recursesubdirs; Components: {#COMPN_TOOLBOX_SKELETON} and {#COMPN_XCOS}
...
Source: contrib\{#XCOS_TOOLBOX_SKELETON}\macros\TBX_MUT_STYLE.sci; DestDir: {app}\contrib\{#XCOS_TOOLBOX_SKELETON}\macros; Flags: recursesubdirs; Components: {#COMPN_TOOLBOX_SKELETON} and {#COMPN_XCOS}
