...
Source: contrib\{#TOOLBOX_SKELETON}\src\java\src\org\scilab\contrib\toolboxskeleton\Sum.java; DestDir: {app}\contrib\{#TOOLBOX_SKELETON}\src\java\src\org\scilab\contrib\toolboxskeleton; Components: {#COMPN_TOOLBOX_SKELETON}
