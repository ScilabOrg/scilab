...
Source: contrib\{#XCOS_TOOLBOX_SKELETON}\images\gif\TBX_SUM.gif; DestDir: {app}\contrib\{#XCOS_TOOLBOX_SKELETON}\images\gif; Flags: recursesubdirs; Components: {#COMPN_TOOLBOX_SKELETON}
Source: contrib\{#XCOS_TOOLBOX_SKELETON}\images\svg\TBX_SUM.svg; DestDir: {app}\contrib\{#XCOS_TOOLBOX_SKELETON}\images\svg; Flags: recursesubdirs; Components: {#COMPN_TOOLBOX_SKELETON}
Source: contrib\{#XCOS_TOOLBOX_SKELETON}\macros\TBX_SUM.sci; DestDir: {app}\contrib\{#XCOS_TOOLBOX_SKELETON}\macros; Flags: recursesubdirs; Components: {#COMPN_TOOLBOX_SKELETON}
