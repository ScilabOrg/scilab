...
let msgs = [
  ...
  ("_ExtCallToUnsupportedLang",
    [("ENG", "External call to unsupported language")]);
  ...
  ("_UnspecifiedExtCallLang",
    [("ENG", "External call language not specified")]);
  ("_CommandLine",
    [("ENG", "command line")]);
  ("_CharacterPosition",
  ...
  ("_ModelicaUnsupported",
    [("ENG", "Use of Modelica unsupported feature:")]);
  ...
  ("_NonRealFuncInput",
    [("ENG", "Non Real function input")]);
  ("_NonRealFuncOutput",
    [("ENG", "Non Real function output")]);
  ...
  ("_VariabilityConflictsInAssignExpr",
    [("ENG", "Variability conflicts in assignment expression")]);
